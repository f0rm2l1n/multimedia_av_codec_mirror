...
#ifndef I_STANDARD_MEDIA_CODEC_SERVICE_H
#define I_STANDARD_MEDIA_CODEC_SERVICE_H
...
class IStandardMediaCodecService : public IRemoteBroker {
public:
    virtual ~IStandardMediaCodecService() = default;
