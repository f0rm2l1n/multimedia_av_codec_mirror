...
#ifndef MEDIA_CODEC_SERVICE_STUB_H
#define MEDIA_CODEC_SERVICE_STUB_H
...
class MediaCodecServiceStub : public IRemoteStub<IStandardCodecService>, public NoCopyable {
public:
    static sptr<MediaCodecServiceStub> Create();
    virtual ~MediaCodecServiceStub();

    int OnRemoteRequest(uint32_t code, MessageParcel &data, MessageParcel &reply, MessageOption &option) override;
    using MediaCodecStubFunc = int32_t(MediaCodecServiceStub::*)(MessageParcel &data, MessageParcel &reply);
...
#endif // MEDIA_CODEC_SERVICE_STUB_H
