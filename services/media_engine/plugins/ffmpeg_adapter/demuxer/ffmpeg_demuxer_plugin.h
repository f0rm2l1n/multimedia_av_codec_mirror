...
public:
    ...
    //     1) If COUNTRY_CODE is 0xB5 or 0x26, and PROVIDER_CODE is 0x04 and PROVIDER_ORIENTED_CODE is 0x05, assign the value as HDR_VIVID.
    //     2) If COUNTRY_CODE is 0xB5 and PROVIDER_CODE is 0x3C, assign the value as HDR10.
    // 4. If ITU_T_T35 is not included, check if there are special boxes in the reference file:
    ...
    // 6. If none of the above conditions are satisfied, assign the value as NONE, which may indicate SDR or non-standard HDR.
