 ...
 */
#ifndef FFMPEG_DTS_DECODER_PLUGIN_H
#define FFMPEG_DTS_DECODER_PLUGIN_H
...
namespace Plugins {
namespace Ffmpeg {
class FFmpegDtsDecoderPlugin : public CodecPlugin {
public:
    explicit FFmpegDtsDecoderPlugin(const std::string& name);

    ~FFmpegDtsDecoderPlugin();
