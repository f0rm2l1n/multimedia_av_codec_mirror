/*
 * Copyright (c) 20235 Huawei Device Co., Ltd.
 ...
 */
#ifndef FFMPEG_ADPCM_DECODER_PLUGIN_H
#define FFMPEG_ADPCM_DECODER_PLUGIN_H
...
class FFmpegADPCMDecoderPlugin : public CodecPlugin {
public:
    explicit FFmpegADPCMDecoderPlugin(const std::string& name);
    ~FFmpegADPCMDecoderPlugin() override;
