...
#ifndef FFMPEG_EAC3_DECODER_PLUGIN_H
#define FFMPEG_EAC3_DECODER_PLUGIN_H
...
namespace Plugins {
namespace Ffmpeg {
class FFmpegEAC3DecoderPlugin : public CodecPlugin {
public:
    explicit FFmpegEAC3DecoderPlugin(const std::string &name);

    ~FFmpegEAC3DecoderPlugin();
