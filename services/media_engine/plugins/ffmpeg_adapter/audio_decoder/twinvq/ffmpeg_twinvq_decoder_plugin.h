...
#ifndef FFMPEG_TWINVQ_DECODER_PLUGIN_H
#define FFMPEG_TWINVQ_DECODER_PLUGIN_H
...
namespace Plugins {
namespace Ffmpeg {
class FFmpegTwinVQDecoderPlugin : public CodecPlugin {
public:
    explicit FFmpegTwinVQDecoderPlugin(const std::string &name);

    ~FFmpegTwinVQDecoderPlugin();
