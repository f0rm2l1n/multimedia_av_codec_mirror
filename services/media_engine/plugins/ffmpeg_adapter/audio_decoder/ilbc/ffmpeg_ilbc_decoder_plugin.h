...
#ifndef FFMPEG_ILBC_DECODER_PLUGIN_H
#define FFMPEG_ILBC_DECODER_PLUGIN_H
...
namespace Plugins {
namespace Ffmpeg {
class FFmpegILBCDecoderPlugin : public CodecPlugin {
public:
    explicit FFmpegILBCDecoderPlugin(const std::string &name);

    ~FFmpegILBCDecoderPlugin();
