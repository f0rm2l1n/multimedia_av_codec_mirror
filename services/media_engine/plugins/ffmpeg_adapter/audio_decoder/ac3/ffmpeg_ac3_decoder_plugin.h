...
#ifndef FFMPEG_AC3_DECODER_PLUGIN_H
#define FFMPEG_AC3_DECODER_PLUGIN_H
...
namespace Plugins {
namespace Ffmpeg {
class FFmpegAC3DecoderPlugin : public CodecPlugin {
public:
    explicit FFmpegAC3DecoderPlugin(const std::string& name);

    ~FFmpegAC3DecoderPlugin();
