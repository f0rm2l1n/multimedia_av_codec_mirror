...
#ifndef FFMPEG_GSM_DECODER_PLUGIN_H
#define FFMPEG_GSM_DECODER_PLUGIN_H
...
namespace Plugins {
namespace Ffmpeg {
class FFmpegGSMDecoderPlugin : public CodecPlugin {
public:
    explicit FFmpegGSMDecoderPlugin(const std::string &name);

    ~FFmpegGSMDecoderPlugin();
