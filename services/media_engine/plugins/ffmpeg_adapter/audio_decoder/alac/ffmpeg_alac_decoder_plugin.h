 ...
 */
#ifndef FFMPEG_ALAC_DECODER_PLUGIN_H
#define FFMPEG_ALAC_DECODER_PLUGIN_H
...
namespace Plugins {
namespace Ffmpeg {
class FFmpegAlacDecoderPlugin : public CodecPlugin {
public:
    explicit FFmpegAlacDecoderPlugin(const std::string &name);

    ~FFmpegAlacDecoderPlugin();
