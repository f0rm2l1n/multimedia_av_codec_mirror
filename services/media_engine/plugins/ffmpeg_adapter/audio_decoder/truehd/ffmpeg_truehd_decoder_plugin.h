...
#ifndef FFMPEG_TRUEHD_DECODER_PLUGIN_H
#define FFMPEG_TRUEHD_DECODER_PLUGIN_H
...
namespace Plugins {
namespace Ffmpeg {
class FFmpegTruehdDecoderPlugin : public CodecPlugin {
public:
    explicit FFmpegTruehdDecoderPlugin(const std::string &name);

    ~FFmpegTruehdDecoderPlugin();
