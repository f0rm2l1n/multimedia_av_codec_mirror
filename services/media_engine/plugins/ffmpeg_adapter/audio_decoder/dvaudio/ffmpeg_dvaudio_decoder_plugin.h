 ...
 */
#ifndef FFMPEG_DVAUDIO_DECODER_PLUGIN_H
#define FFMPEG_DVAUDIO_DECODER_PLUGIN_H
...
namespace Plugins {
namespace Ffmpeg {
class FFmpegDvaudioDecoderPlugin : public CodecPlugin {
public:
    explicit FFmpegDvaudioDecoderPlugin(const std::string& name);

    ~FFmpegDvaudioDecoderPlugin();
