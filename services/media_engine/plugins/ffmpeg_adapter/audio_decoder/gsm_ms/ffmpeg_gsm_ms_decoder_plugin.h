...
#ifndef FFMPEG_GSM_MS_DECODER_PLUGIN_H
#define FFMPEG_GSM_MS_DECODER_PLUGIN_H
...
namespace Plugins {
namespace Ffmpeg {
class FFmpegGsmMsDecoderPlugin : public CodecPlugin {
public:
    explicit FFmpegGsmMsDecoderPlugin(const std::string &name);

    ~FFmpegGsmMsDecoderPlugin();
