 ...
 */
#ifndef FFMPEG_COOK_DECODER_PLUGIN_H
#define FFMPEG_COOK_DECODER_PLUGIN_H
...
namespace Plugins {
namespace Ffmpeg {
class FFmpegCookDecoderPlugin : public CodecPlugin {
public:
    explicit FFmpegCookDecoderPlugin(const std::string& name);

    ~FFmpegCookDecoderPlugin();
