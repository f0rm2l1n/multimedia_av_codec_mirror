...
bool MediaSyncManager::UpdateTimeAnchor(int64_t clockTime, int64_t mediaTime, int64_t maxMediaTime,
    IMediaSynchronizer* supplier)
{
    ...
    if (isSeeking_ && Plugins::HstTime2Ms(abs(mediaTime - seekingMediaTime_)) <= 100) {
