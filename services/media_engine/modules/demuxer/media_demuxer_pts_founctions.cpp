...
Status MediaDemuxer::HandleAutoMaintainPts(uint32_t trackId, std::shared_ptr<AVBuffer> sample)
{
    ...
    MEDIA_LOG_D("HandleAutoMaintainPts success, trackId: " PUBLIC_LOG_U32 ", orginal pts: "
    PUBLIC_LOG_D64 ", pts: " PUBLIC_LOG_D64 ", basePts: "
    PUBLIC_LOG_D64, trackId, curPacketPts, sample->pts_, baseInfo->basePts);
    return Status::OK;
}
