...
#ifndef LIVE_HTTP_STREAM_DEMUXER_H
#define LIVE_HTTP_STREAM_DEMUXER_H
...
class LiveHttpStreamDemuxer : public BaseStreamDemuxer {
public:
    explicit LiveHttpStreamDemuxer();
    ~LiveHttpStreamDemuxer() override;
