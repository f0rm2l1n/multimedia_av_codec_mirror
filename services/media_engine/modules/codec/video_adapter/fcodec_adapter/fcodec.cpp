...
int32_t FCodec::QueueInputBuffer(uint32_t index, std::shared_ptr<AVBuffer> &buffer)
{
    AVCODEC_SYNC_TRACE;
...
int32_t FCodec::SetCallback(const std::shared_ptr<AVCodecCallbackAdapter> &callback)
{
    AVCODEC_SYNC_TRACE;
