...
namespace Media {
namespace Pipeline {
static AutoRegisterFilter<CodecCapabilityFilter> g_registerCodecCapabilityFilter("builtin.recorder.codeccapability",
    FilterType::FILTERTYPE_CODEC, 
    [](const std::string& name, const FilterType type) {
        return std::make_shared<CodecCapabilityFilter>(name, FilterType::FILTERTYPE_CODEC);
    });
...
void CodecCapabilityFilter::Init(const std::shared_ptr<EventReceiver>& receiver,
