...
void CapsUnitTest::CheckAVDecH264(const std::shared_ptr<VideoCaps> &videoCaps) const
{
    ...
    EXPECT_LE(1, videoCaps->GetSupportedBitrate().minVal);
    EXPECT_GE(MAX_VIDEO_BITRATE, videoCaps->GetSupportedBitrate().maxVal);
    EXPECT_GE(0, videoCaps->GetSupportedWidthAlignment());
    EXPECT_LE(DEFAULT_WIDTH_RANGE.minVal, videoCaps->GetSupportedWidth().minVal);
    EXPECT_GE(DEFAULT_WIDTH_RANGE.maxVal, videoCaps->GetSupportedWidth().maxVal);
    EXPECT_LE(DEFAULT_HEIGHT_RANGE.minVal, videoCaps->GetSupportedHeight().minVal);
    EXPECT_GE(DEFAULT_HEIGHT_RANGE.maxVal, videoCaps->GetSupportedHeight().maxVal);
    EXPECT_LE(1, videoCaps->GetSupportedFrameRate().minVal);
    EXPECT_GE(DEFAULT_FRAMERATE_RANGE.maxVal, videoCaps->GetSupportedFrameRate().maxVal);
    EXPECT_GE(0, videoCaps->GetSupportedEncodeQuality().minVal);
    EXPECT_GE(0, videoCaps->GetSupportedEncodeQuality().maxVal);
    EXPECT_GE(0, videoCaps->GetSupportedQuality().minVal);
    EXPECT_GE(0, videoCaps->GetSupportedQuality().maxVal);
    EXPECT_GE(0, videoCaps->GetSupportedComplexity().minVal);
    EXPECT_GE(0, videoCaps->GetSupportedComplexity().maxVal);
    EXPECT_GT(0, videoCaps->GetSupportedFormats().size());
    EXPECT_GT(0, videoCaps->GetSupportedProfiles().size());
    EXPECT_GE(0, videoCaps->GetSupportedBitrateMode().size());
    EXPECT_GE(0, videoCaps->GetSupportedLevels().size());
...
void CapsUnitTest::CheckAVDecH263(const std::shared_ptr<VideoCaps> &videoCaps) const
{
    ...
    EXPECT_GE(0, videoCaps->GetSupportedComplexity().minVal);
    EXPECT_GE(0, videoCaps->GetSupportedComplexity().maxVal);
    EXPECT_GT(0, videoCaps->GetSupportedFormats().size()); // 2: supported formats count
    EXPECT_GT(0, videoCaps->GetSupportedProfiles().size());
    EXPECT_GE(0, videoCaps->GetSupportedBitrateMode().size());
    EXPECT_GE(0, videoCaps->GetSupportedLevels().size());
    EXPECT_EQ(false, videoCaps->IsSupportDynamicIframe());
...
void CapsUnitTest::CheckAVDecMpeg2Video(const std::shared_ptr<VideoCaps> &videoCaps) const
{
    ...
    EXPECT_GE(0, videoCaps->GetSupportedComplexity().maxVal);
    EXPECT_GT(0, videoCaps->GetSupportedFormats().size());  // 2: supported formats count
    EXPECT_GT(0, videoCaps->GetSupportedProfiles().size()); // 2: supported profile count
    EXPECT_GE(0, videoCaps->GetSupportedBitrateMode().size());
    EXPECT_GE(0, videoCaps->GetSupportedLevels().size());
    EXPECT_EQ(false, videoCaps->IsSupportDynamicIframe());
...
void CapsUnitTest::CheckAVDecAVC(const std::shared_ptr<VideoCaps> &videoCaps) const
{
    ...
    EXPECT_LE(1, videoCaps->GetSupportedBitrate().minVal);
    EXPECT_GE(MAX_VIDEO_BITRATE, videoCaps->GetSupportedBitrate().maxVal);
    EXPECT_LE(DEFAULT_WIDTH_ALIGNMENT, videoCaps->GetSupportedWidthAlignment());
    EXPECT_LE(DEFAULT_HEIGHT_ALIGNMENT, videoCaps->GetSupportedHeightAlignment());
    EXPECT_LE(DEFAULT_WIDTH_RANGE.minVal, videoCaps->GetSupportedWidth().minVal);
    EXPECT_GE(DEFAULT_WIDTH_RANGE.maxVal, videoCaps->GetSupportedWidth().maxVal);
    EXPECT_LE(DEFAULT_HEIGHT_RANGE.minVal, videoCaps->GetSupportedHeight().minVal);
    EXPECT_GE(DEFAULT_HEIGHT_RANGE.maxVal, videoCaps->GetSupportedHeight().maxVal);
    EXPECT_LE(DEFAULT_FRAMERATE_RANGE.minVal, videoCaps->GetSupportedFrameRate().minVal);
    EXPECT_GE(DEFAULT_FRAMERATE_RANGE.maxVal, videoCaps->GetSupportedFrameRate().maxVal);
    EXPECT_GE(0, videoCaps->GetSupportedEncodeQuality().minVal);
    EXPECT_GE(0, videoCaps->GetSupportedEncodeQuality().maxVal);
    EXPECT_GE(0, videoCaps->GetSupportedQuality().minVal);
    ...
    EXPECT_GE(0, videoCaps->GetSupportedComplexity().minVal);
    EXPECT_GE(0, videoCaps->GetSupportedComplexity().maxVal);
    EXPECT_GT(0, videoCaps->GetSupportedFormats().size());  // 4: supported formats count
    EXPECT_GT(0, videoCaps->GetSupportedProfiles().size()); // 3: supported profile count
    EXPECT_GE(0, videoCaps->GetSupportedBitrateMode().size());
    EXPECT_GE(0, videoCaps->GetSupportedLevels().size());
    EXPECT_EQ(false, videoCaps->IsSupportDynamicIframe());
    EXPECT_EQ(false, videoCaps->IsSizeAndRateSupported(videoCaps->GetSupportedWidth().minVal,
...
void CapsUnitTest::CheckAVEncAVC(const std::shared_ptr<VideoCaps> &videoCaps) const
{
    ...
    EXPECT_LE(DEFAULT_BITRATE_RANGE_ENC.minVal, videoCaps->GetSupportedBitrate().minVal);
    EXPECT_GE(DEFAULT_BITRATE_RANGE_ENC.maxVal, videoCaps->GetSupportedBitrate().maxVal);
    EXPECT_LE(DEFAULT_ALIGNMENT_ENC, videoCaps->GetSupportedWidthAlignment());
    EXPECT_LE(DEFAULT_ALIGNMENT_ENC, videoCaps->GetSupportedHeightAlignment());
    EXPECT_LE(DEFAULT_WIDTH_RANGE_ENC.minVal, videoCaps->GetSupportedWidth().minVal);
    EXPECT_GE(DEFAULT_WIDTH_RANGE_ENC.maxVal, videoCaps->GetSupportedWidth().maxVal);
    EXPECT_LE(DEFAULT_HEIGHT_RANGE_ENC.minVal, videoCaps->GetSupportedHeight().minVal);
    EXPECT_GE(DEFAULT_HEIGHT_RANGE_ENC.maxVal, videoCaps->GetSupportedHeight().maxVal);
    EXPECT_LE(1, videoCaps->GetSupportedFrameRate().minVal);
    EXPECT_GE(DEFAULT_FRAMERATE_RANGE.maxVal, videoCaps->GetSupportedFrameRate().maxVal);
    EXPECT_LE(DEFAULT_VIDEO_QUALITY_RANGE.minVal, videoCaps->GetSupportedEncodeQuality().minVal);
    EXPECT_GE(DEFAULT_VIDEO_QUALITY_RANGE.maxVal, videoCaps->GetSupportedEncodeQuality().maxVal);
    EXPECT_GE(0, videoCaps->GetSupportedQuality().minVal);
    EXPECT_GE(0, videoCaps->GetSupportedQuality().maxVal);
    EXPECT_GE(0, videoCaps->GetSupportedComplexity().minVal);
    EXPECT_GE(0, videoCaps->GetSupportedComplexity().maxVal);
...
void CapsUnitTest::CheckAVEncMpeg4(const std::shared_ptr<VideoCaps> &videoCaps) const
{
    ...
    EXPECT_GE(0, videoCaps->GetSupportedHeightAlignment());
    EXPECT_LE(DEFAULT_WIDTH_RANGE.minVal, videoCaps->GetSupportedWidth().minVal);
    EXPECT_GE(DEFAULT_WIDTH, videoCaps->GetSupportedWidth().maxVal);
    EXPECT_LE(DEFAULT_HEIGHT_RANGE.minVal, videoCaps->GetSupportedHeight().minVal);
    EXPECT_GE(DEFAULT_HEIGHT, videoCaps->GetSupportedHeight().maxVal);
    EXPECT_LE(DEFAULT_FRAMERATE_RANGE.minVal, videoCaps->GetSupportedFrameRate().minVal);
    EXPECT_GE(DEFAULT_FRAMERATE_RANGE.maxVal, videoCaps->GetSupportedFrameRate().maxVal);
    EXPECT_GE(0, videoCaps->GetSupportedEncodeQuality().minVal);
    EXPECT_GE(0, videoCaps->GetSupportedEncodeQuality().maxVal);
    ...
    EXPECT_GT(0, videoCaps->GetSupportedFormats().size());
    EXPECT_GT(0, videoCaps->GetSupportedProfiles().size());
    EXPECT_GT(0, videoCaps->GetSupportedBitrateMode().size());
    EXPECT_GE(0, videoCaps->GetSupportedLevels().size());
    EXPECT_EQ(false, videoCaps->IsSupportDynamicIframe());
}
...
void CapsUnitTest::CheckAVDecMP3(const std::shared_ptr<AudioCaps> &audioCaps) const
{
    ...
    EXPECT_LE(MIN_AUDIO_BITRATE, audioCaps->GetSupportedBitrate().minVal);
    EXPECT_GE(MAX_AUDIO_BITRATE, audioCaps->GetSupportedBitrate().maxVal);
    EXPECT_LE(1, audioCaps->GetSupportedChannel().minVal);
    EXPECT_GE(MAX_CHANNEL_COUNT_MP3, audioCaps->GetSupportedChannel().maxVal);
    EXPECT_GE(0, audioCaps->GetSupportedComplexity().minVal);
    EXPECT_GE(0, audioCaps->GetSupportedComplexity().maxVal);
    EXPECT_GE(0, audioCaps->GetSupportedFormats().size());
    EXPECT_GT(0, audioCaps->GetSupportedSampleRates().size());
    EXPECT_GE(0, audioCaps->GetSupportedProfiles().size());
    EXPECT_GE(0, audioCaps->GetSupportedLevels().size());
}
...
void CapsUnitTest::CheckAVEncMP3(const std::shared_ptr<AudioCaps> &audioCaps) const
{
    ...
    EXPECT_EQ(1, audioCodecCaps->IsSoftwareOnly());
    EXPECT_EQ(0, audioCodecCaps->IsVendor());
    EXPECT_LE(8000, audioCaps->GetSupportedBitrate().minVal); // 8000: max bitrate
    EXPECT_GE(MAX_AUDIO_BITRATE, audioCaps->GetSupportedBitrate().maxVal);
    EXPECT_LE(1, audioCaps->GetSupportedChannel().minVal);
    EXPECT_GE(MAX_CHANNEL_COUNT_MP3, audioCaps->GetSupportedChannel().maxVal);
    EXPECT_GE(0, audioCaps->GetSupportedComplexity().minVal);
...
void CapsUnitTest::CheckAVDecAAC(const std::shared_ptr<AudioCaps> &audioCaps) const
{
    ...
    EXPECT_EQ(1, audioCodecCaps->IsSoftwareOnly());
    EXPECT_EQ(0, audioCodecCaps->IsVendor());
    EXPECT_LE(8000, audioCaps->GetSupportedBitrate().minVal);   // 8000: min supported bitrate
    EXPECT_GE(960000, audioCaps->GetSupportedBitrate().maxVal); // 960000: max supported bitrate
    EXPECT_LE(1, audioCaps->GetSupportedChannel().minVal);
    EXPECT_GE(MAX_CHANNEL_COUNT, audioCaps->GetSupportedChannel().maxVal);      // 8: max channal count
    EXPECT_GE(0, audioCaps->GetSupportedComplexity().minVal);
    EXPECT_GE(0, audioCaps->GetSupportedComplexity().maxVal);
    EXPECT_GE(0, audioCaps->GetSupportedFormats().size());
    EXPECT_GT(0, audioCaps->GetSupportedSampleRates().size());
...
void CapsUnitTest::CheckAVDecVorbis(const std::shared_ptr<AudioCaps> &audioCaps) const
{
    ...
    EXPECT_EQ(1, audioCodecCaps->IsSoftwareOnly());
    EXPECT_EQ(0, audioCodecCaps->IsVendor());
    EXPECT_LE(32000, audioCaps->GetSupportedBitrate().minVal);  // 32000: min supported bitrate
    EXPECT_GE(500000, audioCaps->GetSupportedBitrate().maxVal); // 500000: max supported bitrate
    EXPECT_LE(1, audioCaps->GetSupportedChannel().minVal);
    EXPECT_GE(MAX_CHANNEL_COUNT, audioCaps->GetSupportedChannel().maxVal);      // 8: max channal count
    EXPECT_GE(0, audioCaps->GetSupportedComplexity().minVal);
    EXPECT_GE(0, audioCaps->GetSupportedComplexity().maxVal);
...
void CapsUnitTest::CheckAVDecFlac(const std::shared_ptr<AudioCaps> &audioCaps) const
{
    ...
    EXPECT_EQ(1, audioCodecCaps->IsSoftwareOnly());
    EXPECT_EQ(0, audioCodecCaps->IsVendor());
    EXPECT_LE(1, audioCaps->GetSupportedBitrate().minVal);
    EXPECT_GE(1536000, audioCaps->GetSupportedBitrate().maxVal); // 1536000: max supported bitrate
    EXPECT_LE(1, audioCaps->GetSupportedChannel().minVal);
    EXPECT_GE(MAX_CHANNEL_COUNT, audioCaps->GetSupportedChannel().maxVal);
    EXPECT_GE(0, audioCaps->GetSupportedComplexity().minVal);
    EXPECT_GE(0, audioCaps->GetSupportedComplexity().maxVal);
    EXPECT_GE(0, audioCaps->GetSupportedFormats().size());
    EXPECT_GT(0, audioCaps->GetSupportedSampleRates().size());
...
void CapsUnitTest::CheckAVEncFlac(const std::shared_ptr<AudioCaps> &audioCaps) const
{
    ...
    EXPECT_LE(1, audioCaps->GetSupportedChannel().minVal);
    EXPECT_GE(MAX_CHANNEL_COUNT, audioCaps->GetSupportedChannel().maxVal);
    EXPECT_LE(-2, audioCaps->GetSupportedComplexity().minVal); // -2: min complexity
    EXPECT_GE(2, audioCaps->GetSupportedComplexity().maxVal); // 2: max complexity
    EXPECT_GE(0, audioCaps->GetSupportedFormats().size());
    EXPECT_GT(0, audioCaps->GetSupportedSampleRates().size());
    EXPECT_GE(0, audioCaps->GetSupportedProfiles().size());
    EXPECT_GE(0, audioCaps->GetSupportedLevels().size());
...
void CapsUnitTest::CheckAVDecOpus(const std::shared_ptr<AudioCaps> &audioCaps) const
{
    ...
    EXPECT_GE(MAX_AUDIO_BITRATE, audioCaps->GetSupportedBitrate().maxVal);
    EXPECT_LE(1, audioCaps->GetSupportedChannel().minVal);
    EXPECT_GE(2, audioCaps->GetSupportedChannel().maxVal); // 2: opus support max 2 channels
    EXPECT_GE(0, audioCaps->GetSupportedComplexity().minVal);
    EXPECT_GE(0, audioCaps->GetSupportedComplexity().maxVal);
    EXPECT_GT(0, audioCaps->GetSupportedFormats().size());
    EXPECT_GT(0, audioCaps->GetSupportedSampleRates().size());
    EXPECT_GE(0, audioCaps->GetSupportedProfiles().size());
    EXPECT_GE(0, audioCaps->GetSupportedLevels().size());
}
...
void CapsUnitTest::CheckAVDecVivid(const std::shared_ptr<AudioCaps> &audioCaps) const
{
    ...
    EXPECT_EQ(1, audioCodecCaps->IsSoftwareOnly());
    EXPECT_EQ(0, audioCodecCaps->IsVendor());
    EXPECT_LE(AUDIO_MIN_BIT_RATE_VIVID_DECODER, audioCaps->GetSupportedBitrate().minVal);
    EXPECT_GE(AUDIO_MAX_BIT_RATE_VIVID_DECODER, audioCaps->GetSupportedBitrate().maxVal);
    EXPECT_LE(1, audioCaps->GetSupportedChannel().minVal);
    EXPECT_GE(AUDIO_MAX_CHANNEL_COUNT_VIVID, audioCaps->GetSupportedChannel().maxVal);
    EXPECT_GT(0, audioCaps->GetSupportedSampleRates().size());
}
...
void CapsUnitTest::CheckAVEncAAC(const std::shared_ptr<AudioCaps> &audioCaps) const
{
    ...
    EXPECT_EQ(0, audioCodecCaps->IsVendor());
    EXPECT_LE(1, audioCaps->GetSupportedBitrate().minVal);
    EXPECT_GE(MAX_AUDIO_BITRATE_AAC, audioCaps->GetSupportedBitrate().maxVal);
    EXPECT_LE(1, audioCaps->GetSupportedChannel().minVal);
    EXPECT_GE(MAX_CHANNEL_COUNT, audioCaps->GetSupportedChannel().maxVal);
    ...
    EXPECT_GE(0, audioCaps->GetSupportedFormats().size());
    EXPECT_GT(0, audioCaps->GetSupportedSampleRates().size());
    EXPECT_GT(0, audioCaps->GetSupportedProfiles().size());
    auto profilesVec = audioCaps->GetSupportedProfiles();
    EXPECT_GE(0, profilesVec.at(0));
    EXPECT_GE(0, audioCaps->GetSupportedLevels().size());
}
...
void CapsUnitTest::CheckAVEncOpus(const std::shared_ptr<AudioCaps> &audioCaps) const
{
    ...
    EXPECT_EQ(1, audioCodecCaps->IsSoftwareOnly());
    EXPECT_EQ(0, audioCodecCaps->IsVendor());
    EXPECT_LE(6000, audioCaps->GetSupportedBitrate().minVal); // 6000: opus min bitrate
    EXPECT_GE(510000, audioCaps->GetSupportedBitrate().maxVal); // 510000: opus max bitrate
    EXPECT_LE(1, audioCaps->GetSupportedChannel().minVal);
    EXPECT_GE(2, audioCaps->GetSupportedChannel().maxVal); // 2: opus support max 2 channels
    EXPECT_LE(1, audioCaps->GetSupportedComplexity().minVal);
    EXPECT_GE(10, audioCaps->GetSupportedComplexity().maxVal); // 10: opus complexity max
    EXPECT_GE(0, audioCaps->GetSupportedFormats().size());
    EXPECT_GT(0, audioCaps->GetSupportedSampleRates().size()); // 5: opus encode support 5 sample rates
    EXPECT_GT(0, audioCaps->GetSupportedProfiles().size());
    EXPECT_GT(0, audioCaps->GetSupportedLevels().size());
}
...
void CapsUnitTest::CheckAVEncAmrnb(const std::shared_ptr<AudioCaps> &audioCaps) const
{
    ...
    EXPECT_EQ(1, audioCodecCaps->IsSoftwareOnly());
    EXPECT_EQ(0, audioCodecCaps->IsVendor());
    EXPECT_LE(4750, audioCaps->GetSupportedBitrate().minVal); // 4750: amrnb min bitrate
    EXPECT_GT(12200, audioCaps->GetSupportedBitrate().maxVal); // 12200: amrnb max bitrate
    EXPECT_LE(1, audioCaps->GetSupportedChannel().minVal);
    EXPECT_GE(1, audioCaps->GetSupportedChannel().maxVal);
    EXPECT_GE(0, audioCaps->GetSupportedComplexity().minVal);
    EXPECT_GE(0, audioCaps->GetSupportedComplexity().maxVal);
    EXPECT_GE(0, audioCaps->GetSupportedFormats().size());
    EXPECT_GT(0, audioCaps->GetSupportedSampleRates().size());
...
void CapsUnitTest::CheckAVDecAmrnb(const std::shared_ptr<AudioCaps> &audioCaps) const
{
    ...
    EXPECT_EQ(0, audioCodecCaps->IsVendor());
    EXPECT_LE(4750, audioCaps->GetSupportedBitrate().minVal); // 4750: amrnb min bitrate
    EXPECT_GE(12200, audioCaps->GetSupportedBitrate().maxVal); // 12200: amrnb max bitrate
    EXPECT_GT(0, audioCaps->GetSupportedChannel().minVal);
    EXPECT_GT(0, audioCaps->GetSupportedChannel().maxVal);
    EXPECT_GE(0, audioCaps->GetSupportedComplexity().minVal);
    EXPECT_GE(0, audioCaps->GetSupportedComplexity().maxVal);
    EXPECT_GE(0, audioCaps->GetSupportedFormats().size());
    EXPECT_GT(0, audioCaps->GetSupportedSampleRates().size());
...
void CapsUnitTest::CheckAVEncAmrwb(const std::shared_ptr<AudioCaps> &audioCaps) const
{
    ...
    EXPECT_EQ(1, audioCodecCaps->IsSoftwareOnly());
    EXPECT_EQ(0, audioCodecCaps->IsVendor());
    EXPECT_LE(6600, audioCaps->GetSupportedBitrate().minVal); // 6600: amrwb min bitrate
    EXPECT_GE(23850, audioCaps->GetSupportedBitrate().maxVal); // 23850: amrwb max bitrate
    EXPECT_GT(0, audioCaps->GetSupportedChannel().minVal);
    EXPECT_GT(0, audioCaps->GetSupportedChannel().maxVal);
    EXPECT_GE(0, audioCaps->GetSupportedComplexity().minVal);
    EXPECT_GE(0, audioCaps->GetSupportedComplexity().maxVal);
...
void CapsUnitTest::CheckAVEncG711mu(const std::shared_ptr<AudioCaps> &audioCaps) const
{
    ...
    EXPECT_EQ(1, audioCodecCaps->IsSoftwareOnly());
    EXPECT_EQ(0, audioCodecCaps->IsVendor());
    EXPECT_LE(64000, audioCaps->GetSupportedBitrate().minVal); // 64000: g711mu only support 64000 bitrate
    EXPECT_GE(64000, audioCaps->GetSupportedBitrate().maxVal); // 64000: g711mu only support 64000 bitrate
    EXPECT_GT(0, audioCaps->GetSupportedChannel().minVal);
    EXPECT_GT(0, audioCaps->GetSupportedChannel().maxVal);
    EXPECT_GE(0, audioCaps->GetSupportedComplexity().minVal);
    EXPECT_GE(0, audioCaps->GetSupportedComplexity().maxVal);
