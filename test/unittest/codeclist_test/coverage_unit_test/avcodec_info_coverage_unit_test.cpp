...
{
    height_ = 30;
    auto ret = videoCaps_->GetVideoWidthRangeForHeight(height_);
    (void) ret;
}
...
{
    width_ = 30;
    auto ret = videoCaps_->GetVideoHeightRangeForWidth(width_);
    (void) ret;
}
...
HWTEST_F(AVCodecInfoTest, GetVideoHeightRangeForWidth_Valid_Test_003, TestSize.Level1)
{
    ...
    auto ret = videoCaps_->GetVideoHeightRangeForWidth(height_);
    (void) ret;
}
...
HWTEST_F(AVCodecInfoTest, GetSupportedFrameRatesFor_Valid_Test_001, TestSize.Level1)
{
    width_ = 0;
    height_ = 0;
    auto ret = videoCaps_->GetSupportedFrameRatesFor(width_, height_);
    (void) ret;
}
