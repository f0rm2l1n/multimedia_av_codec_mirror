...
public:
    Source() = default;
    ~Source() override {}
    MOCK_METHOD(Status, SetSource, (const std::shared_ptr<Plugins::MediaSource>& source), ());
    ...
    MOCK_METHOD(Status, Read, (int32_t streamID,
        std::shared_ptr<Plugins::Buffer>& buffer, uint64_t offset, size_t expectedLen), ());
    ...
    MOCK_METHOD(Status, InitPlugin, (const std::shared_ptr<Plugins::MediaSource>& source), ());
    MOCK_METHOD(std::string, GetUriSuffix, (const std::string& uri), ());
    MOCK_METHOD(bool, GetProtocolByUri, (), ());
    MOCK_METHOD(bool, ParseProtocol, (const std::shared_ptr<Plugins::MediaSource>& source), ());
    MOCK_METHOD(Status, FindPlugin, (const std::shared_ptr<Plugins::MediaSource>& source), ());
