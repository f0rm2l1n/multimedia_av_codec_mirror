...
constexpr string_view COOK_FILE_TODEMUX = "/data/test/media/dts.avi";
constexpr string_view OUTPUT_COOK_PCM_FILE_PATH = "/data/test/media/test_decoder_dts.pcm";
constexpr string_view INPUT_DTS_1_PATH = "/data/test/media/8000_mono_dts.avi";
constexpr string_view INPUT_DTS_2_PATH = "/data/test/media/16000_mono_dts.avi";
constexpr string_view INPUT_DTS_3_PATH = "/data/test/media/32000_stereo_dts.avi";
constexpr string_view INPUT_DTS_4_PATH = "/data/test/media/11025_stereo_dts.avi";
constexpr string_view INPUT_DTS_5_PATH = "/data/test/media/22050_quad_side_dts.avi";
constexpr string_view INPUT_DTS_6_PATH = "/data/test/media/44100_quad_side_dts.avi";
constexpr string_view INPUT_DTS_7_PATH = "/data/test/media/12000_50_dts.avi";
constexpr string_view INPUT_DTS_8_PATH = "/data/test/media/24000_50_dts.avi";
constexpr string_view INPUT_DTS_9_PATH = "/data/test/media/48000_51_dts.avi";

constexpr string_view OUTPUT_DTS_PCM_1_PATH = "/data/test/media/test_8000_mono_dts.pcm";
constexpr string_view OUTPUT_DTS_PCM_2_PATH = "/data/test/media/test_16000_mono_dts.pcm";
constexpr string_view OUTPUT_DTS_PCM_3_PATH = "/data/test/media/test_32000_stereo_dts.pcm";
constexpr string_view OUTPUT_DTS_PCM_4_PATH = "/data/test/media/test_11025_stereo_dts.pcm";
constexpr string_view OUTPUT_DTS_PCM_5_PATH = "/data/test/media/test_22050_quad_side_dts.pcm";
constexpr string_view OUTPUT_DTS_PCM_6_PATH = "/data/test/media/test_44100_quad_side_dts.pcm";
constexpr string_view OUTPUT_DTS_PCM_7_PATH = "/data/test/media/test_12000_50_dts.pcm";
constexpr string_view OUTPUT_DTS_PCM_8_PATH = "/data/test/media/test_24000_50_dts.pcm";
constexpr string_view OUTPUT_DTS_PCM_9_PATH = "/data/test/media/test_48000_51_dts.pcm";
...
class AudioCodeDtsDecoderUnitTest : public testing::Test {
public:
...
int32_t AudioCodeDtsDecoderUnitTest::InitFile()
{
    ...
    int fd = open(COOK_FILE_TODEMUX.data(), O_RDONLY);
    int64_t size = GetFileSize(COOK_FILE_TODEMUX.data());
    cout << COOK_FILE_TODEMUX.data() << "----------------------" << fd << "---------" << size << endl;
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, CheckSampleFormat_Dts_001, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(INPUT_DTS_1_PATH, OUTPUT_DTS_PCM_1_PATH));
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, CheckSampleFormat_Dts_002, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(INPUT_DTS_2_PATH, OUTPUT_DTS_PCM_2_PATH));
    ASSERT_EQ(AV_ERR_OK, CreateCodecFunc());
    OH_AVFormat *fmt = OH_AVFormat_Create();
    EXPECT_EQ(AV_ERR_OK, OH_AudioCodec_Reset(audioDec_));
    OH_AVFormat_SetIntValue(fmt, MediaDescriptionKey::MD_KEY_CHANNEL_COUNT.data(), 1);
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, CheckSampleFormat_Dts_003, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(INPUT_DTS_3_PATH, OUTPUT_DTS_PCM_3_PATH));
    ASSERT_EQ(AV_ERR_OK, CreateCodecFunc());
    OH_AVFormat *fmt = OH_AVFormat_Create();
    EXPECT_EQ(AV_ERR_OK, OH_AudioCodec_Reset(audioDec_));
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, CheckSampleFormat_Dts_004, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(INPUT_DTS_4_PATH, OUTPUT_DTS_PCM_4_PATH));
    ASSERT_EQ(AV_ERR_OK, CreateCodecFunc());
    OH_AVFormat *fmt = OH_AVFormat_Create();
    EXPECT_EQ(AV_ERR_OK, OH_AudioCodec_Reset(audioDec_));
    OH_AVFormat_SetIntValue(fmt, MediaDescriptionKey::MD_KEY_CHANNEL_COUNT.data(), 2);
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, CheckSampleFormat_Dts_005, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(INPUT_DTS_5_PATH, OUTPUT_DTS_PCM_5_PATH));
    ASSERT_EQ(AV_ERR_OK, CreateCodecFunc());
    OH_AVFormat *fmt = OH_AVFormat_Create();
    EXPECT_EQ(AV_ERR_OK, OH_AudioCodec_Reset(audioDec_));
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, CheckSampleFormat_Dts_006, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(INPUT_DTS_6_PATH, OUTPUT_DTS_PCM_6_PATH));
    ASSERT_EQ(AV_ERR_OK, CreateCodecFunc());
    OH_AVFormat *fmt = OH_AVFormat_Create();
    EXPECT_EQ(AV_ERR_OK, OH_AudioCodec_Reset(audioDec_));
    OH_AVFormat_SetIntValue(fmt, MediaDescriptionKey::MD_KEY_CHANNEL_COUNT.data(), 4);
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, CheckSampleFormat_Dts_007, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(INPUT_DTS_7_PATH, OUTPUT_DTS_PCM_7_PATH));
    ASSERT_EQ(AV_ERR_OK, CreateCodecFunc());
    OH_AVFormat *fmt = OH_AVFormat_Create();
    EXPECT_EQ(AV_ERR_OK, OH_AudioCodec_Reset(audioDec_));
    ...
    OH_AVFormat_SetIntValue(fmt, MediaDescriptionKey::MD_KEY_SAMPLE_RATE.data(), 12000);
    OH_AVFormat_SetIntValue(fmt, MediaDescriptionKey::MD_KEY_AUDIO_SAMPLE_FORMAT.data(),
        AVSampleFormat::AV_SAMPLE_FMT_FLTP);
    EXPECT_EQ(AV_ERR_OK, OH_AudioCodec_Configure(audioDec_, fmt));
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Start());
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, CheckSampleFormat_Dts_008, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(INPUT_DTS_8_PATH, OUTPUT_DTS_PCM_8_PATH));
    ASSERT_EQ(AV_ERR_OK, CreateCodecFunc());
    OH_AVFormat *fmt = OH_AVFormat_Create();
    EXPECT_EQ(AV_ERR_OK, OH_AudioCodec_Reset(audioDec_));
    OH_AVFormat_SetIntValue(fmt, MediaDescriptionKey::MD_KEY_CHANNEL_COUNT.data(), 5);
    OH_AVFormat_SetLongValue(fmt, MediaDescriptionKey::MD_KEY_CHANNEL_LAYOUT.data(),
        OH_AudioChannelLayout::CH_LAYOUT_5POINT0);
    OH_AVFormat_SetIntValue(fmt, MediaDescriptionKey::MD_KEY_SAMPLE_RATE.data(), 24000);
    OH_AVFormat_SetIntValue(fmt, MediaDescriptionKey::MD_KEY_AUDIO_SAMPLE_FORMAT.data(),
        AVSampleFormat::AV_SAMPLE_FMT_FLTP);
    EXPECT_EQ(AV_ERR_OK, OH_AudioCodec_Configure(audioDec_, fmt));
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Start());
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, CheckSampleFormat_Dts_009, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(INPUT_DTS_9_PATH, OUTPUT_DTS_PCM_9_PATH));
    ASSERT_EQ(AV_ERR_OK, CreateCodecFunc());
    OH_AVFormat *fmt = OH_AVFormat_Create();
    EXPECT_EQ(AV_ERR_OK, OH_AudioCodec_Reset(audioDec_));
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, audioDecoder_Dts_CreateByName_01, TestSize.Level1)
{
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, audioDecoder_Dts_CreateByName_02, TestSize.Level1)
{
    audioDec_ = OH_AudioCodec_CreateByName(nullptr);
    EXPECT_EQ(nullptr, audioDec_);
}

HWTEST_F(AudioCodeDtsDecoderUnitTest, audioDecoder_Dts_CreateByName_03, TestSize.Level1)
{
    audioDec_ = OH_AudioCodec_CreateByName("audio_dts_msdecoder");
    EXPECT_EQ(nullptr, audioDec_);
}

HWTEST_F(AudioCodeDtsDecoderUnitTest, audioDecoder_Dts_CreateByMime_01, TestSize.Level1)
{
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, audioDecoder_Dts_CreateByMime_02, TestSize.Level1)
{
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, capability_001, TestSize.Level1)
{
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, CheckSampleInvalidFormat_Dts_001, TestSize.Level1)
{
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, CheckSampleInvalidFormat_Dts_002, TestSize.Level1)
{
    uint32_t bitRate = 13000;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile());
    ASSERT_EQ(AV_ERR_OK, CreateCodecFunc());
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, audioDecoder_Dts_PushInputData_InvalidIndex_01, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile());
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, audioDecoder_Dts_ReleaseOutputBuffer_InvalidIndex_01, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile());
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Configure());
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, audioDecoder_Dts_Configure_01, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Configure());
    Release();
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, audioDecoder_Dts_SetParameter_01, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile());
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, audioDecoder_Dts_SetParameter_02, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Configure());
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, audioDecoder_Dts_Start_01, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile());
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, audioDecoder_Dts_Start_02, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile());
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Configure());
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, audioDecoder_Dts_Stop_01, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile());
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, audioDecoder_Dts_Flush_01, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile());
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, audioDecoder_Dts_Reset_01, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Configure());
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, audioDecoder_Dts_Reset_02, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile());
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, audioDecoder_Dts_Reset_03, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile());
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, audioDecoder_Dts_Destroy_01, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile());
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, audioDecoder_Dts_Destroy_02, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile());
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Configure());
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, audioDecoder_Dts_GetOutputFormat_01, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile());
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Configure());
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, audioDecoder_Dts_IsValid_01, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    bool isValid = false;
...
HWTEST_F(AudioCodeDtsDecoderUnitTest, audioDecoder_Dts_Prepare_01, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Configure());
