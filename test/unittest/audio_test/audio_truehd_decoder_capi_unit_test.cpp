...
namespace {
const string CODEC_TRUEHD_NAME = std::string(std::string(AVCodecCodecName::AUDIO_DECODER_TRUEHD_NAME));
constexpr int32_t MAX_CHANNELS = 8;
constexpr uint32_t DEFAULT_SAMPLE_RATE = 48000;
constexpr string_view TRUEHD_FILE_TODEMUX = "/data/test/media/truehd.mkv";
constexpr string_view OUTPUT_TRUEHD_PCM_FILE_PATH = "/data/test/media/test_decoder_truehd.pcm";
constexpr string_view INPUT_TRUEHD_WAV_1_PATH = "/data/test/media/truehd_44100_stereo.mp4";
constexpr string_view INPUT_TRUEHD_WAV_3_PATH = "/data/test/media/truehd_48000_50side.mp4";
constexpr string_view INPUT_TRUEHD_WAV_4_PATH = "/data/test/media/truehd_192000_51side.mp4";
constexpr string_view INPUT_TRUEHD_WAV_6_PATH = "/data/test/media/truehd_88200_21.mp4";
constexpr string_view INPUT_TRUEHD_WAV_7_PATH = "/data/test/media/truehd_96000_30.mp4";
constexpr string_view INPUT_TRUEHD_WAV_8_PATH = "/data/test/media/truehd_176400_31.mp4";

constexpr string_view OUTPUT_TRUEHD_PCM_1_PATH = "/data/test/media/truehd_44100_stereo.pcm";
constexpr string_view OUTPUT_TRUEHD_PCM_3_PATH = "/data/test/media/truehd_48000_50side.pcm";
constexpr string_view OUTPUT_TRUEHD_PCM_4_PATH = "/data/test/media/truehd_192000_51side.pcm";
constexpr string_view OUTPUT_TRUEHD_PCM_6_PATH = "/data/test/media/truehd_88200_21.pcm";
constexpr string_view OUTPUT_TRUEHD_PCM_7_PATH = "/data/test/media/truehd_96000_30.pcm";
constexpr string_view OUTPUT_TRUEHD_PCM_8_PATH = "/data/test/media/truehd_176400_31.pcm";
constexpr string_view OUTPUT_TRUEHD_PCM_10_PATH = "/data/test/media/truehd.pcm";
...
{
    if (!pcmOutputFile_.is_open()) {
        std::cout << "open " << OUTPUT_TRUEHD_PCM_FILE_PATH << " failed!" << std::endl;
    }
    while (isRunning_.load()) {
...
int32_t AudioCodeTrueHDDecoderUnitTest::InitFile(string_view input)
{
    inputFile_.open(input.data(), std::ios::binary);
    pcmOutputFile_.open(OUTPUT_TRUEHD_PCM_FILE_PATH.data(), std::ios::out | std::ios::binary);
    if (!inputFile_.is_open()) {
...
int32_t AudioCodeTrueHDDecoderUnitTest::InitFile(string_view input, string_view output)
{
    inputFile_.open(input.data(), std::ios::binary);
    if (!inputFile_.is_open()) {
...
{
    audioDec_ = OH_AudioCodec_CreateByName((std::string(AVCodecCodecName::AUDIO_DECODER_TRUEHD_NAME)).data());
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, AudioDemuxAndDecode_TRUEHD_001, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(TRUEHD_FILE_TODEMUX, OUTPUT_TRUEHD_PCM_FILE_PATH));
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, CheckSampleFormat_TRUEHD_001, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(INPUT_TRUEHD_WAV_1_PATH, OUTPUT_TRUEHD_PCM_1_PATH));
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, CheckSampleFormat_TRUEHD_003, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(INPUT_TRUEHD_WAV_3_PATH, OUTPUT_TRUEHD_PCM_3_PATH));
    ASSERT_EQ(AV_ERR_OK, CreateCodecFunc());
    OH_AVFormat *fmt = OH_AVFormat_Create();
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, CheckSampleFormat_TRUEHD_004, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(INPUT_TRUEHD_WAV_4_PATH, OUTPUT_TRUEHD_PCM_4_PATH));
    ASSERT_EQ(AV_ERR_OK, CreateCodecFunc());
    OH_AVFormat *fmt = OH_AVFormat_Create();
    OH_AVFormat_SetIntValue(fmt, MediaDescriptionKey::MD_KEY_CHANNEL_COUNT.data(), 6);
    OH_AVFormat_SetLongValue(fmt, MediaDescriptionKey::MD_KEY_CHANNEL_LAYOUT.data(),
        OH_AudioChannelLayout::CH_LAYOUT_5POINT1);
    OH_AVFormat_SetIntValue(fmt, MediaDescriptionKey::MD_KEY_SAMPLE_RATE.data(), 192000);
    OH_AVFormat_SetIntValue(fmt, MediaDescriptionKey::MD_KEY_AUDIO_SAMPLE_FORMAT.data(),
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, CheckSampleFormat_TRUEHD_006, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(INPUT_TRUEHD_WAV_6_PATH, OUTPUT_TRUEHD_PCM_6_PATH));
    ASSERT_EQ(AV_ERR_OK, CreateCodecFunc());
    OH_AVFormat *fmt = OH_AVFormat_Create();
    OH_AVFormat_SetIntValue(fmt, MediaDescriptionKey::MD_KEY_CHANNEL_COUNT.data(), 3);
    OH_AVFormat_SetLongValue(fmt, MediaDescriptionKey::MD_KEY_CHANNEL_LAYOUT.data(),
        OH_AudioChannelLayout::CH_LAYOUT_2POINT1);
    OH_AVFormat_SetIntValue(fmt, MediaDescriptionKey::MD_KEY_SAMPLE_RATE.data(), 88200);
    OH_AVFormat_SetIntValue(fmt, MediaDescriptionKey::MD_KEY_AUDIO_SAMPLE_FORMAT.data(),
        AudioSampleFormat::SAMPLE_S24LE);
    EXPECT_EQ(AV_ERR_OK, OH_AudioCodec_Configure(audioDec_, fmt));
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Start());
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, CheckSampleFormat_TRUEHD_007, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(INPUT_TRUEHD_WAV_7_PATH, OUTPUT_TRUEHD_PCM_7_PATH));
    ASSERT_EQ(AV_ERR_OK, CreateCodecFunc());
    OH_AVFormat *fmt = OH_AVFormat_Create();
    OH_AVFormat_SetIntValue(fmt, MediaDescriptionKey::MD_KEY_CHANNEL_COUNT.data(), 3);
    OH_AVFormat_SetLongValue(fmt, MediaDescriptionKey::MD_KEY_CHANNEL_LAYOUT.data(),
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, CheckSampleFormat_TRUEHD_008, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(INPUT_TRUEHD_WAV_8_PATH, OUTPUT_TRUEHD_PCM_8_PATH));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    OH_AVFormat *fmt = OH_AVFormat_Create();
    OH_AVFormat_SetIntValue(fmt, MediaDescriptionKey::MD_KEY_CHANNEL_COUNT.data(), 4);
    OH_AVFormat_SetLongValue(fmt, MediaDescriptionKey::MD_KEY_CHANNEL_LAYOUT.data(),
        OH_AudioChannelLayout::CH_LAYOUT_3POINT1);
    OH_AVFormat_SetIntValue(fmt, MediaDescriptionKey::MD_KEY_SAMPLE_RATE.data(), 176400);
    OH_AVFormat_SetIntValue(fmt, MediaDescriptionKey::MD_KEY_AUDIO_SAMPLE_FORMAT.data(),
        AudioSampleFormat::SAMPLE_S32LE);
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, Callback_TRUEHD_001, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(INPUT_TRUEHD_WAV_7_PATH, OUTPUT_TRUEHD_PCM_7_PATH));
    ASSERT_EQ(AV_ERR_OK, CreateCodecFunc());
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, Callback_TRUEHD_002, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(INPUT_TRUEHD_WAV_8_PATH, OUTPUT_TRUEHD_PCM_8_PATH));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, Callback_TRUEHD_003, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(INPUT_TRUEHD_WAV_6_PATH, OUTPUT_TRUEHD_PCM_6_PATH));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    OH_AVFormat *fmt = OH_AVFormat_Create();
    OH_AVFormat_SetIntValue(fmt, MediaDescriptionKey::MD_KEY_CHANNEL_COUNT.data(), 4);
    ASSERT_EQ(true, OH_AVFormat_SetLongValue(fmt, MediaDescriptionKey::MD_KEY_CHANNEL_LAYOUT.data(),
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, capability_001, TestSize.Level1)
{
    OH_AVCapability *cap = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_AUDIO_TRUEHD, false, SOFTWARE);
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, CheckSampleInvalidFormat_TRUEHD_001, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(TRUEHD_FILE_TODEMUX, OUTPUT_TRUEHD_PCM_10_PATH));
    ASSERT_EQ(AV_ERR_OK, CreateCodecFunc());
    OH_AVFormat *fmt = OH_AVFormat_Create();
    OH_AVFormat_SetIntValue(fmt, MediaDescriptionKey::MD_KEY_CHANNEL_COUNT.data(), 5);
    OH_AVFormat_SetLongValue(fmt, MediaDescriptionKey::MD_KEY_CHANNEL_LAYOUT.data(),
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, CheckSampleInvalidFormat_TRUEHD_002, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(TRUEHD_FILE_TODEMUX, OUTPUT_TRUEHD_PCM_10_PATH));
    ASSERT_EQ(AV_ERR_OK, CreateCodecFunc());
    OH_AVFormat *fmt = OH_AVFormat_Create();
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, audioDecoder_TRUEHD_CreateByName_01, TestSize.Level1)
{
    audioDec_ = OH_AudioCodec_CreateByName((std::string(AVCodecCodecName::AUDIO_DECODER_TRUEHD_NAME)).data());
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, audioDecoder_TRUEHD_CreateByName_02, TestSize.Level1)
{
    audioDec_ = OH_AudioCodec_CreateByName(nullptr);
    EXPECT_EQ(nullptr, audioDec_);
}

HWTEST_F(AudioCodeTrueHDDecoderUnitTest, audioDecoder_TRUEHD_CreateByName_03, TestSize.Level1)
{
    audioDec_ = OH_AudioCodec_CreateByName("audio_decoder.eac3");
    EXPECT_EQ(nullptr, audioDec_);
}

HWTEST_F(AudioCodeTrueHDDecoderUnitTest, audioDecoder_TRUEHD_CreateByMime_01, TestSize.Level1)
{
    audioDec_ = OH_AudioCodec_CreateByMime(std::string(AVCodecMimeType::MEDIA_MIMETYPE_AUDIO_TRUEHD).data(), false);
    EXPECT_NE(nullptr, audioDec_);
    Release();
}

HWTEST_F(AudioCodeTrueHDDecoderUnitTest, audioDecoder_TRUEHD_CreateByMime_02, TestSize.Level1)
{
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, audioDecoder_TRUEHD_PushInputData_InvalidIndex_01, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(TRUEHD_FILE_TODEMUX));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Configure());
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Start());
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, audioDecoder_TRUEHD_ReleaseOutputBuffer_InvalidIndex_01, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(TRUEHD_FILE_TODEMUX));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, audioDecoder_TRUEHD_Configure_01, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Configure());
    Release();
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, audioDecoder_TRUEHD_SetParameter_01, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(TRUEHD_FILE_TODEMUX));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, audioDecoder_TRUEHD_SetParameter_02, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Configure());
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, audioDecoder_TRUEHD_Start_01, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(TRUEHD_FILE_TODEMUX));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, audioDecoder_TRUEHD_Start_02, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(TRUEHD_FILE_TODEMUX));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Configure());
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, audioDecoder_TRUEHD_Stop_01, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(TRUEHD_FILE_TODEMUX));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, audioDecoder_TRUEHD_Flush_01, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(TRUEHD_FILE_TODEMUX));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, audioDecoder_TRUEHD_Reset_01, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Configure());
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, audioDecoder_TRUEHD_Reset_02, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(TRUEHD_FILE_TODEMUX));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, audioDecoder_TRUEHD_Reset_03, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(TRUEHD_FILE_TODEMUX));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, audioDecoder_TRUEHD_Destroy_01, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(TRUEHD_FILE_TODEMUX));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, audioDecoder_TRUEHD_Destroy_02, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(TRUEHD_FILE_TODEMUX));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Configure());
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, audioDecoder_TRUEHD_GetOutputFormat_01, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(TRUEHD_FILE_TODEMUX));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Configure());
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, audioDecoder_TRUEHD_IsValid_01, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    bool isValid = false;
...
HWTEST_F(AudioCodeTrueHDDecoderUnitTest, audioDecoder_TRUEHD_Prepare_01, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Configure());
