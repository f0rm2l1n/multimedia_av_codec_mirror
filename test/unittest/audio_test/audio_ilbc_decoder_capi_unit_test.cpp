...
namespace {
const string CODEC_ILBC_NAME = std::string(std::string(AVCodecCodecName::AUDIO_DECODER_ILBC_NAME));
...
constexpr string_view OUTPUT_Ilbc_PCM_FILE_PATH = "/data/test/media/test_decoder_ilbc.pcm";
constexpr string_view OUTPUT_Ilbc_PCM_INVALID_PATH = "/data/test/media/ilbc_mov.pcm";
...
{
    if (!pcmOutputFile_.is_open()) {
        std::cout << "open " << OUTPUT_Ilbc_PCM_FILE_PATH << " failed!" << std::endl;
    }
    while (isRunning_.load()) {
...
int32_t AudioCodeIlbcDecoderUnitTest::InitFile(string_view input)
{
    inputFile_.open(input.data(), std::ios::binary);
    pcmOutputFile_.open(OUTPUT_Ilbc_PCM_FILE_PATH.data(), std::ios::out | std::ios::binary);
    if (!inputFile_.is_open()) {
...
int32_t AudioCodeIlbcDecoderUnitTest::InitFile(string_view input, string_view output)
{
    inputFile_.open(input.data(), std::ios::binary);
    if (!inputFile_.is_open()) {
...
HWTEST_F(AudioCodeIlbcDecoderUnitTest, AudioDemuxAndDecode_Ilbc_001, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(Ilbc_FILE_TODEMUX, OUTPUT_Ilbc_PCM_FILE_PATH));
...
HWTEST_F(AudioCodeIlbcDecoderUnitTest, capability_001, TestSize.Level1)
{
    OH_AVCapability *cap = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_AUDIO_ILBC, false, SOFTWARE);
...
HWTEST_F(AudioCodeIlbcDecoderUnitTest, CheckSampleInvalidFormat_Ilbc_001, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(Ilbc_FILE_TODEMUX, OUTPUT_Ilbc_PCM_INVALID_PATH));
...
HWTEST_F(AudioCodeIlbcDecoderUnitTest, CheckSampleInvalidFormat_Ilbc_002, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(Ilbc_FILE_TODEMUX, OUTPUT_Ilbc_PCM_INVALID_PATH));
    ASSERT_EQ(AV_ERR_OK, CreateCodecFunc());
    OH_AVFormat *fmt = OH_AVFormat_Create();
...
HWTEST_F(AudioCodeIlbcDecoderUnitTest, audioDecoder_Ilbc_CreateByName_01, TestSize.Level1)
{
    audioDec_ = OH_AudioCodec_CreateByName((std::string(AVCodecCodecName::AUDIO_DECODER_ILBC_NAME)).data());
...
HWTEST_F(AudioCodeIlbcDecoderUnitTest, audioDecoder_Ilbc_CreateByName_02, TestSize.Level1)
{
    audioDec_ = OH_AudioCodec_CreateByName(nullptr);
    EXPECT_EQ(nullptr, audioDec_);
}

HWTEST_F(AudioCodeIlbcDecoderUnitTest, audioDecoder_Ilbc_CreateByName_03, TestSize.Level1)
{
    audioDec_ = OH_AudioCodec_CreateByName("audio_decoder.eac3");
    EXPECT_EQ(nullptr, audioDec_);
}

HWTEST_F(AudioCodeIlbcDecoderUnitTest, audioDecoder_Ilbc_CreateByMime_01, TestSize.Level1)
{
    audioDec_ = OH_AudioCodec_CreateByMime(std::string(AVCodecMimeType::MEDIA_MIMETYPE_AUDIO_ILBC).data(), false);
    EXPECT_NE(nullptr, audioDec_);
    Release();
}
 
HWTEST_F(AudioCodeIlbcDecoderUnitTest, audioDecoder_Ilbc_CreateByMime_02, TestSize.Level1)
{
...
HWTEST_F(AudioCodeIlbcDecoderUnitTest, audioDecoder_Ilbc_PushInputData_InvalidIndex_01, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(Ilbc_FILE_TODEMUX));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Configure());
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Start());
...
HWTEST_F(AudioCodeIlbcDecoderUnitTest, audioDecoder_Ilbc_ReleaseOutputBuffer_InvalidIndex_01, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(Ilbc_FILE_TODEMUX));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
...
HWTEST_F(AudioCodeIlbcDecoderUnitTest, audioDecoder_Ilbc_Configure_01, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Configure());
    Release();
...
HWTEST_F(AudioCodeIlbcDecoderUnitTest, audioDecoder_Ilbc_SetParameter_01, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(Ilbc_FILE_TODEMUX));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
...
HWTEST_F(AudioCodeIlbcDecoderUnitTest, audioDecoder_Ilbc_SetParameter_02, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Configure());
...
HWTEST_F(AudioCodeIlbcDecoderUnitTest, audioDecoder_Ilbc_Start_01, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(Ilbc_FILE_TODEMUX));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
...
HWTEST_F(AudioCodeIlbcDecoderUnitTest, audioDecoder_Ilbc_Start_02, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(Ilbc_FILE_TODEMUX));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Configure());
...
HWTEST_F(AudioCodeIlbcDecoderUnitTest, audioDecoder_Ilbc_Stop_01, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(Ilbc_FILE_TODEMUX));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
...
HWTEST_F(AudioCodeIlbcDecoderUnitTest, audioDecoder_Ilbc_Flush_01, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(Ilbc_FILE_TODEMUX));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
...
HWTEST_F(AudioCodeIlbcDecoderUnitTest, audioDecoder_Ilbc_Reset_01, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Configure());
...
HWTEST_F(AudioCodeIlbcDecoderUnitTest, audioDecoder_Ilbc_Reset_02, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(Ilbc_FILE_TODEMUX));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
...
HWTEST_F(AudioCodeIlbcDecoderUnitTest, audioDecoder_Ilbc_Reset_03, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(Ilbc_FILE_TODEMUX));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
...
HWTEST_F(AudioCodeIlbcDecoderUnitTest, audioDecoder_Ilbc_Destroy_01, TestSize.Level1)
{
    isTestingFormat_ = true;
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(Ilbc_FILE_TODEMUX));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
...
HWTEST_F(AudioCodeIlbcDecoderUnitTest, audioDecoder_Ilbc_Destroy_02, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(Ilbc_FILE_TODEMUX));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Configure());
...
HWTEST_F(AudioCodeIlbcDecoderUnitTest, audioDecoder_Ilbc_GetOutputFormat_01, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, InitFile(Ilbc_FILE_TODEMUX));
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Configure());
...
HWTEST_F(AudioCodeIlbcDecoderUnitTest, audioDecoder_Ilbc_IsValid_01, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    bool isValid = false;
...
HWTEST_F(AudioCodeIlbcDecoderUnitTest, audioDecoder_Ilbc_Prepare_01, TestSize.Level1)
{
    ASSERT_EQ(OH_AVErrCode::AV_ERR_OK, CreateCodecFunc());
    EXPECT_EQ(OH_AVErrCode::AV_ERR_OK, Configure());
