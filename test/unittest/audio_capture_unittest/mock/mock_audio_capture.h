...
#ifndef MOCK_AUDIO_CAPTURE_H
#define MOCK_AUDIO_CAPTURE_H
...
public:
    ...
    virtual ~MockAudioCapturer() = default;
    ...
    MOCK_METHOD(int32_t, RegisterAudioPolicyServerDiedCb,
        (const int32_t clientPid, const std::shared_ptr<AudioCapturerPolicyServiceDiedCallback> &callback),
        (override));
    ...
    MOCK_METHOD(int32_t, GetAudioTimestampInfo, (Timestamp &timestamp,
        Timestamp::Timestampbase base), (const, override));
