...
class VideoDecStableTestVC1 : public testing::TestWithParam<std::string> {
public:
...
void VideoDecStableTestVC1::SetUpTestCase(void) {}

void VideoDecStableTestVC1::TearDownTestCase(void) {}

void VideoDecStableTestVC1::SetUp(void)
{
...
void VideoDecStableTestVC1::TearDown(void)
{
    heapThread_ = nullptr;
}
...
{
    switch (path) {
        case VC1VideoPaths::VC1_PROFILE_SIMPLE:
            return "test.vc1";
 ...
 */
HWMTEST_F(VideoDecStableTestVC1, VideoDecoder_Multithread_Release_AVBuffer, TestSize.Level1,
          VideoDecSample::threadNum_)
{
    for (int i = 0; i < static_cast<int>(VC1VideoPaths::VC1_PROFILE_SIMPLE) + 1; ++i) {
        VC1VideoPaths path = static_cast<VC1VideoPaths>(i);
        std::string inputPath = getVC1InputPath(path);
        auto vdec = make_shared<VideoDecSample>();
        auto signal = make_shared<VCodecSignal>(vdec);
        vdec->frameCount_ = 300;
        vdec->mime_ = OH_AVCODEC_MIMETYPE_VIDEO_VC1;
 ...
 *           2. release not in callback;
 */
HWMTEST_F(VideoDecStableTestVC1, VideoDecoder_Multithread_Release_001, TestSize.Level1, VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
    vdec->frameCount_ = 300;
    vdec->mime_ = OH_AVCODEC_MIMETYPE_VIDEO_VC1;
    vdec->inPath_ = "test.vc1";
    vdec->outPath_ = GetTestName();
    EXPECT_EQ(vdec->Create(), true);
 ...
 */
HWMTEST_F(VideoDecStableTestVC1, VideoDecoder_Multithread_Start_Four_Times, TestSize.Level1, VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
    vdec->frameCount_ = 300;
 ...
 *           2. release not in callback;
 */
HWMTEST_F(VideoDecStableTestVC1, VideoDecoder_Multithread_CreateByMime_001,
 ...
 *           2. release not in callback;
 */
HWMTEST_F(VideoDecStableTestVC1, VideoDecoder_Multithread_CreateByMime_AVBuffer_001, TestSize.Level1,
          VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
...
INSTANTIATE_TEST_SUITE_P(, VideoDecStableTestVC1, testing::Values("Flush", "Stop", "Reset", "SetOutputSurface"));
 ...
 */
AVCODEC_MTEST_P(VideoDecStableTestVC1, VideoDecoder_Multithread_001, TestSize.Level1, VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
    vdec->operation_ = VideoDecStableTestVC1::GetParam();
    vdec->frameCount_ = 300;
    vdec->mime_ = OH_AVCODEC_MIMETYPE_VIDEO_VC1;
    vdec->inPath_ = "test.vc1";
    vdec->outPath_ = GetTestName();
 ...
 */
AVCODEC_MTEST_P(VideoDecStableTestVC1, VideoDecoder_Multithread_002, TestSize.Level1, VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
    vdec->operation_ = VideoDecStableTestVC1::GetParam();
 ...
 */
AVCODEC_MTEST_P(VideoDecStableTestVC1, VideoDecoder_Multithread_003, TestSize.Level1, VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
    vdec->operation_ = VideoDecStableTestVC1::GetParam();
 ...
 *           3. set surface;
 */
AVCODEC_MTEST_P(VideoDecStableTestVC1, VideoDecoder_Multithread_004, TestSize.Level1, VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
    vdec->operation_ = VideoDecStableTestVC1::GetParam();
 ...
 *           3. set surface;
 */
AVCODEC_MTEST_P(VideoDecStableTestVC1, VideoDecoder_Multithread_005, TestSize.Level1, VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
    vdec->operation_ = VideoDecStableTestVC1::GetParam();
 ...
 *           2. operate not in callback;
 */
AVCODEC_MTEST_P(VideoDecStableTestVC1, VideoDecoder_Multithread_With_Queue_001, TestSize.Level1,
                VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 *           2. operate in input callback;
 */
AVCODEC_MTEST_P(VideoDecStableTestVC1, VideoDecoder_Multithread_With_Queue_002, TestSize.Level1,
                VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 */
AVCODEC_MTEST_P(VideoDecStableTestVC1, VideoDecoder_Multithread_With_Queue_003, TestSize.Level1,
                VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 *           4. set surface;
 */
AVCODEC_MTEST_P(VideoDecStableTestVC1, VideoDecoder_Multithread_With_Queue_004, TestSize.Level1,
                VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 *           4. set surface;
 */
AVCODEC_MTEST_P(VideoDecStableTestVC1, VideoDecoder_Multithread_With_Queue_005, TestSize.Level1,
                VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 *           2. operate not in callback;
 */
AVCODEC_MTEST_P(VideoDecStableTestVC1, VideoDecoder_Multithread_AVBuffer_001,
                TestSize.Level1, VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 *           2. operate in input callback;
 */
AVCODEC_MTEST_P(VideoDecStableTestVC1, VideoDecoder_Multithread_AVBuffer_002,
                TestSize.Level1, VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 *           2. operate in output callback;
 */
AVCODEC_MTEST_P(VideoDecStableTestVC1, VideoDecoder_Multithread_AVBuffer_003,
                TestSize.Level1, VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 *           3. set surface;
 */
AVCODEC_MTEST_P(VideoDecStableTestVC1, VideoDecoder_Multithread_AVBuffer_004,
                TestSize.Level1, VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 *           3. set surface;
 */
AVCODEC_MTEST_P(VideoDecStableTestVC1, VideoDecoder_Multithread_AVBuffer_005,
                TestSize.Level1, VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 *           2. operate not in callback;
 */
AVCODEC_MTEST_P(VideoDecStableTestVC1, VideoDecoder_Multithread_AVBuffer_With_Queue_001, TestSize.Level1,
                VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 *           2. operate in input callback;
 */
AVCODEC_MTEST_P(VideoDecStableTestVC1, VideoDecoder_Multithread_AVBuffer_With_Queue_002, TestSize.Level1,
                VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 *           3. free buffer in queue;
 */
AVCODEC_MTEST_P(VideoDecStableTestVC1, VideoDecoder_Multithread_AVBuffer_With_Queue_003, TestSize.Level1,
                VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 *           4. set surface;
 */
AVCODEC_MTEST_P(VideoDecStableTestVC1, VideoDecoder_Multithread_AVBuffer_With_Queue_004, TestSize.Level1,
                VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 *           4. set surface;
 */
AVCODEC_MTEST_P(VideoDecStableTestVC1, VideoDecoder_Multithread_AVBuffer_With_Queue_005, TestSize.Level1,
                VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
