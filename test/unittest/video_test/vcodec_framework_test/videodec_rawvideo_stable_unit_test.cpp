...
class VideoDecStableTestRAWVIDEO : public testing::TestWithParam<std::string> {
public:
...
void VideoDecStableTestRAWVIDEO::SetUpTestCase(void) {}

void VideoDecStableTestRAWVIDEO::TearDownTestCase(void) {}

void VideoDecStableTestRAWVIDEO::SetUp(void)
{
...
void VideoDecStableTestRAWVIDEO::TearDown(void)
{
    heapThread_ = nullptr;
}
...
/**.
 * @tc.name: VideoDecoder_rawvideodecoder_Release_001
 * @tc.desc: 1. push/free buffer in callback;
 *           2. release not in callback;
 */
HWMTEST_F(VideoDecStableTestRAWVIDEO, VideoDecoder_rawvideodecoder_Release_001,
          TestSize.Level1, VideoDecSample::threadNum_)
{
    ...
    vdec->mime_ = OH_AVCODEC_MIMETYPE_VIDEO_RAWVIDEO;
    vdec->inPath_ = "rawvideo.dat";
    vdec->sampleWidth_ = 720;
    vdec->sampleHeight_ = 480;
    vdec->releaseOtherBuffer_ = true;
    vdec->outPath_ = GetTestName();
    vdec->dumpKey_ = "rawvideodecoder.dump";
    vdec->dumpValue_ = "11";
    vdec->setRawVideoPixFmt_ = true;
    vdec->rawvideoPixFmt_ = 0;
...
/**
 * @tc.name: VideoDecoder_rawvideodecoder_Create_AVBuffer_001
 * @tc.desc: 1. push/free buffer in callback;
 *           2. release not in callback;
 */
HWMTEST_F(VideoDecStableTestRAWVIDEO, VideoDecoder_rawvideodecoder_Create_AVBuffer_001, TestSize.Level1,
...
/**
 * @tc.name: VideoDecoder_rawvideodecoder_Create_AVBuffer_002
 * @tc.desc: 1. push/free buffer in callback;
 *           2. release not in callback;
 */
HWMTEST_F(VideoDecStableTestRAWVIDEO, VideoDecoder_rawvideodecoder_Create_AVBuffer_002, TestSize.Level1,
          VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
...
/**
 * @tc.name: VideoDecoder_rawvideodecoder_Create_AVBuffer_003
 * @tc.desc: 1. push/free buffer in callback;
 *           2. release not in callback;
 */
HWMTEST_F(VideoDecStableTestRAWVIDEO, VideoDecoder_rawvideodecoder_Create_AVBuffer_003, TestSize.Level1,
          VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
...
INSTANTIATE_TEST_SUITE_P(, VideoDecStableTestRAWVIDEO, testing::Values("Flush", "Stop", "Reset", "SetOutputSurface"));
 ...
 */
AVCODEC_MTEST_P(VideoDecStableTestRAWVIDEO, VideoDecoder_Multithread_001, TestSize.Level1, VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
    vdec->operation_ = VideoDecStableTestRAWVIDEO::GetParam();
 ...
 */
AVCODEC_MTEST_P(VideoDecStableTestRAWVIDEO, VideoDecoder_Multithread_002, TestSize.Level1, VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
    vdec->operation_ = VideoDecStableTestRAWVIDEO::GetParam();
 ...
 */
AVCODEC_MTEST_P(VideoDecStableTestRAWVIDEO, VideoDecoder_Multithread_003, TestSize.Level1, VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
    vdec->operation_ = VideoDecStableTestRAWVIDEO::GetParam();
 ...
 *           3. set surface;
 */
AVCODEC_MTEST_P(VideoDecStableTestRAWVIDEO, VideoDecoder_Multithread_004, TestSize.Level1, VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
    vdec->operation_ = VideoDecStableTestRAWVIDEO::GetParam();
 ...
 *           3. set surface;
 */
AVCODEC_MTEST_P(VideoDecStableTestRAWVIDEO, VideoDecoder_Multithread_005, TestSize.Level1, VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
    vdec->operation_ = VideoDecStableTestRAWVIDEO::GetParam();
 ...
 *           2. operate not in callback;
 */
AVCODEC_MTEST_P(VideoDecStableTestRAWVIDEO, VideoDecoder_Multithread_With_Queue_001, TestSize.Level1,
                VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 *           2. operate in input callback;
 */
AVCODEC_MTEST_P(VideoDecStableTestRAWVIDEO, VideoDecoder_Multithread_With_Queue_002, TestSize.Level1,
                VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 */
AVCODEC_MTEST_P(VideoDecStableTestRAWVIDEO, VideoDecoder_Multithread_With_Queue_003, TestSize.Level1,
                VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 *           4. set surface;
 */
AVCODEC_MTEST_P(VideoDecStableTestRAWVIDEO, VideoDecoder_Multithread_With_Queue_004, TestSize.Level1,
                VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 *           4. set surface;
 */
AVCODEC_MTEST_P(VideoDecStableTestRAWVIDEO, VideoDecoder_Multithread_With_Queue_005, TestSize.Level1,
                VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 *           2. operate not in callback;
 */
AVCODEC_MTEST_P(VideoDecStableTestRAWVIDEO, VideoDecoder_Multithread_AVBuffer_001,
                TestSize.Level1, VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 *           2. operate in input callback;
 */
AVCODEC_MTEST_P(VideoDecStableTestRAWVIDEO, VideoDecoder_Multithread_AVBuffer_002,
                TestSize.Level1, VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 *           2. operate in output callback;
 */
AVCODEC_MTEST_P(VideoDecStableTestRAWVIDEO, VideoDecoder_Multithread_AVBuffer_003,
                TestSize.Level1, VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 *           3. set surface;
 */
AVCODEC_MTEST_P(VideoDecStableTestRAWVIDEO, VideoDecoder_Multithread_AVBuffer_004,
                TestSize.Level1, VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 *           3. set surface;
 */
AVCODEC_MTEST_P(VideoDecStableTestRAWVIDEO, VideoDecoder_Multithread_AVBuffer_005,
                TestSize.Level1, VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 *           2. operate not in callback;
 */
AVCODEC_MTEST_P(VideoDecStableTestRAWVIDEO, VideoDecoder_Multithread_AVBuffer_With_Queue_001, TestSize.Level1,
                VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 *           2. operate in input callback;
 */
AVCODEC_MTEST_P(VideoDecStableTestRAWVIDEO, VideoDecoder_Multithread_AVBuffer_With_Queue_002, TestSize.Level1,
                VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 *           3. free buffer in queue;
 */
AVCODEC_MTEST_P(VideoDecStableTestRAWVIDEO, VideoDecoder_Multithread_AVBuffer_With_Queue_003, TestSize.Level1,
                VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 *           4. set surface;
 */
AVCODEC_MTEST_P(VideoDecStableTestRAWVIDEO, VideoDecoder_Multithread_AVBuffer_With_Queue_004, TestSize.Level1,
                VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
 ...
 *           4. set surface;
 */
AVCODEC_MTEST_P(VideoDecStableTestRAWVIDEO, VideoDecoder_Multithread_AVBuffer_With_Queue_005, TestSize.Level1,
                VideoDecSample::threadNum_)
{
    auto vdec = make_shared<VideoDecSample>();
    auto signal = make_shared<VCodecSignal>(vdec);
