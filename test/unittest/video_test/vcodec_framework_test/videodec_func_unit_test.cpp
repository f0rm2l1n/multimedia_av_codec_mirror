 ...
 * @tc.type: FUNC
 */
HWTEST_F(TEST_SUIT, VideoDecoder_HRDVivid2SDR_CApi_001, TestSize.Level1)
{
    int32_t colorSpace = INT32_MIN;
    CreateByNameWithParam(HW_HEVC);
    SetFormatWithParam(HW_HEVC);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(TEST_SUIT, VideoDecoder_HRDVivid2SDR_CApi_002, TestSize.Level1)
{
 ...
 * @tc.desc: key pixel format unset
 * @tc.type: FUNC
 */
HWTEST_F(TEST_SUIT, VideoDecoder_HRDVivid2SDR_CApi_003, TestSize.Level1)
{
    CreateByNameWithParam(HW_HEVC);
    ...
    ASSERT_EQ(AV_ERR_OK, videoDec_->CreateInputSurface());
 ...
 * @tc.desc: key pixel format is NV12 and Prepare unset
 * @tc.type: FUNC
 */
HWTEST_F(TEST_SUIT, VideoDecoder_HRDVivid2SDR_CApi_004, TestSize.Level1)
{
    CreateByNameWithParam(HW_HEVC);
    SetFormatWithParam(HW_HEVC);
    PrepareSource(HW_HEVC);
 ...
 * @tc.desc: key pixel format is NV12
 * @tc.type: FUNC
 */
HWTEST_F(TEST_SUIT, VideoDecoder_HRDVivid2SDR_CApi_005, TestSize.Level1)
{
    CreateByNameWithParam(HW_HEVC);
    SetFormatWithParam(HW_HEVC);
    PrepareSource(HW_HEVC);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(TEST_SUIT, VideoDecoder_HRDVivid2SDR_CApi_006, TestSize.Level1)
{
    CreateByNameWithParam(HW_HEVC);
...
#else
/**
 * @tc.name: VideoDecoder_HRDVivid2SDR_InnerApi_001
 * @tc.desc: set invalid key
 * @tc.type: FUNC
 */
HWTEST_F(TEST_SUIT, VideoDecoder_HRDVivid2SDR_InnerApi_001, TestSize.Level1)
{
    int32_t colorSpace = INT32_MIN;
    CreateByNameWithParam(HW_HEVC);
    SetFormatWithParam(HW_HEVC);
...
/**
 * @tc.name: VideoDecoder_HRDVivid2SDR_InnerApi_002
 * @tc.desc: set invalid key
 * @tc.type: FUNC
 */
HWTEST_F(TEST_SUIT, VideoDecoder_HRDVivid2SDR_InnerApi_002, TestSize.Level1)
{
    int32_t colorSpace = INT32_MAX;
    CreateByNameWithParam(HW_HEVC);
    SetFormatWithParam(HW_HEVC);
...
/**
 * @tc.name: VideoDecoder_HRDVivid2SDR_InnerApi_003
 * @tc.desc: key pixel format unset
 * @tc.type: FUNC
 */
HWTEST_F(TEST_SUIT, VideoDecoder_HRDVivid2SDR_InnerApi_003, TestSize.Level1)
{
    CreateByNameWithParam(HW_HEVC);
...
/**
 * @tc.name: VideoDecoder_HRDVivid2SDR_InnerApi_004
 * @tc.desc: key pixel format is NV12 and Prepare unset
 * @tc.type: FUNC
 */
HWTEST_F(TEST_SUIT, VideoDecoder_HRDVivid2SDR_InnerApi_004, TestSize.Level1)
{
    CreateByNameWithParam(HW_HEVC);
    SetFormatWithParam(HW_HEVC);
    PrepareSource(HW_HEVC);
...
/**
 * @tc.name: VideoDecoder_HRDVivid2SDR_InnerApi_005
 * @tc.desc: key pixel format is NV12
 * @tc.type: FUNC
 */
HWTEST_F(TEST_SUIT, VideoDecoder_HRDVivid2SDR_InnerApi_005, TestSize.Level1)
{
    CreateByNameWithParam(HW_HEVC);
    SetFormatWithParam(HW_HEVC);
    PrepareSource(HW_HEVC);
...
/**
 * @tc.name: VideoDecoder_HRDVivid2SDR_InnerApi_006
 * @tc.desc: key pixel format is NV21
 * @tc.type: FUNC
 */
HWTEST_F(TEST_SUIT, VideoDecoder_HRDVivid2SDR_InnerApi_006, TestSize.Level1)
{
    CreateByNameWithParam(HW_HEVC);
