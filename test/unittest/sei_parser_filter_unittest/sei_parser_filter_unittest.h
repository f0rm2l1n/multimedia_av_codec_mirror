...
public:
    ...
    std::shared_ptr<SeiParserFilter> producerListener_;
};
...
public:
    ...
    MOCK_METHOD(Status, OnLinked,
        (StreamType, std::shared_ptr<Meta>, std::shared_ptr<FilterLinkCallback>), ());
};
...
public:
    ...
    MOCK_METHOD(sptr<AVBufferQueueConsumer>, GetConsumer, (), ());
};
...
public:
    ...
    MOCK_METHOD(sptr<AVBufferQueueProducer>, GetProducer, (), ());
};
