...
public:
    ...
    MOCK_METHOD(bool, UpdateTimeAnchor, (int64_t clockTime,
        int64_t delayTime, IMediaTime iMediaTime, IMediaSynchronizer* supplier), (override));
    ...
    MOCK_METHOD(void, SetMediaTimeRangeStart, (int64_t startMediaTime,
        int32_t trackId, IMediaSynchronizer* supplier), (override));
    MOCK_METHOD(void, SetMediaTimeRangeEnd,
        (int64_t endMediaTime, int32_t trackId, IMediaSynchronizer* supplier), (override));
