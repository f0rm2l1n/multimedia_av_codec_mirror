...
constexpr HlsMediaDownloaderUnitTest *HLS_MEDIA_DOWNLOADER_UNITTEST = new HlsMediaDownloaderUnitTest();
// 黑白球視頻地址
...
{
    std::make_shared<HlsMediaDownloader> downloader = HLS_MEDIA_DOWNLOADER_UNITTEST->GetMediaDownloader();
