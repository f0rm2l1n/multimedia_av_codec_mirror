...
string g_mpegPath = TEST_FILE_PATH + string("3gp_h264_aac.3gp");
string g_mpegURL = TEST_URI_PATH + string("3gp_h264_aac.3gp");

} //namespace

namespace {
/**
 * @tc.name: Demuxer_ReadSample_4270
 * @tc.desc: Read sample test for timed metadata track,local
 * @tc.type: FUNC
 */
HWTEST_F(DemuxerUnitTest, Demuxer_ReadSample_4270, TestSize.Level1)
{
...
/**
 * @tc.name: Demuxer_ReadSample_4271
 * @tc.desc: Read sample test for timed metadata track,Uri
 * @tc.type: FUNC
 */
HWTEST_F(DemuxerUnitTest, Demuxer_ReadSample_4271, TestSize.Level1)
{
...
/**
 * @tc.name: Demuxer_SeekToTime_208_gp_2250
 * @tc.desc: seek to the specified time
 * @tc.type: FUNC
 */
HWTEST_F(DemuxerUnitTest, Demuxer_SeekToTime_4272, TestSize.Level1)
{
    InitResource(g_mpegURL, URI);
    ASSERT_TRUE(initStatus_);
    ASSERT_TRUE(SetInitValue());
...
/**
 * @tc.name: Demuxer_SeekToTime_4273
 * @tc.desc: seek to the specified time
 * @tc.type: FUNC
 */
HWTEST_F(DemuxerUnitTest, Demuxer_SeekToTime_4273, TestSize.Level1)
{
    InitResource(g_mpegPath, LOCAL);
    ASSERT_TRUE(initStatus_);
    ASSERT_TRUE(SetInitValue());
