...
HWTEST_F(DemuxerUnitTest, Demuxer_SeekToTime_1800, TestSize.Level1)
{
    ...
    vector<int32_t> audioVals = {480, 480, 480, 80, 480, 480, 80, 480, 80, 80, 480, 480, 80, 80, 80, 80, 480, 80};
    sharedMem_ = AVMemoryMockFactory::CreateAVMemoryMock(bufferSize_);
    ASSERT_NE(sharedMem_, nullptr);
    for (auto toPts = toPtsList.begin(); toPts != toPtsList.end(); toPts++) {
        for (auto mode = seekModes.begin(); mode != seekModes.end(); mode++) {
...
HWTEST_F(DemuxerUnitTest, Demuxer_SeekToTime_1834, TestSize.Level1)
{
    ...
    vector<int32_t> audioVals = {288, 288, 288, 157, 159, 159, 87, 87, 87, 201, 202, 202, 11, 11, 11};
    sharedMem_ = AVMemoryMockFactory::CreateAVMemoryMock(bufferSize_);
    ASSERT_NE(sharedMem_, nullptr);
    for (auto toPts = toPtsList.begin(); toPts != toPtsList.end(); toPts++) {
        for (auto mode = seekModes.begin(); mode != seekModes.end(); mode++) {
...
HWTEST_F(DemuxerUnitTest, Demuxer_SeekToTime_1835, TestSize.Level1)
{
    ...
    vector<int32_t> videoVals = {1937, 1937, 1937, 1624, 1640, 1640, 724, 740, 724, 108, 124, 124};
    vector<int32_t> audioVals = {2720, 2720, 2720, 2320, 2320, 2320, 1040, 1040, 1040, 160, 160, 160};
    sharedMem_ = AVMemoryMockFactory::CreateAVMemoryMock(bufferSize_);
    ASSERT_NE(sharedMem_, nullptr);
    for (auto toPts = toPtsList.begin(); toPts != toPtsList.end(); toPts++) {
        for (auto mode = seekModes.begin(); mode != seekModes.end(); mode++) {
...
HWTEST_F(DemuxerUnitTest, Demuxer_SeekToTime_1837, TestSize.Level1)
{
    ...
    vector<int32_t> videoVals = {179, 431, 179, 11611, 11863, 11863, 14204, 14204, 14204};
    vector<int32_t> audioVals = {158, 375, 158, 10375, 10592, 10592, 12730, 12730, 12730};
    sharedMem_ = AVMemoryMockFactory::CreateAVMemoryMock(bufferSize_);
    ASSERT_NE(sharedMem_, nullptr);
    for (auto toPts = toPtsList.begin(); toPts != toPtsList.end(); toPts++) {
        for (auto mode = seekModes.begin(); mode != seekModes.end(); mode++) {
