...
public:
    ...
    ~AVCodecTrace() {}
    MOCK_METHOD(void, TraceBegin, (const std::string& funcName, int32_t taskId), ());
    MOCK_METHOD(void, TraceEnd, (const std::string& funcName, int32_t taskId), ());
    MOCK_METHOD(void, CounterTrace, (const std::string& varName, int32_t val), ());
};
} // namespace MediaAVCodec
} // namespace OHOS
