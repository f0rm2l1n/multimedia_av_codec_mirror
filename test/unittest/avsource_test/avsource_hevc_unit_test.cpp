 ...
 * @tc.desc: get source format(flv id12)
 * @tc.type: FUNC
 */
...
/**
 * @tc.name: AVSource_GetFormat_1405
 * @tc.desc: get format when the file is flv(id12)
 * @tc.type: FUNC
 */
HWTEST_F(AVSourceUnitTest, AVSource_GetFormat_1405, TestSize.Level1)
{
    if (access(HEVC_LIB_PATH.c_str(), F_OK) != 0) {
        return;
    }
