...
string g_3gpPath3 = TEST_FILE_PATH + string("3gp_mpeg4_aac.3gp");
 ...
 * @tc.type: FUNC
 */
HWTEST_F(AVSourceUnitTest, AVSource_3GP_GetFormat_0001, TestSize.Level1)
{
...
/**
 * @tc.name: AVSource_3GP_GetFormat_0002
 * @tc.desc: get source format when the file is 3gp(h264, aac)
 * @tc.type: FUNC
 */
HWTEST_F(AVSourceUnitTest, AVSource_3GP_GetFormat_0002, TestSize.Level1)
{
    printf("---- %s ------\n", g_3gpUri1.data());
...
/**
 * @tc.name: AVSource_3GP_GetFormat_0003
 * @tc.desc: get source format when the file is 3gp(h263, aac)
 * @tc.type: FUNC
 */
HWTEST_F(AVSourceUnitTest, AVSource_3GP_GetFormat_0003, TestSize.Level1)
{
    fd_ = OpenFile(g_3gpPath2);
    size_ = GetFileSize(g_3gpPath2);
    printf("---- %s ----\n", g_3gpPath2.c_str());
    source_ = AVSourceMockFactory::CreateSourceWithFD(fd_, SOURCE_OFFSET, size_);
    ASSERT_NE(source_, nullptr);
    format_ = source_->GetSourceFormat();
...
/**
 * @tc.name: AVSource_3GP_GetFormat_0004
 * @tc.desc: get source format when the file is 3gp(h263, aac)
 * @tc.type: FUNC
 */
HWTEST_F(AVSourceUnitTest, AVSource_3GP_GetFormat_0004, TestSize.Level1)
{
    printf("---- %s ------\n", g_3gpUri2.data());
    source_ = AVSourceMockFactory::CreateSourceWithURI(const_cast<char *>(g_3gpUri2.data()));
    ASSERT_NE(source_, nullptr);
    format_ = source_->GetSourceFormat();
    ASSERT_NE(format_, nullptr);
    printf("[ sourceFormat ]: %s\n", format_->DumpInfo());
...
/**
 * @tc.name: AVSource_3GP_GetFormat_0005
 * @tc.desc: get source format when the file is 3gp(mpeg4, aac)
 * @tc.type: FUNC
 */
HWTEST_F(AVSourceUnitTest, AVSource_3GP_GetFormat_0005, TestSize.Level1)
{
    fd_ = OpenFile(g_3gpPath3);
    size_ = GetFileSize(g_3gpPath3);
    printf("---- %s ----\n", g_3gpPath3.c_str());
    source_ = AVSourceMockFactory::CreateSourceWithFD(fd_, SOURCE_OFFSET, size_);
    ASSERT_NE(source_, nullptr);
    format_ = source_->GetSourceFormat();
    ...
    ASSERT_EQ(formatVal_.sampleRate, 48000);
    ASSERT_EQ(formatVal_.channelCount, 2);
    ASSERT_EQ(formatVal_.bitRate, 123200);
    ASSERT_EQ(formatVal_.codecMime, "audio/mp4a-latm");
    ASSERT_EQ(formatVal_.audioSampleFormat, AudioSampleFormat::SAMPLE_F32P);
    ASSERT_EQ(formatVal_.channelLayout, 3);
}
...
/**
 * @tc.name: AVSource_3GP_GetFormat_0006
 * @tc.desc: get source format when the file is 3gp(mpeg4, aac)
 * @tc.type: FUNC
 */
HWTEST_F(AVSourceUnitTest, AVSource_3GP_GetFormat_0006, TestSize.Level1)
{
    printf("---- %s ------\n", g_3gpUri3.data());
    source_ = AVSourceMockFactory::CreateSourceWithURI(const_cast<char *>(g_3gpUri3.data()));
    ASSERT_NE(source_, nullptr);
    format_ = source_->GetSourceFormat();
    ASSERT_NE(format_, nullptr);
    printf("[ sourceFormat ]: %s\n", format_->DumpInfo());
