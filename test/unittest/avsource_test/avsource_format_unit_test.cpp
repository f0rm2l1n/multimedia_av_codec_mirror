...
string g_3gpPath1 = TEST_FILE_PATH + string("3gp_h264_aac.3gp");
string g_3g2Path1 = TEST_FILE_PATH + string("3g2_mp4v_mp4a.3g2");
string g_vobPath1 = TEST_FILE_PATH + string("mov_mpeg2_mp2.vob");
...
string g_vobUri1 = TEST_URI_PATH + string("mov_mpeg2_mp2.vob");
...
/**
 * @tc.name: AVSource_GetFormat_20803
 * @tc.desc: get source format when the file is m4v(h264, aac)
 * @tc.type: FUNC
 */
HWTEST_F(AVSourceUnitTest, AVSource_GetFormat_20803, TestSize.Level1)
{
    ...
    ASSERT_EQ(formatVal_.bitRate, 130905);
...
/**
 * @tc.name: AVSource_GetFormat_20804
 * @tc.desc: get source format when the file is m4v(h264, aac)
 * @tc.type: FUNC
 */
HWTEST_F(AVSourceUnitTest, AVSource_GetFormat_20804, TestSize.Level1)
{
    printf("---- %s ------\n", g_m4vUri1.data());
 ...
 * @tc.desc: get source format when the file is 3gp(h264, aac)
 * @tc.type: FUNC
 */
HWTEST_F(AVSourceUnitTest, AVSource_GetFormat_20805, TestSize.Level1)
{
    fd_ = OpenFile(g_3gpPath1);
    size_ = GetFileSize(g_3gpPath1);
    printf("---- %s ----\n", g_3gpPath1.c_str());
    source_ = AVSourceMockFactory::CreateSourceWithFD(fd_, SOURCE_OFFSET, size_);
    ASSERT_NE(source_, nullptr);
    format_ = source_->GetSourceFormat();
    ...
    ASSERT_EQ(formatVal_.codecMime, "video/avc");
    printf("[ formatVal_.codecMime ]: %s\n", formatVal_.codecMime.c_str());
    ASSERT_EQ(formatVal_.width, 960);
    ASSERT_EQ(formatVal_.height, 400);
    ASSERT_DOUBLE_EQ(formatVal_.frameRate, 23.976023976023978);
    trackIndex_ = 1;
    format_->Destroy();
    format_ = source_->GetTrackFormat(trackIndex_);
    ASSERT_NE(format_, nullptr);
    ...
    ASSERT_EQ(formatVal_.channelCount, 2);
    ASSERT_EQ(formatVal_.bitRate, 123153);
    ASSERT_EQ(formatVal_.codecMime, "audio/mp4a-latm");
    ASSERT_EQ(formatVal_.audioSampleFormat, AudioSampleFormat::SAMPLE_F32P);
    ASSERT_EQ(formatVal_.channelLayout, 3);
}
 ...
 * @tc.type: FUNC
 */
HWTEST_F(AVSourceUnitTest, AVSource_GetFormat_20806, TestSize.Level1)
{
    printf("---- %s ------\n", g_3gpUri1.data());
    source_ = AVSourceMockFactory::CreateSourceWithURI(const_cast<char*>(g_3gpUri1.data()));
    ASSERT_NE(source_, nullptr);
    format_ = source_->GetSourceFormat();
    ASSERT_NE(format_, nullptr);
    printf("[ sourceFormat ]: %s\n", format_->DumpInfo());
...
/**
 * @tc.name: AVSource_GetFormat_20807
 * @tc.desc: get source format when the file is 3g2(mp4v, mp4a)
 * @tc.type: FUNC
 */
HWTEST_F(AVSourceUnitTest, AVSource_GetFormat_20807, TestSize.Level1)
{
...
/**
 * @tc.name: AVSource_GetFormat_20808
 * @tc.desc: get source format when the file is 3g2(mp4v, mp4v)
 * @tc.type: FUNC
 */
HWTEST_F(AVSourceUnitTest, AVSource_GetFormat_20808, TestSize.Level1)
{
    printf("---- %s ------\n", g_3g2Uri1.data());
...
/**
 * @tc.name: AVSource_GetFormat_20809
 * @tc.desc: get source format when the file is mov(mpeg2, mp2)
 * @tc.type: FUNC
 */
HWTEST_F(AVSourceUnitTest, AVSource_GetFormat_20809, TestSize.Level1)
{
...
/**
 * @tc.name: AVSource_GetFormat_20810
 * @tc.desc: get source format when the file is mov(mpeg2, mp2)
 * @tc.type: FUNC
 */
HWTEST_F(AVSourceUnitTest, AVSource_GetFormat_20810, TestSize.Level1)
{
    printf("---- %s ------\n", g_vobUri1.data());
