 ...
 * @tc.type: FUNC
 */
HWTEST_F(Mpeg4MuxerUnitTest, Muxer_SetColorBoxInfo_001, TestSize.Level0)
{
    int32_t audioTrackId = -1;
    int32_t videoTrackId = -1;
    std::string outputFile = TEST_FILE_PATH + std::string("Mpeg4_SetColorBoxInfo_001.mp4");
    OH_AVOutputFormat outputFormat = AV_OUTPUT_FORMAT_MPEG_4;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(Mpeg4MuxerUnitTest, Muxer_SetColorBoxInfo_002, TestSize.Level0)
{
    int32_t audioTrackId = -1;
    int32_t videoTrackId = -1;
    std::string outputFile = TEST_FILE_PATH + std::string("Mpeg4_SetColorBoxInfo_002.mp4");
    OH_AVOutputFormat outputFormat = AV_OUTPUT_FORMAT_MPEG_4;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(Mpeg4MuxerUnitTest, Muxer_SetColorBoxInfo_004, TestSize.Level0)
{
    int32_t videoTrackId = -1;
    std::string outputFile = TEST_FILE_PATH + std::string("Mpeg4_SetColorBoxInfo_004.mp4");
    OH_AVOutputFormat outputFormat = AV_OUTPUT_FORMAT_MPEG_4;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(Mpeg4MuxerUnitTest, Muxer_SetColorBoxInfo_005, TestSize.Level0)
{
    int32_t videoTrackId = -1;
    std::string outputFile = TEST_FILE_PATH + std::string("Mpeg4_SetColorBoxInfo_005.mp4");
    OH_AVOutputFormat outputFormat = AV_OUTPUT_FORMAT_MPEG_4;
