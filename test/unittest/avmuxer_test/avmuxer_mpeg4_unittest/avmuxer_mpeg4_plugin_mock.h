...
#ifndef MUXER_MPEG4_PLUGIN_MOCK_H
#define MUXER_MPEG4_PLUGIN_MOCK_H
...
class AVMuxerMpeg4PluginMock : public AVMuxerMock {
public:
    explicit AVMuxerMpeg4PluginMock(std::shared_ptr<Media::Plugins::DataSink> dataSink,
        std::shared_ptr<Media::Plugins::MuxerPlugin> muxer);
    ~AVMuxerMpeg4PluginMock() = default;
...
#endif // MUXER_MPEG4_PLUGIN_MOCK_H