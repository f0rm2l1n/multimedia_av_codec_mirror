...
#ifndef AUDIO_SERVER_SINK_PLUGIN_UNITTEST_H
#define AUDIO_SERVER_SINK_PLUGIN_UNITTEST_H
...
class AudioServerSinkPluginUnitTest : public testing::Test {
public:
...
class MockEventReceiver : public OHOS::Media::Pipeline::EventReceiver {
public:
...
#endif // AUDIO_SERVER_SINK_PLUGIN_UNITTEST_H