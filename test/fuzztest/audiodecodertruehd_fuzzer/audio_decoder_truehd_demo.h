...
#ifndef AVCODEC_AUDIO_AVBUFFER_DECODER_TRUEHD_DEMO_H
#define AVCODEC_AUDIO_AVBUFFER_DECODER_TRUEHD_DEMO_H
...
#endif // AVCODEC_AUDIO_AVBUFFER_DECODER_TRUEHD_DEMO_H
