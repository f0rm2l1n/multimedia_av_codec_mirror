...
private:
    ...
    // 设置meta信息
    int32_t SetFormat(const uint8_t* data, size_t size);
    // 添加轨
    ...
    bool UpdateWriteBufferInfoAVBuffer(OH_AVBuffer **buffer, OH_AVCodecBufferAttr *info, int32_t trackIndex);
...
private:
    ...
    OH_AVFormat *metaFormat_ = { nullptr };
