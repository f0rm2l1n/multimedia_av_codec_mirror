...
bool AvcapabilityFuzzTest(const uint8_t *data, size_t size)
{
    ...
    OH_AVCapability_GetVideoFrameRateRangeForSize(cap, fdp.ConsumeIntegral<int32_t>(), fdp.ConsumeIntegral<int32_t>(), &range);
    OH_AVCapability_AreVideoSizeAndFrameRateSupported(cap, fdp.ConsumeIntegral<int32_t>(), fdp.ConsumeIntegral<int32_t>(), frameRate);
