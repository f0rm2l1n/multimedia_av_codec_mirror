...
#include "audio_decoder_mp3_new_demo.h"
...
static uint32_t g_supportedSampleRateSet[] = {8000, 11025, 12000, 16000, 22050,
                                              24000, 32000, 44100, 48000};
static int32_t g_supportedChannels[] = {2}; // 1 for max channel
...
void Mp3FuzzDemo::RandomSetMeta(const uint8_t *data)
{
...
bool Mp3FuzzDemo::DoMp3ParserWithParserAPI(const uint8_t *data, size_t size)
{
    ...
    base.audioDec_ = OH_AudioCodec_CreateByName((AVCodecCodecName::AUDIO_DECODER_MP3_NAME).data());
