...
#define FUZZ_PROJECT_NAME "demuxerpluginwebm_fuzzer"
using namespace std;
...
void DemuxerPluginFuzzWithFunc(const uint8_t *data, size_t size)
{
    ...
    demuxerTest->testFilePath_ = "/data/test/demuxerpluginwebm.webm";
    demuxerTest->demuxerPluginName_ = "avdemux_webm";
