...
#define FUZZ_PROJECT_NAME "avsdecoderresource_fuzzer"
...
bool AvsdecoderResourceFuzzTest(const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::AvsdecoderResourceFuzzTest(data, size);
#endif
    return 0;
}