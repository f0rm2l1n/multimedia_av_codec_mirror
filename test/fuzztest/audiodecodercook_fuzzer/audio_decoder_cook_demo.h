...
#ifndef AVCODEC_AUDIO_AVBUFFER_DECODER_COOK_DEMO_H
#define AVCODEC_AUDIO_AVBUFFER_DECODER_COOK_DEMO_H
...
private:
    ...
    void InputFunc();
    void InputFuncInner(size_t frameBytes);
    void OutputFunc();
...
#endif // AVCODEC_AUDIO_AVBUFFER_DECODER_COOK_DEMO_H
