...
#define FUZZ_PROJECT_NAME "hwavcdecoderserver_fuzzer"

namespace OHOS {
bool HwavcdecoderServerFuzzTest(const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::HwavcdecoderServerFuzzTest(data, size);
    return 0;
}
