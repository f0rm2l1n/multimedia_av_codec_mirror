...
#define FUZZ_PROJECT_NAME "rawvideodecoderresource_fuzzer"
...
bool RawvideodecoderResourceFuzzTest(const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::RawvideodecoderResourceFuzzTest(data, size);
    return 0;
}