...
#define FUZZ_PROJECT_NAME "mpeg4swdecoderserver_fuzzer"

namespace OHOS {
bool Mpeg4SwdecoderServerFuzzTest(const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::Mpeg4SwdecoderServerFuzzTest(data, size);
    return 0;
}
