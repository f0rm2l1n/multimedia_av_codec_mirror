...
#define FUZZ_PROJECT_NAME "rv40decoderresource_fuzzer"
...
bool Rv40decoderResourceFuzzTest(const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::Rv40decoderResourceFuzzTest(data, size);
#else
    (void)data;
    (void)size;
#endif
