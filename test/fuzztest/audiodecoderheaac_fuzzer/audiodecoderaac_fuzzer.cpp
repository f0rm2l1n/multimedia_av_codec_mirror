...
#define FUZZ_PROJECT_NAME "audiodecoderheaac_fuzzer"
...
bool AudioDecoderHEAACFuzzTest(const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::AudioDecoderHEAACFuzzTest(data, size);
    return 0;
}