...
#define FUZZ_PROJECT_NAME "demuxerpluginmpegts_fuzzer"
using namespace std;
...
void DemuxerPluginFuzzWithFunc(const uint8_t *data, size_t size)
{
    ...
    demuxerTest->testFilePath_ = "/data/test/demuxerpluginmpegts.ts";
    demuxerTest->demuxerPluginName_ = "avdemux_mpegts";
