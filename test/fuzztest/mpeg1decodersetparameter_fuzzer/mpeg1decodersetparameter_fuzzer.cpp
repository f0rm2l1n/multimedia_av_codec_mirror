...
#define FUZZ_PROJECT_NAME "mpeg1decodersetparameter_fuzzer"
...
{
    format = OH_AVFormat_CreateVideoFormat("video/mpeg", DEFAULT_WIDTH, DEFAULT_HEIGHT);
...
namespace OHOS {
bool Mpeg1decoderSetParameterFuzzTest(const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::Mpeg1decoderSetParameterFuzzTest(data, size);
    return 0;
}
