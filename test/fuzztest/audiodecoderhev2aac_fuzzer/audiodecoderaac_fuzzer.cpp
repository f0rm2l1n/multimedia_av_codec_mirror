...
#define FUZZ_PROJECT_NAME "audiodecoderhev2aac_fuzzer"
...
bool AudioDecoderHEV2AACFuzzTest(const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::AudioDecoderHEV2AACFuzzTest(data, size);
    return 0;
}