...
#ifndef AUDIO_ENCODER_SETPARAMETER_DEMO_BASE_H
#define AUDIO_ENCODER_SETPARAMETER_DEMO_BASE_H
...
public:
    ...
    bool RunCaseSetParameter(const uint8_t *data, size_t size);
...
#endif // AUDIO_ENCODER_SETPARAMETER_DEMO_BASE_H
