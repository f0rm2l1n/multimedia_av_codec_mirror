...
#define FUZZ_PROJECT_NAME "rv30decoderresource_fuzzer"
...
bool Rv30decoderResourceFuzzTest(const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::Rv30decoderResourceFuzzTest(data, size);
#else
    (void)data;
    (void)size;
#endif
