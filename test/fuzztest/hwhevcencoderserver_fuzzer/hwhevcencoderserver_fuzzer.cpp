...
#define FUZZ_PROJECT_NAME "hwhevcencoderserver_fuzzer"

namespace OHOS {
bool HwhevcencoderServerFuzzTest(const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::HwhevcencoderServerFuzzTest(data, size);
    return 0;
}
