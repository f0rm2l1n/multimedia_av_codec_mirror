...
static uint32_t g_supportedSampleRateSet[] = {8000};
...
void G711aFuzzDemo::RandomSetMeta(const uint8_t *data)
{
...
bool G711aFuzzDemo::DoG711aParserWithParserAPI(const uint8_t *data, size_t size)
{
