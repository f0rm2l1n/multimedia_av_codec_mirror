...
#define FUZZ_PROJECT_NAME "h263swdecoderserver_fuzzer"

namespace OHOS {
bool H263SwdecoderServerFuzzTest(const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::H263SwdecoderServerFuzzTest(data, size);
    return 0;
}
