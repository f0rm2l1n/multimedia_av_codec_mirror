...
static uint32_t g_supportedSampleRateSet[] = {8000, 384000};
static int32_t g_supportedChannels[] = {1, 2, 3, 4, 5, 6, 7, 8}; // 8 for max channel
...
void FlacFuzzDemo::RandomSetMeta(const uint8_t *data)
{
...
bool FlacFuzzDemo::DoFlacParserWithParserAPI(const uint8_t *data, size_t size)
{
    ...
    base.audioDec_ = OH_AudioCodec_CreateByName((AVCodecCodecName::AUDIO_DECODER_FLAC_NAME).data());
