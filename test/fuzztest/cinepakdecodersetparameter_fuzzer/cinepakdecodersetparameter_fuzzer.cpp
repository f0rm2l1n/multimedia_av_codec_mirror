...
#define FUZZ_PROJECT_NAME "cinepakdecodersetparameter_fuzzer"
...
{
    format = OH_AVFormat_CreateVideoFormat("video/cinepak", DEFAULT_WIDTH, DEFAULT_HEIGHT);
...
namespace OHOS {
bool CinepakdecoderSetParameterFuzzTest(const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    (void)data;
    (void)size;
    OHOS::CinepakdecoderSetParameterFuzzTest(data, size);
    return 0;
}
