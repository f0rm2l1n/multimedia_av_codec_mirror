...
namespace OHOS {
const char *THREE_G2_PATH = "/data/test/fuzz_create.3g2";
...
bool CheckDataValidity(FuzzedDataProvider *fdp, size_t size)
{
    ...
    int32_t fd = open(THREE_G2_PATH, O_RDWR | O_CREAT, S_IRUSR | S_IWUSR);
    if (fd < 0) {
        return false;
    }
