...
#define FUZZ_PROJECT_NAME "msvideo1decodersetparameter_fuzzer"
...
{
    format = OH_AVFormat_CreateVideoFormat("video/msvideo1", DEFAULT_WIDTH, DEFAULT_HEIGHT);
...
namespace OHOS {
bool MsVideo1decoderSetParameterFuzzTest(const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::MsVideo1decoderSetParameterFuzzTest(data, size);
    return 0;
}
