...
#define FUZZ_PROJECT_NAME "mjpegdecoderinner_fuzzer"
...
bool MjpegdecoderInnerFuzzTest(const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::MjpegdecoderInnerFuzzTest(data, size);
    return 0;
}
