...
#define FUZZ_PROJECT_NAME "msvideo1decoderresource_fuzzer"
...
bool MsVideo1decoderResourceFuzzTest(const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::MsVideo1decoderResourceFuzzTest(data, size);
    return 0;
}