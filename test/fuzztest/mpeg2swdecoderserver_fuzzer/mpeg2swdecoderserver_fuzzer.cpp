...
#define FUZZ_PROJECT_NAME "mpeg2swdecoderserver_fuzzer"

namespace OHOS {
bool Mpeg2SwdecoderServerFuzzTest(const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::Mpeg2SwdecoderServerFuzzTest(data, size);
    return 0;
}
