...
#define FUZZ_PROJECT_NAME "hwhevcdecoderserver_fuzzer"

namespace OHOS {
bool HwhevcdecoderServerFuzzTest(const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::HwhevcdecoderServerFuzzTest(data, size);
    return 0;
}
