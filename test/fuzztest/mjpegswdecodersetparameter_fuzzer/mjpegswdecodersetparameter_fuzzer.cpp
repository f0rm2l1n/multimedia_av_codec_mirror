...
#define FUZZ_PROJECT_NAME "mjpegswdecodersetparameter_fuzzer"
using namespace std;
...
{
    format = OH_AVFormat_CreateVideoFormat("video/mjpeg", DEFAULT_WIDTH, DEFAULT_HEIGHT);
    ...
    OH_AVFormat_SetIntValue(format, OH_MD_KEY_ROTATION, intData5);
