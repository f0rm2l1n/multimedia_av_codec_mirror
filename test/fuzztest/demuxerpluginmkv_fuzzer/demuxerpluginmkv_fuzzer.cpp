...
#define FUZZ_PROJECT_NAME "demuxerpluginmkv_fuzzer"
using namespace std;
...
void DemuxerPluginFuzzWithFunc(const uint8_t *data, size_t size)
{
    ...
    demuxerTest->testFilePath_ = "/data/test/demuxerpluginmkv.mkv";
    demuxerTest->demuxerPluginName_ = "avdemux_matroska,webm";
    demuxerTest->videoHeightDefault_ = 1080;
    demuxerTest->videoWidthDefault_ = 1920;
