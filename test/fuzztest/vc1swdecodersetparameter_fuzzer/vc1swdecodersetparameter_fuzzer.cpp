...
#define FUZZ_PROJECT_NAME "vc1swdecodersetparameter_fuzzer"
...
{
    format = OH_AVFormat_CreateVideoFormat("video/vc1", DEFAULT_WIDTH, DEFAULT_HEIGHT);
...
namespace OHOS {
bool Vc1SwdecoderFuzzTest(const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::Vc1SwdecoderFuzzTest(data, size);
#else
    (void)data;
    (void)size;
#endif
