...
#define FUZZ_PROJECT_NAME "vp8swdecoderserversurface_fuzzer"

namespace OHOS {
bool Vp8SwdecoderServerSurfaceFuzzTest(const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::Vp8SwdecoderServerSurfaceFuzzTest(data, size);
#else
    (void)data;
    (void)size;
#endif
