...
#define FUZZ_PROJECT_NAME "cinepakdecoderresource_fuzzer"
...
bool CinepakdecoderResourceFuzzTest(const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    (void)data;
    (void)size;
    OHOS::CinepakdecoderResourceFuzzTest(data, size);
    return 0;
}