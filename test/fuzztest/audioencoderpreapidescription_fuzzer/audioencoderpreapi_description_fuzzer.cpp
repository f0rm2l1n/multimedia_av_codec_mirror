...
#define FUZZ_PROJECT_NAME "audioencoderpreapidescription_fuzzer"
...
bool AudioEncoderAACDescriptionFuzzTest(const uint8_t *data, size_t size)
{
    ...
    bool ret = aDecBufferDemo->RunCaseDescription(data, size);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::AudioEncoderAACDescriptionFuzzTest(data, size);
