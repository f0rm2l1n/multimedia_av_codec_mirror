...
#ifndef AVCODEC_AUDIO_AVBUFFER_DECODER_TWINVQ_DEMO_H
#define AVCODEC_AUDIO_AVBUFFER_DECODER_TWINVQ_DEMO_H
...
private:
    ...
    int32_t Reset();
    int32_t Release();
    bool IsBufferFormatAacOrVorbis();
    void InputFunc();
    void OutputFunc();
    bool WaitInputBuffer();
    void SendEOS(uint32_t index, OH_AVBuffer* buffer);
    bool FeedOneFrame(uint32_t index, OH_AVBuffer* buffer, size_t frameBytes);
...
#endif // AVCODEC_AUDIO_AVBUFFER_DECODER_TWINVQ_DEMO_H