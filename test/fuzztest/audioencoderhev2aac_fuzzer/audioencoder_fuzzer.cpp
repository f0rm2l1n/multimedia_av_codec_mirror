...
#define FUZZ_PROJECT_NAME "audioencoderhev2aac_fuzzer"

using namespace OHOS::MediaAVCodec::AudioAacEncDemo;

namespace OHOS {

bool AudioEncoderHEV2AACFuzzTest(const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::AudioEncoderHEV2AACFuzzTest(data, size);
    return 0;
}
