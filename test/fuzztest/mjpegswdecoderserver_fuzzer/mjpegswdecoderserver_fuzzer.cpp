...
#define FUZZ_PROJECT_NAME "mjpegswdecoderserver_fuzzer"

namespace OHOS {
bool MjpegSwdecoderServerFuzzTest(const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::MjpegSwdecoderServerFuzzTest(data, size);
    return 0;
}
