...
public:
     ...
     *OH_AVCODEC_MIMETYPE_AUDIO_G711MU,OH_AVCODEC_MIMETYPE_AUDIO_VIVID}; default: OH_AVCODEC_MIMETYPE_AUDIO_VIVID;
     * @Status Create
     **/
    ...
    "OH.Media.Codec.Decoder.Audio.OPUS", "OH.Media.Codec.Decoder.Audio.G711MU","OH.Media.Codec.Decoder.Audio.Vivid"};
