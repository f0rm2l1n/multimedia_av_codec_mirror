...
class DemuxerAsynTypeInnerFunc8Test : public testing::Test {
public:
...
constexpr uint32_t READFRAME_7 = 7;
constexpr uint32_t READFRAME_8 = 8;
constexpr uint32_t READFRAME_4 = 4;
...
void DemuxerAsynTypeInnerFunc8Test::SetUpTestCase(void) {}

void DemuxerAsynTypeInnerFunc8Test::TearDownTestCase(void) {}

void DemuxerAsynTypeInnerFunc8Test::SetUp(void)
{
}

void DemuxerAsynTypeInnerFunc8Test::TearDown(void)
{
    dataSourceImpl_ = nullptr;
}

bool DemuxerAsynTypeInnerFunc8Test::CreateBufferSize()
{
...
bool DemuxerAsynTypeInnerFunc8Test::CreateDataSource(const std::string &filePath)
{
...
bool DemuxerAsynTypeInnerFunc8Test::CreateDemuxerPluginByName(const std::string& typeName, const std::string& filePath,
    int probSize)
{
...
void DemuxerAsynTypeInnerFunc8Test::RemoveValue()
{
    if (!frames_.empty()) {
        frames_.clear();
    }
...
void DemuxerAsynTypeInnerFunc8Test::GetFrameNum(int32_t i)
{
...
void DemuxerAsynTypeInnerFunc8Test::GetFrameNumAudio(int32_t i)
{
    if (avBuf_->flag_ == MediaAVCodec::AVCODEC_BUFFER_FLAG_EOS) {
        if (i == 0) {
            isAudioEosFlagForSave = true;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_APE_FUNC_0140
 * @tc.name      : read-pause-read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_APE_FUNC_0140, TestSize.Level3)
{
    indexAud = 0;
    ...
    ASSERT_EQ(audioIndexForRead, READFRAME_7);
}

/**
 * @tc.number    : DEMUXER_ASYN_INNER_APE_FUNC_0150
 * @tc.name      : read-pause-seek-read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_APE_FUNC_0150, TestSize.Level3)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int64_t realtime = 0;
    int64_t seekTime = 6144000;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_APE, TEST_FILE_URI_APE, DEF_PROB_SIZE), true);
    ASSERT_NE(pluginBase_, nullptr);
    ASSERT_EQ(CreateBufferSize(), true);
    auto demuxerPlugin = std::static_pointer_cast<Plugins::DemuxerPlugin>(pluginBase_);
    ...
    ASSERT_EQ(audioIndexForRead, READFRAME_4);
}

/**
 * @tc.number    : DEMUXER_ASYN_INNER_APE_FUNC_0160
 * @tc.name      : pause-read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_APE_FUNC_0160, TestSize.Level3)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_APE, TEST_FILE_URI_APE, DEF_PROB_SIZE), true);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_APE_FUNC_0170
 * @tc.name      : pause-seek-read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_APE_FUNC_0170, TestSize.Level3)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int64_t realtime = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_APE_FUNC_0180
 * @tc.name      : 未选择轨，pause
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_APE_FUNC_0180, TestSize.Level3)
{
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_APE, TEST_FILE_URI_APE, DEF_PROB_SIZE), true);
    ASSERT_NE(pluginBase_, nullptr);
    auto demuxerPlugin = std::static_pointer_cast<Plugins::DemuxerPlugin>(pluginBase_);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_APE_FUNC_0190
 * @tc.name      : seek + read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_APE_FUNC_0190, TestSize.Level3)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int64_t seekTime = 6144000;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_APE_FUNC_0200
 * @tc.name      : seek后清理缓存
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_APE_FUNC_0200, TestSize.Level3)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int64_t realtime = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_APE_FUNC_0210
 * @tc.name      : >pts, SEEK_NEXT_SYNC+GetLastPTSByTrackId
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_APE_FUNC_0210, TestSize.Level2)
{
    indexAud = 0;
    int64_t realtime = 0;
    int64_t seekTime = 10752000;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_APE, TEST_FILE_URI_APE, DEF_PROB_SIZE), true);
    ASSERT_NE(pluginBase_, nullptr);
    auto demuxerPlugin = std::static_pointer_cast<Plugins::DemuxerPlugin>(pluginBase_);
    ASSERT_EQ(demuxerPlugin->SelectTrack(TRACKNUM_0), Status::OK);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_APE_FUNC_0220
 * @tc.name      : >pts, SEEK_PREVIOUS_SYNC+GetLastPTSByTrackId
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_APE_FUNC_0220, TestSize.Level2)
{
    indexAud = 0;
    int64_t realtime = 0;
    int64_t seekTime = 10752000;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_APE_FUNC_0230
 * @tc.name      : >pts, SEEK_CLOSEST_SYNC+GetLastPTSByTrackId
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_APE_FUNC_0230, TestSize.Level2)
{
    indexAud = 0;
    int64_t realtime = 0;
    int64_t seekTime = 10752000;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_APE_FUNC_0240
 * @tc.name      : 老ReadSample + 新 ReadSample
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_APE_FUNC_0240, TestSize.Level2)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_APE, TEST_FILE_URI_APE, DEF_PROB_SIZE), true);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_APE_FUNC_0250
 * @tc.name      : 老ReadSample + 新 GetNextSampleSize
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_APE_FUNC_0250, TestSize.Level2)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_APE_FUNC_0260
 * @tc.name      : 老 GetNextSampleSize + 新 ReadSample
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_APE_FUNC_0260, TestSize.Level2)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_APE_FUNC_0270
 * @tc.name      : 老 GetNextSampleSize + 新 GetNextSampleSize
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_APE_FUNC_0270, TestSize.Level2)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_APE_FUNC_0280
 * @tc.name      : 新 ReadSample + 老 ReadSample
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_APE_FUNC_0280, TestSize.Level2)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_APE, TEST_FILE_URI_APE, DEF_PROB_SIZE), true);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_APE_FUNC_0290
 * @tc.name      : 新 ReadSample + 老 GetNextSampleSize
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_APE_FUNC_0290, TestSize.Level2)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_APE_FUNC_0300
 * @tc.name      : 新 GetNextSampleSize + 老 ReadSample
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_APE_FUNC_0300, TestSize.Level2)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_APE_FUNC_0310
 * @tc.name      : 新 GetNextSampleSize + 老 GetNextSampleSize
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_APE_FUNC_0310, TestSize.Level2)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_SRT_FUNC_0070
...
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_SRT_FUNC_0070, TestSize.Level0)
{
    ...
    ASSERT_EQ(audioIndexForRead, READFRAME_2);
}
/**
 * @tc.number    : DEMUXER_ASYN_INNER_SRT_FUNC_0080
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_SRT_FUNC_0090
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_SRT_FUNC_0100
 * @tc.name      : GetNextSampleSize,读取音频轨
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_SRT_FUNC_0100, TestSize.Level1)
{
    int32_t size = 0;
    indexAud = 0;
    uint32_t timeout = 10000;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_SRT_FUNC_0110
 * @tc.name      : GetNextSampleSize,读取不存在轨
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_SRT_FUNC_0110, TestSize.Level1)
{
    int32_t size = 0;
    indexAud = 7;
    uint32_t timeout = 10000;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_SRT_FUNC_0120
 * @tc.name      : GetLastPTSByTrackId,不选轨道
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_SRT_FUNC_0120, TestSize.Level2)
{
    indexAud = 0;
    int64_t pts = 0;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_SRT, TEST_FILE_URI_SRT, DEF_PROB_SIZE), true);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_SRT_FUNC_0130
 * @tc.name      : GetLastPTSByTrackId,入参的id没有被选择
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_SRT_FUNC_0130, TestSize.Level2)
{
    indexAud = 7;
    int64_t pts = 0;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_SRT, TEST_FILE_URI_SRT, DEF_PROB_SIZE), true);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_SRT_FUNC_0140
 * @tc.name      : read-pause-read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_SRT_FUNC_0140, TestSize.Level3)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_SRT, TEST_FILE_URI_SRT, DEF_PROB_SIZE), true);
    ...
    ASSERT_EQ(audioIndexForRead, READFRAME_1);
}

/**
 * @tc.number    : DEMUXER_ASYN_INNER_SRT_FUNC_0150
 * @tc.name      : read-pause-seek-read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_SRT_FUNC_0150, TestSize.Level3)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int64_t realtime = 0;
    int64_t seekTime = 1000000;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_SRT, TEST_FILE_URI_SRT, DEF_PROB_SIZE), true);
    ASSERT_NE(pluginBase_, nullptr);
    ASSERT_EQ(CreateBufferSize(), true);
    auto demuxerPlugin = std::static_pointer_cast<Plugins::DemuxerPlugin>(pluginBase_);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_SRT_FUNC_0160
 * @tc.name      : pause-read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_SRT_FUNC_0160, TestSize.Level3)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_SRT, TEST_FILE_URI_SRT, DEF_PROB_SIZE), true);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_SRT_FUNC_0170
 * @tc.name      : pause-seek-read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_SRT_FUNC_0170, TestSize.Level3)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int64_t realtime = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_SRT_FUNC_0180
 * @tc.name      : 未选择轨，pause
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_SRT_FUNC_0180, TestSize.Level3)
{
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_SRT, TEST_FILE_URI_SRT, DEF_PROB_SIZE), true);
    ASSERT_NE(pluginBase_, nullptr);
    auto demuxerPlugin = std::static_pointer_cast<Plugins::DemuxerPlugin>(pluginBase_);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_SRT_FUNC_0190
 * @tc.name      : seek + read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_SRT_FUNC_0190, TestSize.Level3)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int64_t seekTime = 1000000;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_SRT_FUNC_0200
 * @tc.name      : seek后清理缓存
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_SRT_FUNC_0200, TestSize.Level3)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int64_t realtime = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_SRT_FUNC_0210
 * @tc.name      : >pts, SEEK_NEXT_SYNC+GetLastPTSByTrackId
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_SRT_FUNC_0210, TestSize.Level2)
{
    indexAud = 0;
    int64_t realtime = 0;
    int64_t seekTime = 5400000;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_SRT, TEST_FILE_URI_SRT, DEF_PROB_SIZE), true);
    ASSERT_NE(pluginBase_, nullptr);
    auto demuxerPlugin = std::static_pointer_cast<Plugins::DemuxerPlugin>(pluginBase_);
    ASSERT_EQ(demuxerPlugin->SelectTrack(TRACKNUM_0), Status::OK);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_SRT_FUNC_0220
 * @tc.name      : >pts, SEEK_PREVIOUS_SYNC+GetLastPTSByTrackId
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_SRT_FUNC_0220, TestSize.Level2)
{
    indexAud = 0;
    int64_t realtime = 0;
    int64_t seekTime = 5400000;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_SRT_FUNC_0230
 * @tc.name      : >pts, SEEK_CLOSEST_SYNC+GetLastPTSByTrackId
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_SRT_FUNC_0230, TestSize.Level2)
{
    indexAud = 0;
    int64_t realtime = 0;
    int64_t seekTime = 5400000;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_SRT_FUNC_0240
 * @tc.name      : 老ReadSample + 新 ReadSample
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_SRT_FUNC_0240, TestSize.Level2)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_SRT, TEST_FILE_URI_SRT, DEF_PROB_SIZE), true);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_SRT_FUNC_0250
 * @tc.name      : 老ReadSample + 新 GetNextSampleSize
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_SRT_FUNC_0250, TestSize.Level2)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_SRT_FUNC_0260
 * @tc.name      : 老 GetNextSampleSize + 新 ReadSample
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_SRT_FUNC_0260, TestSize.Level2)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_SRT_FUNC_0270
 * @tc.name      : 老 GetNextSampleSize + 新 GetNextSampleSize
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_SRT_FUNC_0270, TestSize.Level2)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_SRT_FUNC_0280
 * @tc.name      : 新 ReadSample + 老 ReadSample
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_SRT_FUNC_0280, TestSize.Level2)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_SRT, TEST_FILE_URI_SRT, DEF_PROB_SIZE), true);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_SRT_FUNC_0290
 * @tc.name      : 新 ReadSample + 老 GetNextSampleSize
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_SRT_FUNC_0290, TestSize.Level2)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_SRT_FUNC_0300
 * @tc.name      : 新 GetNextSampleSize + 老 ReadSample
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_SRT_FUNC_0300, TestSize.Level2)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_SRT_FUNC_0310
 * @tc.name      : 新 GetNextSampleSize + 老 GetNextSampleSize
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_SRT_FUNC_0310, TestSize.Level2)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_WEBVTT_FUNC_0070
 * @tc.name      : ReadSample全流程
 * @tc.desc      : func test
 */
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_WEBVTT_FUNC_0080
 * @tc.name      : ReadSample,一条轨，timeout = 0
 * @tc.desc      : func test
 */
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_WEBVTT_FUNC_0090
 * @tc.name      : read , timeout > 1帧读取时间
 * @tc.desc      : func test
 */
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_WEBVTT_FUNC_0100
 * @tc.name      : GetNextSampleSize,读取音频轨
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_WEBVTT_FUNC_0100, TestSize.Level1)
{
    int32_t size = 0;
    indexAud = 0;
    uint32_t timeout = 10000;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_WEBVTT_FUNC_0110
 * @tc.name      : GetNextSampleSize,读取不存在轨
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_WEBVTT_FUNC_0110, TestSize.Level1)
{
    int32_t size = 0;
    indexAud = 7;
    uint32_t timeout = 10000;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_WEBVTT_FUNC_0120
 * @tc.name      : GetLastPTSByTrackId,不选轨道
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_WEBVTT_FUNC_0120, TestSize.Level2)
{
    indexAud = 0;
    int64_t pts = 0;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_WEBVTT, TEST_FILE_URI_WEBVTT, DEF_PROB_SIZE), true);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_WEBVTT_FUNC_0130
 * @tc.name      : GetLastPTSByTrackId,入参的id没有被选择
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_WEBVTT_FUNC_0130, TestSize.Level2)
{
    indexAud = 7;
    int64_t pts = 0;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_WEBVTT, TEST_FILE_URI_WEBVTT, DEF_PROB_SIZE), true);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_WEBVTT_FUNC_0140
 * @tc.name      : read-pause-read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_WEBVTT_FUNC_0140, TestSize.Level3)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_WEBVTT, TEST_FILE_URI_WEBVTT, DEF_PROB_SIZE), true);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_WEBVTT_FUNC_0150
 * @tc.name      : read-pause-seek-read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_WEBVTT_FUNC_0150, TestSize.Level3)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int64_t realtime = 0;
    int64_t seekTime = 2100000;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_WEBVTT, TEST_FILE_URI_WEBVTT, DEF_PROB_SIZE), true);
    ASSERT_NE(pluginBase_, nullptr);
    ASSERT_EQ(CreateBufferSize(), true);
    auto demuxerPlugin = std::static_pointer_cast<Plugins::DemuxerPlugin>(pluginBase_);
    ...
    ASSERT_EQ(audioIndexForRead, READFRAME_5);
}

/**
 * @tc.number    : DEMUXER_ASYN_INNER_WEBVTT_FUNC_0160
 * @tc.name      : pause-read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_WEBVTT_FUNC_0160, TestSize.Level3)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_WEBVTT, TEST_FILE_URI_WEBVTT, DEF_PROB_SIZE), true);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_WEBVTT_FUNC_0170
 * @tc.name      : pause-seek-read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_WEBVTT_FUNC_0170, TestSize.Level3)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int64_t realtime = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_WEBVTT_FUNC_0180
 * @tc.name      : 未选择轨，pause
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_WEBVTT_FUNC_0180, TestSize.Level3)
{
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_WEBVTT, TEST_FILE_URI_WEBVTT, DEF_PROB_SIZE), true);
    ASSERT_NE(pluginBase_, nullptr);
    auto demuxerPlugin = std::static_pointer_cast<Plugins::DemuxerPlugin>(pluginBase_);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_WEBVTT_FUNC_0190
 * @tc.name      : seek + read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_WEBVTT_FUNC_0190, TestSize.Level3)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int64_t seekTime = 2100000;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_WEBVTT_FUNC_0200
 * @tc.name      : seek后清理缓存
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_WEBVTT_FUNC_0200, TestSize.Level3)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int64_t realtime = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_WEBVTT_FUNC_0210
 * @tc.name      : >pts, SEEK_NEXT_SYNC+GetLastPTSByTrackId
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_WEBVTT_FUNC_0210, TestSize.Level2)
{
    indexAud = 0;
    int64_t realtime = 0;
    int64_t seekTime = 6100000;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_WEBVTT, TEST_FILE_URI_WEBVTT, DEF_PROB_SIZE), true);
    ASSERT_NE(pluginBase_, nullptr);
    auto demuxerPlugin = std::static_pointer_cast<Plugins::DemuxerPlugin>(pluginBase_);
    ASSERT_EQ(demuxerPlugin->SelectTrack(TRACKNUM_0), Status::OK);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_WEBVTT_FUNC_0220
 * @tc.name      : >pts, SEEK_PREVIOUS_SYNC+GetLastPTSByTrackId
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_WEBVTT_FUNC_0220, TestSize.Level2)
{
    indexAud = 0;
    int64_t realtime = 0;
    int64_t seekTime = 6100000;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_WEBVTT_FUNC_0230
 * @tc.name      : >pts, SEEK_CLOSEST_SYNC+GetLastPTSByTrackId
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_WEBVTT_FUNC_0230, TestSize.Level2)
{
    indexAud = 0;
    int64_t realtime = 0;
    int64_t seekTime = 6100000;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_WEBVTT_FUNC_0240
 * @tc.name      : 老ReadSample + 新 ReadSample
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_WEBVTT_FUNC_0240, TestSize.Level2)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_WEBVTT, TEST_FILE_URI_WEBVTT, DEF_PROB_SIZE), true);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_WEBVTT_FUNC_0250
 * @tc.name      : 老ReadSample + 新 GetNextSampleSize
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_WEBVTT_FUNC_0250, TestSize.Level2)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_WEBVTT_FUNC_0260
 * @tc.name      : 老 GetNextSampleSize + 新 ReadSample
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_WEBVTT_FUNC_0260, TestSize.Level2)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_WEBVTT_FUNC_0270
 * @tc.name      : 老 GetNextSampleSize + 新 GetNextSampleSize
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_WEBVTT_FUNC_0270, TestSize.Level2)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_WEBVTT_FUNC_0280
 * @tc.name      : 新 ReadSample + 老 ReadSample
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_WEBVTT_FUNC_0280, TestSize.Level2)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_WEBVTT, TEST_FILE_URI_WEBVTT, DEF_PROB_SIZE), true);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_WEBVTT_FUNC_0290
 * @tc.name      : 新 ReadSample + 老 GetNextSampleSize
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_WEBVTT_FUNC_0290, TestSize.Level2)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_WEBVTT_FUNC_0300
 * @tc.name      : 新 GetNextSampleSize + 老 ReadSample
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_WEBVTT_FUNC_0300, TestSize.Level2)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_WEBVTT_FUNC_0310
 * @tc.name      : 新 GetNextSampleSize + 老 GetNextSampleSize
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFunc8Test, DEMUXER_ASYN_INNER_WEBVTT_FUNC_0310, TestSize.Level2)
{
    indexAud = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
