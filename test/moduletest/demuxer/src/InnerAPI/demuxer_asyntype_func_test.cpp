...
class DemuxerAsynTypeInnerFuncTest : public testing::Test {
public:
...
constexpr uint32_t READFRAME_431 = 431;
constexpr uint32_t READFRAME_420 = 420;
constexpr uint32_t READFRAME_301 = 301;
constexpr uint32_t READFRAME_10 = 10;
...
void DemuxerAsynTypeInnerFuncTest::SetUpTestCase(void) {}

void DemuxerAsynTypeInnerFuncTest::TearDownTestCase(void) {}

void DemuxerAsynTypeInnerFuncTest::SetUp(void)
{
}

void DemuxerAsynTypeInnerFuncTest::TearDown(void)
{
    dataSourceImpl_ = nullptr;
}

bool DemuxerAsynTypeInnerFuncTest::CreateBufferSize()
{
...
bool DemuxerAsynTypeInnerFuncTest::CreateDemuxerPluginByName(const std::string& typeName, const std::string& filePath,
    int probSize)
{
...
void DemuxerAsynTypeInnerFuncTest::RemoveValue()
{
    if (!frames_.empty()) {
        frames_.clear();
    }
...
void DemuxerAsynTypeInnerFuncTest::GetFrameNum(int32_t i)
{
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0070
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0080
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0090
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0100
 * @tc.name      : GetNextSampleSize,读取视频轨
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_FLV_FUNC_0100, TestSize.Level1)
{
    int32_t size = 0;
    indexVid = 0;
    uint32_t timeout = 10000;
    int32_t sizenum = 35491;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_FLV, TEST_FILE_URI_FLV_1, DEF_PROB_SIZE), true);
    ASSERT_NE(pluginBase_, nullptr);
    auto demuxerPlugin = std::static_pointer_cast<Plugins::DemuxerPlugin>(pluginBase_);
    ASSERT_EQ(demuxerPlugin->SelectTrack(TRACKNUM_0), Status::OK);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0110
 * @tc.name      : GetNextSampleSize,读取音频轨
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_FLV_FUNC_0110, TestSize.Level1)
{
    int32_t size = 0;
    indexAud = 1;
    uint32_t timeout = 10000;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0120
 * @tc.name      : GetNextSampleSize,读取不存在轨
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_FLV_FUNC_0120, TestSize.Level1)
{
    int32_t size = 0;
    indexAud = 7;
    uint32_t timeout = 10000;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0130
 * @tc.name      : GetLastPTSByTrackId,读取视频轨，得到音频轨lastpts
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_FLV_FUNC_0130, TestSize.Level2)
{
    indexVid = 0;
    indexAud = 1;
    readPos = 60;
 ...
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_FLV_FUNC_0140, TestSize.Level2)
{
    indexVid = 0;
    indexAud = 1;
    readPos = 60;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0150
 * @tc.name      : GetLastPTSByTrackId,不选轨道
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_FLV_FUNC_0150, TestSize.Level2)
{
    indexVid = 0;
    int64_t pts = 0;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_FLV, TEST_FILE_URI_FLV_1, DEF_PROB_SIZE), true);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0160
 * @tc.name      : GetLastPTSByTrackId,入参的id没有被选择
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_FLV_FUNC_0160, TestSize.Level2)
{
    indexVid = 0;
    int64_t pts = 0;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_FLV, TEST_FILE_URI_FLV_1, DEF_PROB_SIZE), true);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0170
 * @tc.name      : read-pause-read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_FLV_FUNC_0170, TestSize.Level3)
{
    indexVid = 0;
    uint32_t timeout = 10000;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_FLV, TEST_FILE_URI_FLV_1, DEF_PROB_SIZE), true);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0180
 * @tc.name      : read-pause-seek-read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_FLV_FUNC_0180, TestSize.Level3)
{
    indexVid = 0;
    uint32_t timeout = 10000;
    int64_t realtime = 0;
    int64_t seekTime = 5817000;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_FLV, TEST_FILE_URI_FLV_1, DEF_PROB_SIZE), true);
    ASSERT_NE(pluginBase_, nullptr);
    ASSERT_EQ(CreateBufferSize(), true);
    auto demuxerPlugin = std::static_pointer_cast<Plugins::DemuxerPlugin>(pluginBase_);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0190
 * @tc.name      : pause-read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_FLV_FUNC_0190, TestSize.Level3)
{
    indexVid = 0;
    uint32_t timeout = 10000;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_FLV, TEST_FILE_URI_FLV_1, DEF_PROB_SIZE), true);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0200
 * @tc.name      : pause-seek-read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_FLV_FUNC_0200, TestSize.Level3)
{
    indexVid = 0;
    uint32_t timeout = 10000;
    int64_t realtime = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0210
 * @tc.name      : 未选择轨，pause
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_FLV_FUNC_0210, TestSize.Level3)
{
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_FLV, TEST_FILE_URI_FLV_1, DEF_PROB_SIZE), true);
    ASSERT_NE(pluginBase_, nullptr);
    auto demuxerPlugin = std::static_pointer_cast<Plugins::DemuxerPlugin>(pluginBase_);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0220
 * @tc.name      : seek + read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_FLV_FUNC_0220, TestSize.Level3)
{
    indexVid = 0;
    indexAud = 1;
    uint32_t timeout = 10000;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0230
 * @tc.name      : seek后清理缓存
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_FLV_FUNC_0230, TestSize.Level3)
{
    indexVid = 0;
    indexAud = 1;
    uint32_t timeout = 10000;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0240
 * @tc.name      : >pts, SEEK_NEXT_SYNC+GetLastPTSByTrackId
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_FLV_FUNC_0240, TestSize.Level2)
{
    indexVid = 0;
    int64_t realtime = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0250
 * @tc.name      : >pts, SEEK_PREVIOUS_SYNC+GetLastPTSByTrackId
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_FLV_FUNC_0250, TestSize.Level2)
{
    indexVid = 0;
    int64_t realtime = 0;
    int64_t seekTime = 12367000;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0260
 * @tc.name      : >pts, SEEK_CLOSEST_SYNC+GetLastPTSByTrackId
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_FLV_FUNC_0260, TestSize.Level2)
{
    indexVid = 0;
    int64_t realtime = 0;
    int64_t seekTime = 12367000;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0270
 * @tc.name      : 老ReadSample + 新 ReadSample
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_FLV_FUNC_0270, TestSize.Level2)
{
    indexVid = 0;
    uint32_t timeout = 10000;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_FLV, TEST_FILE_URI_FLV_1, DEF_PROB_SIZE), true);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0280
 * @tc.name      : 老ReadSample + 新 GetNextSampleSize
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_FLV_FUNC_0280, TestSize.Level2)
{
    indexVid = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0290
 * @tc.name      : 老 GetNextSampleSize + 新 ReadSample
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_FLV_FUNC_0290, TestSize.Level2)
{
    indexVid = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0300
 * @tc.name      : 老 GetNextSampleSize + 新 GetNextSampleSize
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_FLV_FUNC_0300, TestSize.Level2)
{
    indexVid = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0310
 * @tc.name      : 新 ReadSample + 老 ReadSample
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_FLV_FUNC_0310, TestSize.Level2)
{
    indexVid = 0;
    uint32_t timeout = 10000;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_FLV, TEST_FILE_URI_FLV_1, DEF_PROB_SIZE), true);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0320
 * @tc.name      : 新 ReadSample + 老 GetNextSampleSize
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_FLV_FUNC_0320, TestSize.Level2)
{
    indexVid = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0330
 * @tc.name      : 新 GetNextSampleSize + 老 ReadSample
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_FLV_FUNC_0330, TestSize.Level2)
{
    indexVid = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_FLV_FUNC_0340
 * @tc.name      : 新 GetNextSampleSize + 老 GetNextSampleSize
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_FLV_FUNC_0340, TestSize.Level2)
{
    indexVid = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0070
 * @tc.name      : ReadSample全流程
 * @tc.desc      : func test
 */
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0080
 * @tc.name      : ReadSample,一条轨，timeout = 0
 * @tc.desc      : func test
 */
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0090
 * @tc.name      : read , timeout > 1帧读取时间
 * @tc.desc      : func test
 */
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0100
 * @tc.name      : GetNextSampleSize,读取视频轨
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0100, TestSize.Level1)
{
    int32_t size = 0;
    indexVid = 0;
    uint32_t timeout = 10000;
    int32_t sizenum = 81294;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_MOV_S, TEST_FILE_URI_MP4, DEF_PROB_SIZE), true);
    ASSERT_NE(pluginBase_, nullptr);
    auto demuxerPlugin = std::static_pointer_cast<Plugins::DemuxerPlugin>(pluginBase_);
    ASSERT_EQ(demuxerPlugin->SelectTrack(TRACKNUM_0), Status::OK);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0110
 * @tc.name      : GetNextSampleSize,读取音频轨
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0110, TestSize.Level1)
{
    int32_t size = 0;
    indexAud = 1;
    uint32_t timeout = 10000;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0120
 * @tc.name      : GetNextSampleSize,读取不存在轨
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0120, TestSize.Level1)
{
    int32_t size = 0;
    indexAud = 7;
    uint32_t timeout = 10000;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0130
 * @tc.name      : GetLastPTSByTrackId,读取视频轨，得到音频轨lastpts
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0130, TestSize.Level2)
{
    indexVid = 0;
    indexAud = 1;
    readPos = 60;
 ...
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0140, TestSize.Level2)
{
    indexVid = 0;
    indexAud = 1;
    readPos = 60;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0150
 * @tc.name      : GetLastPTSByTrackId,不选轨道
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0150, TestSize.Level2)
{
    indexVid = 0;
    int64_t pts = 0;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_MOV_S, TEST_FILE_URI_MP4, DEF_PROB_SIZE), true);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0160
 * @tc.name      : GetLastPTSByTrackId,入参的id没有被选择
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0160, TestSize.Level2)
{
    indexVid = 0;
    int64_t pts = 0;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_MOV_S, TEST_FILE_URI_MP4, DEF_PROB_SIZE), true);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0170
 * @tc.name      : read-pause-read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0170, TestSize.Level3)
{
    indexVid = 0;
    uint32_t timeout = 10000;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_MOV_S, TEST_FILE_URI_MP4, DEF_PROB_SIZE), true);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0180
 * @tc.name      : read-pause-seek-read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0180, TestSize.Level3)
{
    indexVid = 0;
    uint32_t timeout = 10000;
    int64_t realtime = 0;
    int64_t seekTime = 10366666;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_MOV_S, TEST_FILE_URI_MP4, DEF_PROB_SIZE), true);
    ASSERT_NE(pluginBase_, nullptr);
    ASSERT_EQ(CreateBufferSize(), true);
    auto demuxerPlugin = std::static_pointer_cast<Plugins::DemuxerPlugin>(pluginBase_);
    ...
    ASSERT_EQ(audioIndexForRead, READFRAME_84);
    ASSERT_EQ(videoIndexForRead, READFRAME_60);
}

/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0190
 * @tc.name      : pause-read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0190, TestSize.Level3)
{
    indexVid = 0;
    uint32_t timeout = 10000;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_MOV_S, TEST_FILE_URI_MP4, DEF_PROB_SIZE), true);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0200
 * @tc.name      : pause-seek-read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0200, TestSize.Level3)
{
    indexVid = 0;
    uint32_t timeout = 10000;
    int64_t realtime = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0210
 * @tc.name      : 未选择轨，pause
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0210, TestSize.Level3)
{
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_MOV_S, TEST_FILE_URI_MP4, DEF_PROB_SIZE), true);
    ASSERT_NE(pluginBase_, nullptr);
    auto demuxerPlugin = std::static_pointer_cast<Plugins::DemuxerPlugin>(pluginBase_);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0220
 * @tc.name      : seek + read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0220, TestSize.Level3)
{
    indexVid = 0;
    indexAud = 1;
    uint32_t timeout = 10000;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0230
 * @tc.name      : seek后清理缓存
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0230, TestSize.Level3)
{
    indexVid = 0;
    indexAud = 1;
    uint32_t timeout = 10000;
    int64_t realtime = 0;
    int64_t seekTime = 10455666;
    int64_t pts = 0;
    int32_t readCount = 0;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_MOV_S, TEST_FILE_URI_MP4, DEF_PROB_SIZE), true);
    ASSERT_NE(pluginBase_, nullptr);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0240
 * @tc.name      : >pts, SEEK_NEXT_SYNC+GetLastPTSByTrackId
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0240, TestSize.Level2)
{
    indexVid = 0;
    int64_t realtime = 0;
    int64_t seekTime = 12422333;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_MOV_S, TEST_FILE_URI_MP4, DEF_PROB_SIZE), true);
    ASSERT_NE(pluginBase_, nullptr);
    auto demuxerPlugin = std::static_pointer_cast<Plugins::DemuxerPlugin>(pluginBase_);
    ASSERT_EQ(demuxerPlugin->SelectTrack(TRACKNUM_0), Status::OK);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0250
 * @tc.name      : >pts, SEEK_PREVIOUS_SYNC+GetLastPTSByTrackId
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0250, TestSize.Level2)
{
    indexVid = 0;
    int64_t realtime = 0;
    int64_t seekTime = 12422333;
    ...
    ASSERT_EQ(audioIndexForRead, READFRAME_16);
    ASSERT_EQ(videoIndexForRead, READFRAME_12);
}

/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0260
 * @tc.name      : >pts, SEEK_CLOSEST_SYNC+GetLastPTSByTrackId
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0260, TestSize.Level2)
{
    indexVid = 0;
    int64_t realtime = 0;
    int64_t seekTime = 12422333;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0270
 * @tc.name      : 老ReadSample + 新 ReadSample
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0270, TestSize.Level2)
{
    indexVid = 0;
    uint32_t timeout = 10000;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_MOV_S, TEST_FILE_URI_MP4, DEF_PROB_SIZE), true);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0280
 * @tc.name      : 老ReadSample + 新 GetNextSampleSize
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0280, TestSize.Level2)
{
    indexVid = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0290
 * @tc.name      : 老 GetNextSampleSize + 新 ReadSample
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0290, TestSize.Level2)
{
    indexVid = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0300
 * @tc.name      : 老 GetNextSampleSize + 新 GetNextSampleSize
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0300, TestSize.Level2)
{
    indexVid = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0310
 * @tc.name      : 新 ReadSample + 老 ReadSample
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0310, TestSize.Level2)
{
    indexVid = 0;
    uint32_t timeout = 10000;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_MOV_S, TEST_FILE_URI_MP4, DEF_PROB_SIZE), true);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0320
 * @tc.name      : 新 ReadSample + 老 GetNextSampleSize
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0320, TestSize.Level2)
{
    indexVid = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0330
 * @tc.name      : 新 GetNextSampleSize + 老 ReadSample
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0330, TestSize.Level2)
{
    indexVid = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0340
 * @tc.name      : 新 GetNextSampleSize + 老 GetNextSampleSize
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0340, TestSize.Level2)
{
    indexVid = 0;
    uint32_t timeout = 10000;
    int32_t size = 0;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0071
 * @tc.name      : ReadSample全流程
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0071, TestSize.Level1)
{
    ...
    ASSERT_EQ(demuxerPlugin->SelectTrack(3), Status::OK);
    ASSERT_EQ(CreateBufferSize(), true);
    while (!isAuxDepthEosFlagForSave || !isAuxPreyEosFlagForSave || !isMetaEosFlagForSave) {
        for (int32_t i = TRACKNUM_1; i <= TRACKNUM_3; i++) {
            if (((i == TRACKNUM_1) && isAuxDepthEosFlagForSave) || ((i == TRACKNUM_2) && isAuxPreyEosFlagForSave)
             || ((i == TRACKNUM_3) && isMetaEosFlagForSave)) {
                continue;
            }
            ASSERT_EQ(demuxerPlugin->ReadSample(i, avBuf_, timeout), Status::OK);
            if (avBuf_->flag_ == MediaAVCodec::AVCODEC_BUFFER_FLAG_EOS) {
    ...
    ASSERT_EQ(metaIndexForRead, READFRAME_16);
}

/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0081
 * @tc.name      : ReadSample,一条轨，timeout = 0
 * @tc.desc      : func test
 */
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0091
 * @tc.name      : read , timeout > 1帧读取时间
 * @tc.desc      : func test
 */
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0221
 * @tc.name      : seek + read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0221, TestSize.Level3)
{
    indexVid = 0;
    indexAud = 1;
    uint32_t timeout = 10000;
    ...
    ASSERT_EQ(auxDepthIndexForRead, 47);
}

/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0241
 * @tc.name      : >pts, SEEK_NEXT_SYNC+GetLastPTSByTrackId
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0241, TestSize.Level2)
{
    indexVid = 0;
    int64_t realtime = 0;
    int64_t seekTime = 500177;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_MOV_S, TEST_FILE_URI_MP4_1, DEF_PROB_SIZE), true);
    ASSERT_NE(pluginBase_, nullptr);
    auto demuxerPlugin = std::static_pointer_cast<Plugins::DemuxerPlugin>(pluginBase_);
    ASSERT_EQ(demuxerPlugin->SelectTrack(TRACKNUM_0), Status::OK);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0251
 * @tc.name      : >pts, SEEK_PREVIOUS_SYNC+GetLastPTSByTrackId
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0251, TestSize.Level2)
{
    indexVid = 0;
    int64_t realtime = 0;
    int64_t seekTime = 500177;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0261
 * @tc.name      : >pts, SEEK_CLOSEST_SYNC+GetLastPTSByTrackId
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0261, TestSize.Level2)
{
    indexVid = 0;
    int64_t realtime = 0;
    int64_t seekTime = 500177;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0072
 * @tc.name      : ReadSample全流程
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0072, TestSize.Level1)
{
    ...
    ASSERT_EQ(demuxerPlugin->SelectTrack(TRACKNUM_2), Status::OK);
    ASSERT_EQ(CreateBufferSize(), true);
    while (!isAudioEosFlagForSave || !isVideoEosFlagForSave || !isSubtitleEosFlagForSave) {
        for (int32_t i = 0; i <= TRACKNUM_2; i++) {
            if (((i == videoTrackIdx) && isVideoEosFlagForSave) || ((i == audioTrackIdx) && isAudioEosFlagForSave)
             || ((i == subtitleTrackIdx) && isSubtitleEosFlagForSave)) {
                continue;
            }
            ASSERT_EQ(demuxerPlugin->ReadSample(i, avBuf_, timeout), Status::OK);
            if (avBuf_->flag_ == MediaAVCodec::AVCODEC_BUFFER_FLAG_EOS) {
    ...
    ASSERT_EQ(audioIndexForRead, READFRAME_431);
    ASSERT_EQ(subtitleIndexForRead, READFRAME_12);
}
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0082
 * @tc.name      : ReadSample,一条轨，timeout = 0
 * @tc.desc      : func test
 */
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0092
 * @tc.name      : read , timeout > 1帧读取时间
 * @tc.desc      : func test
 */
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0222
 * @tc.name      : seek + read
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0222, TestSize.Level3)
{
    indexVid = 0;
    indexAud = 1;
    uint32_t timeout = 10000;
    int64_t seekTime = 2983333;
    int64_t realtime = 0;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_MOV_S, TEST_FILE_URI_MP4_2, DEF_PROB_SIZE), true);
    ASSERT_NE(pluginBase_, nullptr);
    ASSERT_EQ(CreateBufferSize(), true);
    ...
    ASSERT_EQ(audioIndexForRead, READFRAME_301);
    ASSERT_EQ(subtitleIndexForRead, READFRAME_10);
}

/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0242
 * @tc.name      : >pts, SEEK_NEXT_SYNC+GetLastPTSByTrackId
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0242, TestSize.Level2)
{
    indexVid = 0;
    int64_t realtime = 0;
    int64_t seekTime = 9983333;
    ASSERT_EQ(CreateDemuxerPluginByName(DEMUXER_PLUGIN_NAME_MOV_S, TEST_FILE_URI_MP4_2, DEF_PROB_SIZE), true);
    ASSERT_NE(pluginBase_, nullptr);
    auto demuxerPlugin = std::static_pointer_cast<Plugins::DemuxerPlugin>(pluginBase_);
    ASSERT_EQ(demuxerPlugin->SelectTrack(TRACKNUM_0), Status::OK);
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0252
 * @tc.name      : >pts, SEEK_PREVIOUS_SYNC+GetLastPTSByTrackId
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0252, TestSize.Level2)
{
    indexVid = 0;
    int64_t realtime = 0;
    int64_t seekTime = 9983333;
...
/**
 * @tc.number    : DEMUXER_ASYN_INNER_MP4_FUNC_0262
 * @tc.name      : >pts, SEEK_CLOSEST_SYNC+GetLastPTSByTrackId
 * @tc.desc      : func test
 */
HWTEST_F(DemuxerAsynTypeInnerFuncTest, DEMUXER_ASYN_INNER_MP4_FUNC_0262, TestSize.Level2)
{
    indexVid = 0;
    int64_t realtime = 0;
    int64_t seekTime = 9983333;
