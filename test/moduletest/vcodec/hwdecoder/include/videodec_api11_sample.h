...
public:
    ...
    const char *DYNAMIC_METADATA_FILE = "";
    const char *STATIC_METADATA_FILE = "";
    ...
    bool MdCompareMetaData(uint8_t source[], std::string file);
    void CompareHdrInfo(OH_AVBuffer *buffer, OH_AVCodecBufferAttr attr);
    void GetHdrDynamicMetaData();
    void GetHdrtaticMetaData();
    bool GetHdrMetaDataType(int &metaDataType);
