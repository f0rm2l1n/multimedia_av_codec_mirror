...
namespace OHOS {
namespace Media {
class CinepakdecApiNdkTest : public testing::Test {
public:
...
OH_AVCodec *g_vdec = nullptr;
OH_AVCapability *g_cap = nullptr;
const string CODEC_NAME = "OH.Media.Codec.Decoder.Video.CINEPAK";
VDecAPI11Signal *g_signal = nullptr;
...
void CinepakdecApiNdkTest::SetUpTestCase()
{
    const char *file = "/data/test/media/cinepak.mkv";
    GetFormat(file);
}
void CinepakdecApiNdkTest::TearDownTestCase()
{
...
void CinepakdecApiNdkTest::SetUp()
{
    g_signal = new VDecAPI11Signal();
}
void CinepakdecApiNdkTest::TearDown()
{
    if (g_format != nullptr) {
...
namespace {
/**
 * @tc.number    : VIDEO_CINEPAKDEC_API_0100
 * @tc.name      : Test repeat creation of OH_VideoDecoder_CreateByName
 * @tc.desc      : function test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_API_0100, TestSize.Level2)
{
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_API_0200
 * @tc.name      : Test configuration of OH_VideoDecoder
 * @tc.desc      : function test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_API_0200, TestSize.Level2)
{
    g_vdec = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
    ASSERT_NE(NULL, g_vdec);

    OH_AVFormat *g_format = OH_AVFormat_Create();
    ASSERT_NE(NULL, g_format);
    ...
    ASSERT_EQ(AV_ERR_INVALID_STATE, OH_VideoDecoder_Configure(g_vdec, g_format));
    OH_AVFormat_Destroy(g_format);
    g_format = nullptr;
}

/**
 * @tc.number    : VIDEO_CINEPAKDEC_API_0300
 * @tc.name      : Test start operation of OH_VideoDecoder
 * @tc.desc      : function test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_API_0300, TestSize.Level2)
{
    g_vdec = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
    ASSERT_NE(NULL, g_vdec);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_API_0400
 * @tc.name      : Test stop operation of OH_VideoDecoder
 * @tc.desc      : function test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_API_0400, TestSize.Level2)
{
    g_vdec = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
    ASSERT_NE(NULL, g_vdec);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_API_0500
 * @tc.name      : Test reset operation of OH_VideoDecoder
 * @tc.desc      : function test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_API_0500, TestSize.Level2)
{
    g_vdec = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
    ASSERT_NE(NULL, g_vdec);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_API_0600
 * @tc.name      : Test EOS handling in OH_VideoDecoder
 * @tc.desc      : function test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_API_0600, TestSize.Level2)
{
    g_vdec = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
    ASSERT_NE(NULL, g_vdec);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_API_0700
 * @tc.name      : Test flush operation of OH_VideoDecoder
 * @tc.desc      : function test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_API_0700, TestSize.Level2)
{
    g_vdec = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
    ASSERT_NE(NULL, g_vdec);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_API_0800
 * @tc.name      : Test release operation of OH_VideoDecoder
 * @tc.desc      : function test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_API_0800, TestSize.Level2)
{
    g_vdec = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
    ASSERT_NE(NULL, g_vdec);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_API_0900
 * @tc.name      : Test creation of OH_VideoDecoder by MIME type
 * @tc.desc      : function test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_API_0900, TestSize.Level2)
{
    g_vdec = OH_VideoDecoder_CreateByMime(OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK);
    ASSERT_NE(g_vdec, NULL);
    OH_AVCodec *vdec_2 = OH_VideoDecoder_CreateByMime(OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK);
    ASSERT_NE(vdec_2, NULL);
    OH_VideoDecoder_Destroy(vdec_2);
    vdec_2 = nullptr;
}
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_API_1000
 * @tc.name      : Test callback registration in OH_VideoDecoder
 * @tc.desc      : function test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_API_1000, TestSize.Level2)
{
    g_vdec = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_API_1001
 * @tc.name      : OH_VideoDecoder_RegisterSetCallback with null onError
 * @tc.desc      : function test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_API_1001, TestSize.Level2)
{
    g_vdec = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
    OH_AVCodecCallback cb_;
    cb_.onError = nullptr;
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_API_1002
 * @tc.name      : OH_VideoDecoder_RegisterSetCallback with null onNeedInputBuffer
 * @tc.desc      : function test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_API_1002, TestSize.Level2)
{
    g_vdec = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
    OH_AVCodecCallback cb_;
    cb_.onError = VdecAPI11Error;
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_API_1003
 * @tc.name      : OH_VideoDecoder_RegisterSetCallback with null onNewOutputBuffer
 * @tc.desc      : function test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_API_1003, TestSize.Level2)
{
    g_vdec = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
    OH_AVCodecCallback cb_;
    cb_.onError = VdecAPI11Error;
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_API_1004
 * @tc.name      : OH_VideoDecoder_RegisterSetCallback with null onStreamChanged
 * @tc.desc      : function test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_API_1004, TestSize.Level2)
{
    g_vdec = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
    OH_AVCodecCallback cb_;
    cb_.onError = VdecAPI11Error;
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_API_1005
 * @tc.name      : OH_VideoDecoder_RegisterSetCallback with null capability
 * @tc.desc      : function test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_API_1005, TestSize.Level2)
{
    OH_AVCodecCallback cb_;
    cb_.onError = VdecAPI11Error;
    cb_.onStreamChanged = VdecAPI11FormatChanged;
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_API_1100
 * @tc.name      : Test output description retrieval in OH_VideoDecoder
 * @tc.desc      : function test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_API_1100, TestSize.Level2)
{
    g_vdec = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
    OH_AVFormat *g_format = OH_VideoDecoder_GetOutputDescription(g_vdec);
    ASSERT_NE(NULL, g_format);
    g_format = OH_VideoDecoder_GetOutputDescription(g_vdec);
    ASSERT_NE(NULL, g_format);
}

/**
 * @tc.number    : VIDEO_CINEPAKDEC_API_1200
 * @tc.name      : Test parameter setting in OH_VideoDecoder
 * @tc.desc      : function test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_API_1200, TestSize.Level2)
{
    g_vdec = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
    ASSERT_NE(NULL, g_vdec);
    ...
    ASSERT_EQ(AV_ERR_INVALID_STATE, OH_VideoDecoder_SetParameter(g_vdec, g_format));
    ASSERT_EQ(AV_ERR_INVALID_STATE, OH_VideoDecoder_SetParameter(g_vdec, g_format));
    OH_AVFormat_Destroy(g_format);
    g_format = nullptr;
}
...
/**
 * @tc.number    :  VIDEO_CINEPAKDEC_CAP_API_0001
 * @tc.name      : OH_AVCodec_GetCapability with cinepak mime
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest,  VIDEO_CINEPAKDEC_CAP_API_0001, TestSize.Level2)
{
    g_cap = OH_AVCodec_GetCapability(OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false);
    ASSERT_NE(g_cap, nullptr);
}

/**
 * @tc.number    :  VIDEO_CINEPAKDEC_CAP_API_0002
 * @tc.name      : OH_AVCapability_GetName with cinepak mime
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest,  VIDEO_CINEPAKDEC_CAP_API_0002, TestSize.Level2)
{
    g_cap = OH_AVCodec_GetCapability(OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false);
...
/**
 * @tc.number    :  VIDEO_CINEPAKDEC_CAP_API_0003
 * @tc.name      : OH_AVCodec_GetCapability with null mime
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest,  VIDEO_CINEPAKDEC_CAP_API_0003, TestSize.Level2)
{
...
/**
 * @tc.number    :  VIDEO_CINEPAKDEC_CAP_API_0004
 * @tc.name      : OH_AVCodec_GetCapabilityByCategory with null mime
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest,  VIDEO_CINEPAKDEC_CAP_API_0004, TestSize.Level2)
{
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_0100
 * @tc.name      : Test capability retrieval for CINEPAK codec
 * @tc.desc      : function test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_0100, TestSize.Level1)
{
    g_cap = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
    ASSERT_NE(g_cap, nullptr);
    ASSERT_FALSE(OH_AVCapability_IsHardware(g_cap));
}

/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_0101
 * @tc.name      : Test capability retrieval for null capability
 * @tc.desc      : function test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_0101, TestSize.Level1)
{
    ASSERT_FALSE(OH_AVCapability_IsHardware(nullptr));
}

/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_0200
 * @tc.name      : Test max supported instances retrieval for CINEPAK codec
 * @tc.desc      : function test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_0200, TestSize.Level1)
{
    g_cap = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
    ASSERT_NE(g_cap, nullptr);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_0201
 * @tc.name      : Test max supported instances retrieval for null capability
 * @tc.desc      : function test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_0201, TestSize.Level1)
{
    ASSERT_EQ(0, OH_AVCapability_GetMaxSupportedInstances(nullptr));
}

/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_0300
 * @tc.name      : Test name retrieval for CINEPAK codec
 * @tc.desc      : function test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_0300, TestSize.Level1)
{
    g_cap = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
    ASSERT_NE(g_cap, nullptr);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_0301
 * @tc.name      : Test name retrieval for null capability
 * @tc.desc      : function test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_0301, TestSize.Level1)
{
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_0400
 * @tc.name      : Test video width alignment retrieval with invalid parameter
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_0400, TestSize.Level1)
{
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_0401
 * @tc.name      : Test video width alignment retrieval with null capability
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_0401, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    int32_t alignment = 0;
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_0500
 * @tc.name      : Test video width alignment retrieval with valid parameter
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_0500, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_0600
 * @tc.name      : Test video height alignment retrieval with invalid parameter
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_0600, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_0601
 * @tc.name      : Test video height alignment retrieval with null capability
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_0601, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    int32_t alignment = 0;
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_0700
 * @tc.name      : Test video height alignment retrieval with valid parameter
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_0700, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_0800
 * @tc.name      : Test video width range retrieval for height with invalid parameter
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_0800, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_0900
 * @tc.name      : Test video width range retrieval for height with null range
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_0900, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_1000
 * @tc.name      : Test video width range retrieval for height with zero height
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_1000, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_1001
 * @tc.name      : Test video width range retrieval for height with -1 height
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_1001, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_1002
 * @tc.name      : Test video width range retrieval for height with 9999 height
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_1002, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_1003
 * @tc.name      : Test video width range retrieval for height with 4 height
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_1003, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_1100
 * @tc.name      : Test video width range retrieval for height with valid parameters
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_1100, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_1200
 * @tc.name      : Test video height range retrieval for width with invalid parameter
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_1200, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_1300
 * @tc.name      : Test video height range retrieval for width with null range
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_1300, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_1400
 * @tc.name      : Test video height range retrieval for width with zero width
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_1400, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_1401
 * @tc.name      : Test video height range retrieval for width with -1 width
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_1401, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_1402
 * @tc.name      : Test video height range retrieval for width with 9999 width
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_1402, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_1500
 * @tc.name      : Test video height range retrieval for width with valid parameters
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_1500, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_1600
 * @tc.name      : Test video width range retrieval with null range
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_1600, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_1601
 * @tc.name      : Test video width range retrieval with null capability
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_1601, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
    OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_1700
 * @tc.name      : Test video width range retrieval with valid parameters
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_1700, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_1701
 * @tc.name      : OH_AVCapability_GetVideoWidthRange param correct
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_1701, TestSize.Level2)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_1800
 * @tc.name      : Test video height range retrieval with null range
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_1800, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_1801
 * @tc.name      : Test video height range retrieval with null capability
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_1801, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_1802
 * @tc.name      : OH_AVCapability_GetVideoHeightRange param correct
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_1802, TestSize.Level2)
{
    OH_AVErrCode ret = AV_ERR_OK;
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_1900
 * @tc.name      : Test video height range retrieval with valid parameters
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_1900, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange widthRange;
    OH_AVRange heightRange;
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_2000
 * @tc.name      : Test video size support check with zero width
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_2000, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_2100
 * @tc.name      : Test video size support check with zero height
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_2100, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_2101
 * @tc.name      : Test video size support check with null capability
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_2101, TestSize.Level1)
{
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_2200
 * @tc.name      : Test video size support check with dimensions exceeding maximum range
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_2200, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_2201
 * @tc.name      : Test video size support check with dimensions near minimum range
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_2201, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_2300
 * @tc.name      : Test video size support check with valid dimensions
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_2300, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_2400
 * @tc.name      : Test video frame rate range retrieval with null range
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_2400, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_2401
 * @tc.name      : Test video frame rate range retrieval with null capability
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_2401, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_2500
 * @tc.name      : Test video frame rate range retrieval with valid parameters
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_2500, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_2600
 * @tc.name      : Test video frame rate range retrieval for size with null range
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_2600, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_2601
 * @tc.name      : Test video frame rate range retrieval for size with null capability
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_2601, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_2700
 * @tc.name      : Test video frame rate range retrieval for size with zero width
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_2700, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_2800
 * @tc.name      : Test video frame rate range retrieval for size with zero height
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_2800, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_2801
 * @tc.name      : Test video frame rate range retrieval for size with -1
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_2801, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_2802
 * @tc.name      : Test video frame rate range retrieval for size with 0
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_2802, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_2803
 * @tc.name      : Test video frame rate range retrieval for size with 9999
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_2803, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_2900
 * @tc.name      : Test video frame rate range retrieval for size with valid parameters
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_2900, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    int32_t width = 1280;
    int32_t height = 720;
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_3000
 * @tc.name      : Test video size and frame rate support check with zero width
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_3000, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_3100
 * @tc.name      : Test video size and frame rate support check with zero height
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_3100, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_3200
 * @tc.name      : Test video size and frame rate support check with zero frame rate
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_3200, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_3300
 * @tc.name      : Test video size and frame rate support check with valid parameters
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_3300, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_3400
 * @tc.name      : Test supported pixel formats retrieval with null formats
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_3400, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_3500
 * @tc.name      : Test supported pixel formats retrieval with null count
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_3500, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_3501
 * @tc.name      : Test supported pixel formats retrieval with null capability
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_3501, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    const int32_t *pixelFormat = nullptr;
    uint32_t pixelFormatNum = 0;
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_3502
 * @tc.name      : OH_AVCapability_GetVideoSupportedPixelFormats param correct
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_3502, TestSize.Level2)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
    g_ret = OH_AVCapability_GetVideoSupportedPixelFormats(capability, &pixelFormat_1, &g_pixelFormatNum);
    ...
    for (int i = 0; i < g_pixelFormatNum; i++) {
        ...
        (void)OH_AVFormat_SetIntValue(g_format, OH_MD_KEY_PIXEL_FORMAT, pixelFormat_1[i]);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_3600
 * @tc.name      : Test supported profiles retrieval with valid parameters
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_3600, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_3601
 * @tc.name      : Test supported profiles retrieval with null capability
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_3601, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    const int32_t *profiles = nullptr;
    uint32_t profileNum = 0;
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_3602
 * @tc.name      : Test supported profiles retrieval with null profiles
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_3602, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    uint32_t profileNum = 0;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_3603
 * @tc.name      : Test supported profiles retrieval with null profileNum
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_3603, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    const int32_t *profiles = nullptr;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_3700
 * @tc.name      : Test feature support check with unsupported feature
 * @tc.desc      : api test
 */

HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_3700, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_3800
 * @tc.name      : Test feature properties retrieval with unsupported feature
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_3800, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
    OH_AVFormat *g_format = OH_AVCapability_GetFeatureProperties(capability, VIDEO_LOW_LATENCY);
    ASSERT_EQ(nullptr, g_format);
    OH_AVFormat_Destroy(g_format);
}

/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_3900
 * @tc.name      : Test levels retrieval with unsupported profile
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_3900, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
...
/**
 * @tc.number    : VIDEO_CINEPAKDEC_CAP_API_4000
 * @tc.name      : OH_AVCapability_AreProfileAndLevelSupported param error
 * @tc.desc      : api test
 */
HWTEST_F(CinepakdecApiNdkTest, VIDEO_CINEPAKDEC_CAP_API_4000, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_CINEPAK, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
