...
namespace OHOS {
namespace Media {
class Wvc1DecReliNdkTest : public testing::Test {
public:
...
void Wvc1DecReliNdkTest::SetUpTestCase()
{
    OH_AVCapability *cap = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    g_codecNameWvc1 = OH_AVCapability_GetName(cap);
    cout << "g_codecNameWvc1: " << g_codecNameWvc1 << endl;
}

void Wvc1DecReliNdkTest::TearDownTestCase() {}
void Wvc1DecReliNdkTest::SetUp() {}
void Wvc1DecReliNdkTest::TearDown() {}

namespace {
/**
 * @tc.number    : VIDEO_WVC1DEC_STABILITY_0010
 * @tc.name      : VC1 soft decode successively 16 times
 * @tc.desc      : reli test
 */
HWTEST_F(Wvc1DecReliNdkTest, VIDEO_WVC1DEC_STABILITY_0010, TestSize.Level3)
{
    for (int i = 0; i < g_reliCount; i++)
    {
        ...
        ASSERT_EQ(AV_ERR_OK, vDecSample->CreateVideoDecoder(g_codecNameWvc1.c_str()));
...
/**
 * @tc.number    : VIDEO_WVC1DEC_STABILITY_0020
 * @tc.name      : VC1 soft decode 16 times surface mode, change videoSize to 1920x1080
 * @tc.desc      : reli test
 */
HWTEST_F(Wvc1DecReliNdkTest, VIDEO_WVC1DEC_STABILITY_0020, TestSize.Level3)
{
    for (int i = 0; i < g_reliCount; i++) {
        shared_ptr<VDecAPI11Sample> vDecSample = make_shared<VDecAPI11Sample>();
        vDecSample->getFormat(FILE_PATH);
        ...
        ASSERT_EQ(AV_ERR_OK, vDecSample->RunVideoDec_Surface(g_codecNameWvc1.c_str()));
        vDecSample->WaitForEOS();
    }
}

/**
 * @tc.number    : VIDEO_WVC1DEC_STABILITY_0030
 * @tc.name      : 16 instances VC1 soft decode with Surface mode
 * @tc.desc      : reli test
 */
HWTEST_F(Wvc1DecReliNdkTest, VIDEO_WVC1DEC_STABILITY_0030, TestSize.Level3)
{
    ...
    for (int i = 0; i < g_reliCount; i++)
    {
        ...
        vDecSample->sleepOnFPS = true;
        ASSERT_EQ(AV_ERR_OK, vDecSample->RunVideoDec_Surface(g_codecNameWvc1));
    }
...
/**
 * @tc.number    : VIDEO_WVC1DEC_STABILITY_0040
 * @tc.name      : 16 instances VC1 soft decode with buffer mode
 * @tc.desc      : reli test
 */
HWTEST_F(Wvc1DecReliNdkTest, VIDEO_WVC1DEC_STABILITY_0040, TestSize.Level3)
{
    vector<shared_ptr<VDecAPI11Sample>> decVec;
    for (int i = 0; i < g_reliCount; i++)
    {
        ...
        vDecSample->autoSwitchSurface = false;
        vDecSample->sleepOnFPS = true;
        ASSERT_EQ(AV_ERR_OK, vDecSample->RunVideoDec(g_codecNameWvc1.c_str()));
    }
    uint32_t errorCount = 0;
    for_each(decVec.begin(), decVec.end(), [&errorCount](auto sample)
             {
...
/**
 * @tc.number    : VIDEO_WVC1DEC_STABILITY_0050
 * @tc.name      : VC1 soft decode 16 times with fast Surface change
 * @tc.desc      : reli test
 */
HWTEST_F(Wvc1DecReliNdkTest, VIDEO_WVC1DEC_STABILITY_0050, TestSize.Level3)
{
    for (int i = 0; i < g_reliCount; i++)
    {
        shared_ptr<VDecAPI11Sample> vDecSample = make_shared<VDecAPI11Sample>();
...
/**
 * @tc.number    : VIDEO_WVC1DEC_STABILITY_0060
 * @tc.name      : Decode 16 VC1 streams simultaneously in Surface mode
 * @tc.desc      : reli test
 */
HWTEST_F(Wvc1DecReliNdkTest, VIDEO_WVC1DEC_STABILITY_0060, TestSize.Level3)
{
    vector<shared_ptr<VDecAPI11Sample>> decVec;
    for (int i = 0; i < g_reliCount; i++)
    {
...
/**
 * @tc.number    : VIDEO_WVC1DEC_STABILITY_0070
 * @tc.name      : Decode 16 VC1 streams simultaneously in buffer mode
 * @tc.desc      : reli test
 */
HWTEST_F(Wvc1DecReliNdkTest, VIDEO_WVC1DEC_STABILITY_0070, TestSize.Level3)
{
    vector<shared_ptr<VDecAPI11Sample>> decVec;
    for (int i = 0; i < g_reliCount; i++)
    {
        ...
        vDecSample->getFormat(FILE_PATH);
        vDecSample->sleepOnFPS = true;
        ASSERT_EQ(AV_ERR_OK, vDecSample->CreateVideoDecoder(g_codecNameWvc1));
        ASSERT_EQ(AV_ERR_OK, vDecSample->ConfigureVideoDecoder());
        ASSERT_EQ(AV_ERR_OK, vDecSample->SetVideoDecoderCallback());
        ASSERT_EQ(AV_ERR_OK, vDecSample->StartVideoDecoder());
    }
...
/**
 * @tc.number    : VIDEO_WVC1DEC_STABILITY_0080
 * @tc.name      : 16 instances VC1 soft decode with buffer mode × 5 loops
 * @tc.desc      : reli test
 */
HWTEST_F(Wvc1DecReliNdkTest, VIDEO_WVC1DEC_STABILITY_0080, TestSize.Level3)
{
    for (int j = 0; j < 5; j++)
    {
        vector<shared_ptr<VDecAPI11Sample>> decVec;
...
/**
 * @tc.number    : VIDEO_WVC1DEC_STABILITY_0090
 * @tc.name      : Decode VC1 streams simultaneously
 * @tc.desc      : reli test
 */
HWTEST_F(Wvc1DecReliNdkTest, VIDEO_WVC1DEC_STABILITY_0090, TestSize.Level3)
{
    for (int i = 0; i < g_reliCount; i++)
    {
        shared_ptr<VDecAPI11Sample> vDecSample = make_shared<VDecAPI11Sample>();
        vDecSample->getFormat(FILE_PATH);
        vDecSample->sleepOnFPS = true;
        ASSERT_EQ(AV_ERR_OK, vDecSample->RunVideoDec(g_codecNameWvc1));
        vDecSample->WaitForEOS();
        ASSERT_EQ(AV_ERR_OK, vDecSample->errCount);
        ...
        ASSERT_EQ(AV_ERR_OK, vDecSample1->RunVideoDec(g_codecNameWvc1));
...
/**
 * @tc.number    : VIDEO_WVC1DEC_STABILITY_0100
 * @tc.name      : Decode 10-bit and 8-bit VC1 streams simultaneously
 * @tc.desc      : reli test
 */
HWTEST_F(Wvc1DecReliNdkTest, VIDEO_WVC1DEC_STABILITY_0100, TestSize.Level3)
{
    for (int i = 0; i < g_reliCount; i++)
    {
        shared_ptr<VDecAPI11Sample> vDecSample = make_shared<VDecAPI11Sample>();
        ...
        ASSERT_EQ(AV_ERR_OK, vDecSample1->RunVideoDec_Surface(g_codecNameWvc1));
        vDecSample1->WaitForEOS();
        close(vDecSample1->g_fd);
        vDecSample1->g_fd = -1;
    }
...
/**
 * @tc.number    : VIDEO_WVC1DEC_STABILITY_0110
 * @tc.name      : Random width and height VC1 decode (1920x1080)
 * @tc.desc      : reli test
 */
HWTEST_F(Wvc1DecReliNdkTest, VIDEO_WVC1DEC_STABILITY_0110, TestSize.Level3)
{
    for (int i = 0; i < g_reliCount; i++)
    {
        shared_ptr<VDecAPI11Sample> vDecSample = make_shared<VDecAPI11Sample>();
...
/**
 * @tc.number    : VIDEO_WVC1DEC_STABILITY_0120
 * @tc.name      : Decode VC1 streams with surface and buffer mode successively
 * @tc.desc      : reli test
 */
HWTEST_F(Wvc1DecReliNdkTest, VIDEO_WVC1DEC_STABILITY_0120, TestSize.Level3)
{
    for (int i = 0; i < g_reliCount; i++)
    {
        shared_ptr<VDecAPI11Sample> vDecSample = make_shared<VDecAPI11Sample>();
        ...
        ASSERT_EQ(AV_ERR_OK, vDecSample2->RunVideoDec_Surface(g_codecNameWvc1));
...
/**
 * @tc.number    : VIDEO_WVC1DEC_STABILITY_0130
 * @tc.name      : Create and destroy VC1 decoder repeatedly
 * @tc.desc      : reliable test
 */
HWTEST_F(Wvc1DecReliNdkTest, VIDEO_WVC1DEC_STABILITY_0130, TestSize.Level3)
{
    shared_ptr<VDecAPI11Sample> vDecSample = make_shared<VDecAPI11Sample>();
    vDecSample->getFormat(FILE_PATH);
    for (int i = 0; i < 1000; i++) {
        OH_AVCodec *vdec_ = OH_VideoDecoder_CreateByName(g_codecNameWvc1.c_str());
