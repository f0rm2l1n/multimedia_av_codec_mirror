...
namespace OHOS {
namespace Media {
class Wvc1decApiNdkTest : public testing::Test {
public:
...
const string CODEC_NAME = "OH.Media.Codec.Decoder.Video.WVC1";
...
{
    if (profile == WVC1_PROFILE_ADVANCED) {
        return true;
    } else {
        return false;
    }
...
void Wvc1decApiNdkTest::SetUpTestCase()
{
    const char *file = "/data/test/media/test_vc1.avi";
    GetFormat(file);
}
void Wvc1decApiNdkTest::TearDownTestCase()
{
...
void Wvc1decApiNdkTest::SetUp()
{
    signal_ = new VDecAPI11Signal();
}
void Wvc1decApiNdkTest::TearDown()
{
    if (format != nullptr) {
...
namespace {
/**
 * @tc.number    : VIDEO_WVC1DEC_API_0100
 * @tc.name      : Repeat create OH_VideoDecoder_CreateByName
 * @tc.desc      : function test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_API_0100, TestSize.Level2)
{
...
/**
 * @tc.number    : VIDEO_WVC1DEC_API_0200
 * @tc.name      : Create configure configure
 * @tc.desc      : function test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_API_0200, TestSize.Level2)
{
    vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
...
/**
 * @tc.number    : VIDEO_WVC1DEC_API_0300
 * @tc.name      : Create configure start start
 * @tc.desc      : function test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_API_0300, TestSize.Level2)
{
    vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
    ASSERT_NE(NULL, vdec_);
...
/**
 * @tc.number    : VIDEO_WVC1DEC_API_0400
 * @tc.name      : Create configure start stop stop
 * @tc.desc      : function test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_API_0400, TestSize.Level2)
{
    vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
    ASSERT_NE(NULL, vdec_);
...
/**
 * @tc.number    : VIDEO_WVC1DEC_API_0500
 * @tc.name      : Create configure start stop reset reset
 * @tc.desc      : function test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_API_0500, TestSize.Level2)
{
    vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
    ASSERT_NE(NULL, vdec_);
...
/**
 * @tc.number    : VIDEO_WVC1DEC_API_0600
 * @tc.name      : Create configure start EOS EOS
 * @tc.desc      : function test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_API_0600, TestSize.Level2)
{
    vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
    ASSERT_NE(NULL, vdec_);
...
/**
 * @tc.number    : VIDEO_WVC1DEC_API_0700
 * @tc.name      : Create configure start flush flush
 * @tc.desc      : function test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_API_0700, TestSize.Level2)
{
    vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
    ASSERT_NE(NULL, vdec_);
...
/**
 * @tc.number    : VIDEO_WVC1DEC_API_0800
 * @tc.name      : Create configure start stop release release
 * @tc.desc      : function test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_API_0800, TestSize.Level2)
{
    vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
    ASSERT_NE(NULL, vdec_);
...
/**
 * @tc.number    : VIDEO_WVC1DEC_API_0900
 * @tc.name      : Create VideoDecoder
 * @tc.desc      : function test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_API_0900, TestSize.Level2)
{
    vdec_ = OH_VideoDecoder_CreateByMime(OH_AVCODEC_MIMETYPE_VIDEO_WVC1);
    ASSERT_NE(vdec_, NULL);
    OH_AVCodec *vdec_2 = OH_VideoDecoder_CreateByMime(OH_AVCODEC_MIMETYPE_VIDEO_WVC1);
    ASSERT_NE(vdec_2, NULL);
    OH_VideoDecoder_Destroy(vdec_2);
    vdec_2 = nullptr;
}
...
/**
 * @tc.number    : VIDEO_WVC1DEC_API_1000
 * @tc.name      : Repeat OH_VideoDecoder_RegisterSetCallback
 * @tc.desc      : function test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_API_1000, TestSize.Level2)
{
    vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
...
/**
 * @tc.number    : VIDEO_WVC1DEC_API_1001
 * @tc.name      : OH_VideoDecoder_RegisterSetCallback onError as null
 * @tc.desc      : function test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_API_1001, TestSize.Level2)
{
    vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
    OH_AVCodecCallback cb_;
    cb_.onError = nullptr;
...
/**
 * @tc.number    : VIDEO_WVC1DEC_API_1002
 * @tc.name      : OH_VideoDecoder_RegisterSetCallback onNeedInputBuffer as null
 * @tc.desc      : function test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_API_1002, TestSize.Level2)
{
    vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
    OH_AVCodecCallback cb_;
    cb_.onError = VdecAPI11Error;
...
/**
 * @tc.number    : VIDEO_WVC1DEC_API_1003
 * @tc.name      : OH_VideoDecoder_RegisterSetCallback onNewOutputBuffer as null
 * @tc.desc      : function test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_API_1003, TestSize.Level2)
{
    vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
    OH_AVCodecCallback cb_;
    cb_.onError = VdecAPI11Error;
...
/**
 * @tc.number    : VIDEO_WVC1DEC_API_1004
 * @tc.name      : OH_VideoDecoder_RegisterSetCallback onStreamChanged as null
 * @tc.desc      : function test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_API_1004, TestSize.Level2)
{
    vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
    OH_AVCodecCallback cb_;
    cb_.onError = VdecAPI11Error;
...
/**
 * @tc.number    : VIDEO_WVC1DEC_API_1005
 * @tc.name      : OH_VideoDecoder_RegisterSetCallback with null capability
 * @tc.desc      : function test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_API_1005, TestSize.Level2)
{
    OH_AVCodecCallback cb_;
    cb_.onError = VdecAPI11Error;
    cb_.onStreamChanged = VdecAPI11FormatChanged;
...
/**
 * @tc.number    : VIDEO_WVC1DEC_API_1100
 * @tc.name      : Repeat OH_VideoDecoder_GetOutputDescription
 * @tc.desc      : function test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_API_1100, TestSize.Level2)
{
    vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
...
/**
 * @tc.number    : VIDEO_WVC1DEC_API_1200
 * @tc.name      : Repeat OH_VideoDecoder_SetParameter
 * @tc.desc      : function test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_API_1200, TestSize.Level2)
{
    vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
    ASSERT_NE(NULL, vdec_);
 ...
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,   VIDEO_WVC1DEC_CAP_API_0001, TestSize.Level2)
{
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_0002
 * @tc.name      : OH_AVCapability_GetName vc1 decoder
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,   VIDEO_WVC1DEC_CAP_API_0002, TestSize.Level2)
{
    cap = OH_AVCodec_GetCapability(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false);
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_0003
 * @tc.name      : OH_AVCodec_GetCapability with null mime
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,   VIDEO_WVC1DEC_CAP_API_0003, TestSize.Level2)
{
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_0004
 * @tc.name      : OH_AVCodec_GetCapabilityByCategory with null mime
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,   VIDEO_WVC1DEC_CAP_API_0004, TestSize.Level2)
{
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_0100
 * @tc.name      : OH_AVCodec_GetCapability param correct
 * @tc.desc      : function test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_0100, TestSize.Level1)
{
    cap = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(cap, nullptr);
    ASSERT_FALSE(OH_AVCapability_IsHardware(cap));
}

/**
 * @tc.number    :  VIDEO_WVC1DEC_CAP_API_0101
 * @tc.name      : Test capability retrieval for null capability
 * @tc.desc      : function test
 */
HWTEST_F(Wvc1decApiNdkTest,  VIDEO_WVC1DEC_CAP_API_0101, TestSize.Level1)
{
    ASSERT_FALSE(OH_AVCapability_IsHardware(nullptr));
}

/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_0200
 * @tc.name      : OH_AVCapability_GetMaxSupportedInstances param correct
 * @tc.desc      : function test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_0200, TestSize.Level1)
{
    cap = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(cap, nullptr);
...
/**
 * @tc.number    :  VIDEO_WVC1DEC_CAP_API_0201
 * @tc.name      : Test max supported instances retrieval for null capability
 * @tc.desc      : function test
 */
HWTEST_F(Wvc1decApiNdkTest,  VIDEO_WVC1DEC_CAP_API_0201, TestSize.Level1)
{
    ASSERT_EQ(0, OH_AVCapability_GetMaxSupportedInstances(nullptr));
}

/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_0300
 * @tc.name      : OH_AVCapability_GetName param correct
 * @tc.desc      : function test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_0300, TestSize.Level1)
{
    cap = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(cap, nullptr);
...
/**
 * @tc.number    :  VIDEO_WVC1DEC_CAP_API_0301
 * @tc.name      : Test name retrieval for null capability
 * @tc.desc      : function test
 */
HWTEST_F(Wvc1decApiNdkTest,  VIDEO_WVC1DEC_CAP_API_0301, TestSize.Level1)
{
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_0400
 * @tc.name      : OH_AVCapability_GetVideoWidthAlignment param error
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_0400, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
...
/**
 * @tc.number    :  VIDEO_WVC1DEC_CAP_API_0401
 * @tc.name      : Test video width alignment retrieval with invalid parameter
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,  VIDEO_WVC1DEC_CAP_API_0401, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    int32_t alignment = 0;
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_0500
 * @tc.name      : OH_AVCapability_GetVideoWidthAlignment param correct
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_0500, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_0600
 * @tc.name      : OH_AVCapability_GetVideoHeightAlignment param error
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_0600, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    :  VIDEO_WVC1DEC_CAP_API_0601
 * @tc.name      : Test video height alignment retrieval with invalid parameter
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,  VIDEO_WVC1DEC_CAP_API_0601, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    int32_t alignment = 0;
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_0700
 * @tc.name      : OH_AVCapability_GetVideoHeightAlignment param correct
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_0700, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_0800
 * @tc.name      : OH_AVCapability_GetVideoWidthRangeForHeight with null capability
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_0800, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_0900
 * @tc.name      : OH_AVCapability_GetVideoWidthRangeForHeight with null range
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_0900, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_1000
 * @tc.name      : OH_AVCapability_GetVideoWidthRangeForHeight with invalid height 0
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_1000, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    :  VIDEO_WVC1DEC_CAP_API_1001
 * @tc.name      : Test video width range retrieval for height with -1 height
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,  VIDEO_WVC1DEC_CAP_API_1001, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    :  VIDEO_WVC1DEC_CAP_API_1002
 * @tc.name      : Test video width range retrieval for height with 9999 height
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,  VIDEO_WVC1DEC_CAP_API_1002, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_1003
 * @tc.name      : Test video width range retrieval for height with 1 height
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,  VIDEO_WVC1DEC_CAP_API_1003, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_1100
 * @tc.name      : OH_AVCapability_GetVideoWidthRangeForHeight param correct
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_1100, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_1200
 * @tc.name      : OH_AVCapability_GetVideoHeightRangeForWidth with null capability
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_1200, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_1300
 * @tc.name      : OH_AVCapability_GetVideoHeightRangeForWidth with null range
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_1300, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_1400
 * @tc.name      : OH_AVCapability_GetVideoHeightRangeForWidth with invalid width 0
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_1400, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    :  VIDEO_WVC1DEC_CAP_API_1401
 * @tc.name      : Test video height range retrieval for width with -1 width
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,  VIDEO_WVC1DEC_CAP_API_1401, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    :  VIDEO_WVC1DEC_CAP_API_1402
 * @tc.name      : Test video height range retrieval for width with 9999 width
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,  VIDEO_WVC1DEC_CAP_API_1402, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_1500
 * @tc.name      : OH_AVCapability_GetVideoHeightRangeForWidth param correct
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_1500, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_1600
 * @tc.name      : OH_AVCapability_GetVideoWidthRange param error
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_1600, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    :  VIDEO_WVC1DEC_CAP_API_1601
 * @tc.name      : Test video width range retrieval with null capability
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,  VIDEO_WVC1DEC_CAP_API_1601, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_1700
 * @tc.name      : OH_AVCapability_GetVideoWidthRange param correct
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_1700, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    :  VIDEO_WVC1DEC_CAP_API_1701
 * @tc.name      : OH_AVCapability_GetVideoWidthRange and test configure with out of range width
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,  VIDEO_WVC1DEC_CAP_API_1701, TestSize.Level2)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
         OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
    ret = OH_AVCapability_GetVideoWidthRange(capability, &range);
    ASSERT_EQ(AV_ERR_OK, ret);
    ASSERT_EQ(range.minVal, 2);
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_1800
 * @tc.name      : OH_AVCapability_GetVideoHeightRange param error
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_1800, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    :  VIDEO_WVC1DEC_CAP_API_1801
 * @tc.name      : Test video height range retrieval with null capability
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,  VIDEO_WVC1DEC_CAP_API_1801, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    :  VIDEO_WVC1DEC_CAP_API_1802
 * @tc.name      : OH_AVCapability_GetVideoHeightRange and test configure with out of range height
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,  VIDEO_WVC1DEC_CAP_API_1802, TestSize.Level2)
{
    OH_AVErrCode ret = AV_ERR_OK;
    ...
    ASSERT_EQ(heightRange.maxVal, 1080);
    vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
    ASSERT_NE(nullptr, vdec_);
    format = OH_AVFormat_Create();
    ASSERT_NE(nullptr, format);
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_1900
 * @tc.name      : GetVideoSizeRange and test configure with out of range width and height
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_1900, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange widthRange;
    OH_AVRange heightRange;
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_2000
 * @tc.name      : OH_AVCapability_IsVideoSizeSupported with 0 width
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_2000, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_2100
 * @tc.name      : OH_AVCapability_IsVideoSizeSupported with 0 height
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_2100, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    :  VIDEO_WVC1DEC_CAP_API_2101
 * @tc.name      : Test video size support check with null capability
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,  VIDEO_WVC1DEC_CAP_API_2101, TestSize.Level1)
{
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_2200
 * @tc.name      : OH_AVCapability_IsVideoSizeSupported with out-of-range dimensions
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_2200, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
    OH_AVRange heightRange;
...
/**
 * @tc.number    :  VIDEO_WVC1DEC_CAP_API_2201
 * @tc.name      : Test video size support check with out-of-range dimensions
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,  VIDEO_WVC1DEC_CAP_API_2201, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
    OH_AVRange heightRange;
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_2300
 * @tc.name      : OH_AVCapability_IsVideoSizeSupported with 1920x1080 dimensions
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_2300, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_2400
 * @tc.name      : OH_AVCapability_GetVideoFrameRateRange param error
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_2400, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    :  VIDEO_WVC1DEC_CAP_API_2401
 * @tc.name      : Test video frame rate range retrieval with null capability
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,  VIDEO_WVC1DEC_CAP_API_2401, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_2500
 * @tc.name      : OH_AVCapability_GetVideoFrameRateRange param correct
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_2500, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_2600
 * @tc.name      : OH_AVCapability_GetVideoFrameRateRangeForSize with null range
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_2600, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_2601
 * @tc.name      : Test video frame rate range retrieval for size with null capability
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,  VIDEO_WVC1DEC_CAP_API_2601, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_2700
 * @tc.name      : OH_AVCapability_GetVideoFrameRateRangeForSize with 0 width
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_2700, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_2800
 * @tc.name      : OH_AVCapability_GetVideoFrameRateRangeForSize with 0 height
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_2800, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    :  VIDEO_WVC1DEC_CAP_API_2801
 * @tc.name      : Test video frame rate range retrieval for size with -1
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,  VIDEO_WVC1DEC_CAP_API_2801, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    :  VIDEO_WVC1DEC_CAP_API_2802
 * @tc.name      : Test video frame rate range retrieval for size with 0
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,  VIDEO_WVC1DEC_CAP_API_2802, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    :  VIDEO_WVC1DEC_CAP_API_2803
 * @tc.name      : Test video frame rate range retrieval for size with 9999
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,  VIDEO_WVC1DEC_CAP_API_2803, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
    memset_s(&range, sizeof(OH_AVRange), 0, sizeof(OH_AVRange));
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_2900
 * @tc.name      : OH_AVCapability_GetVideoFrameRateRangeForSize param correct
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_2900, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    int32_t width = 1280;
    int32_t height = 720;
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_3000
 * @tc.name      : OH_AVCapability_AreVideoSizeAndFrameRateSupported with 0 width
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_3000, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_3100
 * @tc.name      : OH_AVCapability_AreVideoSizeAndFrameRateSupported with 0 height
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_3100, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_3200
 * @tc.name      : OH_AVCapability_AreVideoSizeAndFrameRateSupported with 0 frame rate
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_3200, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_3300
 * @tc.name      : OH_AVCapability_AreVideoSizeAndFrameRateSupported param correct
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_3300, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_3400
 * @tc.name      : OH_AVCapability_GetVideoSupportedPixelFormats with null pixelFormat
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_3400, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_3500
 * @tc.name      : OH_AVCapability_GetVideoSupportedPixelFormats with null pixelFormatNum
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_3500, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
...
/**
 * @tc.number    :  VIDEO_WVC1DEC_CAP_API_3501
 * @tc.name      : Test supported pixel formats retrieval with null capability
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,  VIDEO_WVC1DEC_CAP_API_3501, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    const int32_t *pixelFormat = nullptr;
    uint32_t pixelFormatNum = 0;
...
/**
 * @tc.number    :  VIDEO_WVC1DEC_CAP_API_3502
 * @tc.name      : OH_AVCapability_GetVideoSupportedPixelFormats and test configure with supported pixel formats
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,  VIDEO_WVC1DEC_CAP_API_3502, TestSize.Level2)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(
         OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_3600
 * @tc.name      : OH_AVCapability_GetVideoSupportedPixelFormats param correct
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_3600, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    const int32_t *pixelFormat = nullptr;
    uint32_t pixelFormatNum = 0;
...
/**
 * @tc.number    :  VIDEO_WVC1DEC_CAP_API_3601
 * @tc.name      : Test supported profiles retrieval with null capability
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,  VIDEO_WVC1DEC_CAP_API_3601, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
...
/**
 * @tc.number    :  VIDEO_WVC1DEC_CAP_API_3602
 * @tc.name      : Test supported profiles retrieval with null profiles
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,  VIDEO_WVC1DEC_CAP_API_3602, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    uint32_t profileNum = 0;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
...
/**
 * @tc.number    :  VIDEO_WVC1DEC_CAP_API_3603
 * @tc.name      : Test supported profiles retrieval with null profileNum
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest,  VIDEO_WVC1DEC_CAP_API_3603, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    const int32_t *profiles = nullptr;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_3700
 * @tc.name      : OH_AVCapability_GetSupportedProfiles param correct
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_3700, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    const int32_t *profiles = nullptr;
    uint32_t profileNum = 0;
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_3800
 * @tc.name      : OH_AVCapability_GetSupportedLevelsForProfile param correct
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_3800, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_3801
 * @tc.name      : OH_AVCapability_GetSupportedLevelsForProfile with null capability
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_3801, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    const int32_t *levels = nullptr;
    uint32_t levelNum = 0;
    ret = OH_AVCapability_GetSupportedLevelsForProfile(
        nullptr, WVC1_PROFILE_ADVANCED, &levels, &levelNum);
    ASSERT_EQ(AV_ERR_INVALID_VAL, ret);
}

/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_3802
 * @tc.name      : OH_AVCapability_GetSupportedLevelsForProfile with null levels
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_3802, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    uint32_t levelNum = 0;
    ret = OH_AVCapability_GetSupportedLevelsForProfile(
        nullptr, WVC1_PROFILE_ADVANCED, nullptr, &levelNum);
    ASSERT_EQ(AV_ERR_INVALID_VAL, ret);
}

/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_3803
 * @tc.name      : OH_AVCapability_GetSupportedLevelsForProfile with null levelNum
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_3803, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    const int32_t *levels = nullptr;
    ret = OH_AVCapability_GetSupportedLevelsForProfile(
        nullptr, WVC1_PROFILE_ADVANCED, &levels, nullptr);
    ASSERT_EQ(AV_ERR_INVALID_VAL, ret);
}

/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_3901
 * @tc.name      : Check supported profile and level combination
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_3901, TestSize.Level1)
{
    OH_AVErrCode ret = AV_ERR_OK;
    const int32_t *levels = nullptr;
    uint32_t levelNum = 0;
...
/**
 * @tc.number    :  VIDEO_WVC1DEC_CAP_API_4000
 * @tc.name      : OH_AVCapability_IsFeatureSupported param error
 * @tc.desc      : api test
 */

HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_4000, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    :  VIDEO_WVC1DEC_CAP_API_4100
 * @tc.name      : OH_AVCapability_GetFeatureProperties param error
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_4100, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
...
/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_4200
 * @tc.name      : Check supported profile and level combination (ADVANCED, L0)
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_4200, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
    ASSERT_EQ(true, OH_AVCapability_AreProfileAndLevelSupported(capability, WVC1_PROFILE_ADVANCED, WVC1_LEVEL_L0));
}

/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_4300
 * @tc.name      : Check supported profile and level combination (ADVANCED, L1)
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_4300, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
    ASSERT_EQ(true, OH_AVCapability_AreProfileAndLevelSupported(capability, WVC1_PROFILE_ADVANCED, WVC1_LEVEL_L1));
}

/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_4400
 * @tc.name      : Check supported profile and level combination (ADVANCED, L2)
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_4400, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
    ASSERT_EQ(true, OH_AVCapability_AreProfileAndLevelSupported(capability, WVC1_PROFILE_ADVANCED, WVC1_LEVEL_L2));
}

/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_4500
 * @tc.name      : Check supported profile and level combination (ADVANCED, L3)
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_4500, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
    ASSERT_EQ(true, OH_AVCapability_AreProfileAndLevelSupported(capability, WVC1_PROFILE_ADVANCED, WVC1_LEVEL_L3));
}

/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_4600
 * @tc.name      : Check supported profile and level combination (ADVANCED, L4)
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_4600, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
    ASSERT_EQ(true, OH_AVCapability_AreProfileAndLevelSupported(capability, WVC1_PROFILE_ADVANCED, WVC1_LEVEL_L4));
}

/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_4700
 * @tc.name      : Check unsupported profile and level combination (-1, L0)
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_4700, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
    ASSERT_EQ(false, OH_AVCapability_AreProfileAndLevelSupported(capability, -1, WVC1_LEVEL_L0));
}

/**
 * @tc.number    : VIDEO_WVC1DEC_CAP_API_4800
 * @tc.name      : Check unsupported profile and level combination (ADVANCED, -1)
 * @tc.desc      : api test
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_WVC1DEC_CAP_API_4800, TestSize.Level1)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_WVC1, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
    ASSERT_EQ(false, OH_AVCapability_AreProfileAndLevelSupported(capability, WVC1_PROFILE_ADVANCED, -1));
}
 ...
 */
HWTEST_F(Wvc1decApiNdkTest, VIDEO_CAPABILITY_CONIFG_1000, TestSize.Level2)
{
    string codecName = "";
    OH_AVErrCode  ret = AV_ERR_OK;
    OH_AVRange widthRange;
