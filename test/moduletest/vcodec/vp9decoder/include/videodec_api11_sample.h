...
public:
    ...
    const char *INP_DIR = "";
    const char *OUT_DIR = "/data/test/media/Vp9DecTest.yuv";
    const char *OUT_DIR2 = "/data/test/media/Vp9DecTest2.yuv";
    ...
    const char *fileSourcesha256_vp9[64] = {
        "1c", "9d", "c1", "8a", "2e", "18", "ac", "13", "02", "35", "a6", "9d", "63", "ee", "a4", "7f",
        "0f", "85", "3d", "06", "6f", "3f", "6a", "ea", "f7", "84", "68", "da", "f8", "3a", "60", "18",
        "d4", "fe", "d9", "9a", "26", "ca", "c0", "98", "80", "f9", "d1", "d7", "94", "45", "52", "f0",
        "c5", "8a", "80", "68", "4d", "be", "a9", "b0", "92", "58", "56", "ab", "de", "34", "1e", "e6"
    };
    int32_t Start();
    int32_t Stop();
    int32_t Flush();
