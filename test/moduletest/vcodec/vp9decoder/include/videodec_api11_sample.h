...
public:
    ...
    const char *fileSourcesha256_vp9[64] = {
        "16", "02", "b1", "40", "f6", "ef", "59", "e4", "26", "84", "1a", "c2", "04", "4b", "6b", "f3",
        "62", "57", "ad", "57", "68", "8a", "ef", "95", "85", "f4", "f5", "65", "02", "3e", "87", "41",
        "ee", "f0", "6a", "00", "d4", "cc", "81", "32", "94", "f6", "2e", "84", "c1", "4c", "ca", "5c",
        "d8", "5e", "18", "c3", "e9", "2b", "7a", "c9", "da", "27", "20", "5e", "52", "18", "ff", "80"
    };
    int32_t Start();
    int32_t Stop();
    int32_t Flush();
