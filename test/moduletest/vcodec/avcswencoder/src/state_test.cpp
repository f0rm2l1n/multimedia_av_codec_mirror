...
namespace OHOS {
namespace Media {
class AvcSwEncStateNdkTest : public testing::Test {
public:
...
void AvcSwEncStateNdkTest::SetUpTestCase(void) {}

void AvcSwEncStateNdkTest::TearDownTestCase(void) {}

VEncNdkSample *vEncSample = NULL;

void AvcSwEncStateNdkTest::SetUp(void)
{
...
void AvcSwEncStateNdkTest::TearDown(void)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_0100, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_0200, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_0300, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_0400, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_0500, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_0600, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_0700, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_0800, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_0900, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_1000, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_1100, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_1200, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_1300, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_1400, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_1500, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_1600, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_1700, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_1800, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_1900, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_2000, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_2100, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_2200, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_2300, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_2400, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_2500, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_2600, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_2700, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_2800, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_2900, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_3000, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_3100, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_3200, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_3300, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_3400, TestSize.Level2)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_3500, TestSize.Level1)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_3600, TestSize.Level1)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_3700, TestSize.Level1)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_3800, TestSize.Level1)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_3900, TestSize.Level1)
{
    if (vEncSample == NULL) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncStateNdkTest, VIDEO_ENCODE_STATE_4000, TestSize.Level1)
{
if (vEncSample == NULL) {
    return;
    }
