...
namespace OHOS {
namespace Media {
class AvcSwEncApiNdkTest : public testing::Test {
public:
...
void AvcSwEncApiNdkTest::SetUpTestCase()
{
...
void AvcSwEncApiNdkTest::TearDownTestCase() {}
void AvcSwEncApiNdkTest::SetUp()
{
    signal_ = new VEncSignal();
}
void AvcSwEncApiNdkTest::TearDown()
{
    if (format != nullptr) {
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_ILLEGAL_PARA_0100, TestSize.Level2)
{
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_ILLEGAL_PARA_0200, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.name      : OH_VideoEncoder_CreateByName para error
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_ILLEGAL_PARA_0300, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_ILLEGAL_PARA_0400, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.name      : OH_VideoEncoder_Destroy para error
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_ILLEGAL_PARA_0500, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_ILLEGAL_PARA_0600, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_ILLEGAL_PARA_0700, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_ILLEGAL_PARA_0800, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_ILLEGAL_PARA_0900, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
...
/**
 * @tc.number    : VIDEO_ENCODE_ILLEGAL_PARA_1000
 * @tc.name      : OH_VideoEncoder_Configure para not enough
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_ILLEGAL_PARA_1000, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_ILLEGAL_PARA_1100, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
...
/**
 * @tc.number    : VIDEO_ENCODE_ILLEGAL_PARA_1200
 * @tc.name      : OH_VideoEncoder_Stop para error
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_ILLEGAL_PARA_1200, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
...
/**
 * @tc.number    : VIDEO_ENCODE_ILLEGAL_PARA_1300
 * @tc.name      : OH_VideoEncoder_Flush para error
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_ILLEGAL_PARA_1300, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_ILLEGAL_PARA_1400, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_ILLEGAL_PARA_1500, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_ILLEGAL_PARA_1600, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_ILLEGAL_PARA_1700, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_ILLEGAL_PARA_1800, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_ILLEGAL_PARA_1900, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_ILLEGAL_PARA_2000, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_ILLEGAL_PARA_2100, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_ILLEGAL_PARA_2200, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_ILLEGAL_PARA_2300, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_ILLEGAL_PARA_2400, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_ILLEGAL_PARA_2500, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_ILLEGAL_PARA_2600, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_API_0100, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_API_0200, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_API_0300, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_API_0400, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
    ...
    (void)OH_AVFormat_SetIntValue(format, OH_MD_KEY_WIDTH, DEFAULT_WIDTH);
    (void)OH_AVFormat_SetIntValue(format, OH_MD_KEY_HEIGHT, DEFAULT_HEIGHT);
    (void)OH_AVFormat_SetIntValue(format, OH_MD_KEY_BITRATE, DEFAULT_BITRATE);
    (void)OH_AVFormat_SetIntValue(format, OH_MD_KEY_PIXEL_FORMAT, AV_PIXEL_FORMAT_NV12);
    ASSERT_EQ(AV_ERR_OK, OH_VideoEncoder_Configure(venc_, format));
    ASSERT_EQ(AV_ERR_OK, OH_VideoEncoder_Start(venc_));
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_API_0500, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_API_0600, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_API_0700, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_API_0800, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_API_0900, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_API_1000, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_API_1100, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_API_1200, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_API_1300, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_API_1400, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
...
/**
 * @tc.number    : VIDEO_ENCODE_API_1500
 * @tc.name      : set quality with illegal value
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_API_1500, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
...
/**
 * @tc.number    : VIDEO_ENCODE_API_1600
 * @tc.name      : set quality with illegal value
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncApiNdkTest, VIDEO_ENCODE_API_1600, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
