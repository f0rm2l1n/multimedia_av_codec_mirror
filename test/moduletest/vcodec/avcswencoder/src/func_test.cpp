...
constexpr uint32_t MAX_PROFILE_NUM = 2;
...
namespace OHOS {
namespace Media {
class AvcSwEncFuncNdkTest : public testing::Test {
public:
...
void AvcSwEncFuncNdkTest::SetUpTestCase()
{
...
void AvcSwEncFuncNdkTest::TearDownTestCase() {}
void AvcSwEncFuncNdkTest::SetUp() {}
void AvcSwEncFuncNdkTest::TearDown()
{
    if (venc_ != NULL) {
 ...
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_FUNCTION_0100, TestSize.Level1)
{
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_FUNCTION_0200, TestSize.Level1)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_FUNCTION_0300, TestSize.Level1)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_FUNCTION_0400, TestSize.Level1)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_FUNCTION_0500, TestSize.Level1)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_FUNCTION_0600, TestSize.Level1)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_FUNCTION_0700, TestSize.Level1)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.name      : set key frame interval avc
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_FUNCTION_0800, TestSize.Level1)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_FUNCTION_0900, TestSize.Level1)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_FUNCTION_1000, TestSize.Level1)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_FUNCTION_1100, TestSize.Level1)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
...
/**
 * @tc.number    : VIDEO_ENCODE_FUNCTION_1200
 * @tc.name      : set framerate
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_FUNCTION_1200, TestSize.Level1)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
...
/**
 * @tc.number    : VIDEO_ENCODE_FUNCTION_1300
 * @tc.name      : set quality
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_FUNCTION_1300, TestSize.Level1)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : function test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_FUNCTION_1400, TestSize.Level1)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_0100, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_0200, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_0300, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_0400, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_0500, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
    ASSERT_EQ(nullptr, OH_AVCodec_GetCapabilityByCategory("", true, SOFTWARE));
}
/**
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_0600, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
    ASSERT_EQ(nullptr, OH_AVCodec_GetCapabilityByCategory(nullptr, true, SOFTWARE));
}
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_0700, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
    ASSERT_EQ(nullptr, OH_AVCodec_GetCapabilityByCategory("notexist", true, SOFTWARE));
}
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_0800, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
    ASSERT_NE(nullptr, OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_AVC, true, SOFTWARE));
}
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_0900, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_1000, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
    ...
    ASSERT_EQ(false, OH_AVCapability_IsHardware(capability));
}
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_1100, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_1200, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_1300, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_1400, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_1500, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
...
/**
 * @tc.number    : VIDEO_ENCODE_CAPABILITY_1600
 * @tc.name      : OH_AVCapability_GetEncoderBitrateRange param error
 * @tc.desc      : api test
 */

HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_1600, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_1700, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_1800, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_1900, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_2000, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_2100, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
    OH_AVCapability *capa = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_AVC, true, SOFTWARE);
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_2200, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_2300, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_2400, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_2500, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
...
/**
 * @tc.number    : VIDEO_ENCODE_CAPABILITY_2600
 * @tc.name      : OH_AVCapability_GetEncoderQualityRange param correct
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_2600, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_2700, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_2800, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
...
/**
 * @tc.number    : VIDEO_ENCODE_CAPABILITY_2900
 * @tc.name      : OH_AVCapability_GetEncoderComplexityRange param error
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_2900, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_3000, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_3100, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_3200, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_3300, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_3400, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_3500, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_3600, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_3700, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_3800, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_3900, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_4000, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_4100, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_4200, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_4300, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_4400, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_4500, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_4600, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_4700, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_4800, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_4900, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_5000, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_5100, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_5200, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_5300, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_5400, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_5500, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_5600, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_5700, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_5800, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_5900, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_6000, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_6100, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_6200, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_6300, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_6400, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_6500, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_6600, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_6700, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_6800, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_6900, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_7000, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_7100, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_7200, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_7300, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_7400, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_7500, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_7600, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_7700, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_7800, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_7900, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_8000, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_8100, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_8200, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_8300, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
 ...
 * @tc.desc      : api test
 */
HWTEST_F(AvcSwEncFuncNdkTest, VIDEO_ENCODE_CAPABILITY_8400, TestSize.Level2)
{
    if (strlen(g_codecName) == 0) {
        return;
    }
    int64_t max = 1000000001;
    venc_ = OH_VideoEncoder_CreateByName(g_codecName);
    ASSERT_NE(nullptr, venc_);
    format = OH_AVFormat_Create();
    ASSERT_NE(nullptr, format);
