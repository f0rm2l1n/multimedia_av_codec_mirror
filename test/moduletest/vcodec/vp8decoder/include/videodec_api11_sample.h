...
public:
    ...
    const char *fileSourcesha256_vp8[64] = {
        "a4", "45", "ea", "5d", "a6", "a1", "de", "f0", "4e", "80", "ac", "d4", "13", "a3", "5f", "84",
        "4d", "aa", "30", "8a", "e8", "f2", "ef", "e2", "dc", "69", "b4", "c2", "6a", "92", "18", "ce",
        "8d", "5a", "4a", "69", "1e", "d8", "c7", "ca", "ee", "0a", "0b", "c5", "2a", "e4", "b5", "9c",
        "7c", "32", "51", "92", "63", "25", "e9", "d8", "d8", "55", "fb", "21", "01", "4d", "81", "cc"
    };
    int32_t Start();
    int32_t Stop();
    int32_t Flush();
