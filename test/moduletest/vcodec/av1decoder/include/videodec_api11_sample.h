...
public:
    ...
    const char *fileSourcesha256_nv12[64] = {
        "f9", "a1", "ef", "2d", "86", "5d", "bb", "e6", "b6", "db", "e3", "6e", "ac", "f1", "93", "60",
        "5f", "82", "a9", "c7", "f2", "2e", "0f", "82", "c2", "1a", "a7", "f7", "17", "0c", "32", "3b",
        "29", "32", "96", "d6", "16", "74", "59", "dc", "83", "65", "fe", "61", "ae", "f9", "26", "7f",
        "7a", "74", "2b", "68", "8c", "b0", "3a", "4e", "6c", "66", "4e", "27", "08", "db", "e3", "56"
    };
    const char *fileSourcesha256_nv21[64] = {
        "a1", "a2", "60", "a9", "5f", "d3", "26", "46", "dd", "f5", "7f", "98", "7d", "dc", "0e", "db",
        "34", "8f", "04", "f0", "4b", "65", "44", "85", "2e", "56", "bd", "57", "6c", "6e", "6d", "1b",
        "d4", "47", "f1", "76", "39", "cb", "ae", "d9", "f9", "67", "51", "02", "69", "47", "9b", "49",
        "e7", "e9", "9e", "cf", "71", "bf", "56", "6c", "80", "71", "4f", "68", "ef", "58", "87", "2b"
    };
    int32_t Start();
    int32_t Stop();
    int32_t Flush();
