...
const string g_invalidCodecName = "avdec_h264";
const char *g_codecMime = "video/avc";
const string g_codecName = "OH.Media.Codec.Decoder.Video.AVC";
VDecSignal *signal_;
...
{
    vdec_ = OH_VideoDecoder_CreateByName(g_invalidCodecName.c_str());
    ASSERT_EQ(NULL, vdec_);
}
...
{
    vdec_ = OH_VideoDecoder_CreateByMime(g_invalidCodecName.c_str());
    ASSERT_EQ(NULL, vdec_);
}
...
{
    vdec_ = OH_VideoDecoder_CreateByMime(g_codecMime);
    ASSERT_NE(vdec_, NULL);
    vdec_ = OH_VideoDecoder_CreateByMime(g_codecMime);
    ASSERT_NE(vdec_, NULL);
}
...
{
    cap = OH_AVCodec_GetCapability(g_codecMime, false);
...
{
    cap = OH_AVCodec_GetCapabilityByCategory(g_codecMime, false, SOFTWARE);
    ASSERT_NE(cap, nullptr);
}
...
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(g_codecMime, false, SOFTWARE);
 ...
 * @tc.desc      : api test
 */
HWTEST_F(SwdecApiNdkTest, VIDEO_SWDEC_CAP_API_7500, TestSize.Level2)
{
    OH_AVErrCode ret = AV_ERR_OK;
    const int32_t *profiles = nullptr;
    uint32_t profileNum = 0;
 ...
 * @tc.desc      : api test
 */
HWTEST_F(SwdecApiNdkTest, VIDEO_SWDEC_CAP_API_7600, TestSize.Level2)
{
    OH_AVErrCode ret = AV_ERR_OK;
 ...
 * @tc.desc      : api test
 */
HWTEST_F(SwdecApiNdkTest, VIDEO_SWDEC_CAP_API_7700, TestSize.Level2)
{
    OH_AVErrCode ret = AV_ERR_OK;
    const int32_t *levels = nullptr;
    uint32_t levelNum = 0;
 ...
 * @tc.desc      : api test
 */
HWTEST_F(SwdecApiNdkTest, VIDEO_SWDEC_CAP_API_7800, TestSize.Level2)
{
    OH_AVErrCode ret = AV_ERR_OK;
    uint32_t levelNum = 0;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(g_codecMime, false, SOFTWARE);
 ...
 * @tc.desc      : api test
 */
HWTEST_F(SwdecApiNdkTest, VIDEO_SWDEC_CAP_API_7900, TestSize.Level2)
{
    OH_AVErrCode ret = AV_ERR_OK;
    const int32_t *levels = nullptr;
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(g_codecMime, false, SOFTWARE);
 ...
 * @tc.desc      : api test
 */
HWTEST_F(SwdecApiNdkTest, VIDEO_SWDEC_CAP_API_8000, TestSize.Level2)
{
    OH_AVErrCode ret = AV_ERR_OK;
    const int32_t *levels = nullptr;
    uint32_t levelNum = 0;
 ...
 * @tc.desc      : api test
 */
HWTEST_F(SwdecApiNdkTest, VIDEO_SWDEC_CAP_API_8100, TestSize.Level2)
{
 ...
 * @tc.desc      : api test
 */
HWTEST_F(SwdecApiNdkTest, VIDEO_SWDEC_CAP_API_8200, TestSize.Level2)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(g_codecMime, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
 ...
 * @tc.desc      : api test
 */
HWTEST_F(SwdecApiNdkTest, VIDEO_SWDEC_CAP_API_8300, TestSize.Level2)
{
    OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(g_codecMime, false, SOFTWARE);
    ASSERT_NE(nullptr, capability);
