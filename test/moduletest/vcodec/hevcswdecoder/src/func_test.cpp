...
protected:
    const char *g_inpDir1080 = "/data/test/media/1920_1080_30.h265";
    const char *g_inpDir144 = "/data/test/media/176_144_Main10.h265";
    const char *g_inpDir64 = "/data/test/media/64_64_Main.h265";
    const char *g_inpDir1158 = "/data/test/media/1544_1158_Rext_gray.h265";
    const char *g_inpDir1440 = "/data/test/media/1920_1440_Main_HEIF.h265";
    const char *g_inpDir1022 = "/data/test/media/1858_1022_Main.h265";
    const char *g_inpDir71 = "/data/test/media/95_71_Rext_gray.h265";
    const char *g_inpDirVar = "/data/test/media/95_71_Rext_gray.h265";
    const char *g_inpDir1080Var = "/data/test/media/1920_1080_64_64_var.h265";
    const char *g_inpDirNal1280 = "/data/test/media/1280_720_Main_30_93_443271.h265";
};
} // namespace Media
} // namespace OHOS
...
HWTEST_F(HevcSwdecFuncNdkTest, VIDEO_SWDEC_FUNCTION_0320, TestSize.Level0)
{
    if (!access("/system/lib64/media/", 0)) {
        ...
        vDecSample->INP_DIR = g_inpDir1080;
...
HWTEST_F(HevcSwdecFuncNdkTest, VIDEO_SWDEC_FUNCTION_1300, TestSize.Level2)
{
    if (!access("/system/lib64/media/", 0)) {
        shared_ptr<VDecNdkSample> vDecSample = make_shared<VDecNdkSample>();
        vDecSample->INP_DIR = g_inpDir1080Var;
        vDecSample->DEFAULT_WIDTH = 1920;
        vDecSample->DEFAULT_HEIGHT = 1080;
        vDecSample->DEFAULT_FRAME_RATE = 30;
        vDecSample->SF_OUTPUT = false;
...
HWTEST_F(HevcSwdecFuncNdkTest, API11_VIDEO_SWDEC_FUNCTION_1300, TestSize.Level2)
{
    if (!access("/system/lib64/media/", 0)) {
        shared_ptr<VDecAPI11Sample> vDecSample = make_shared<VDecAPI11Sample>();
        vDecSample->INP_DIR = g_inpDirVar;
        vDecSample->DEFAULT_WIDTH = 1920;
        vDecSample->DEFAULT_HEIGHT = 1080;
        vDecSample->DEFAULT_FRAME_RATE = 30;
        vDecSample->SF_OUTPUT = false;
...
HWTEST_F(HevcSwdecFuncNdkTest, API11_SURF_CHANGE_FUNC_016, TestSize.Level0)
{
    if (!access("/system/lib64/media/", 0)) {
        ...
        vDecSample_1->INP_DIR = g_inpDir1080;
...
HWTEST_F(HevcSwdecFuncNdkTest, API11_VIDEO_SWDEC_STAB_FUNC_0100, TestSize.Level0)
{
    if (!access("/system/lib64/media/", 0)) {
        for (int i = 0; i < g_reliCount2; i++) {
            shared_ptr<VDecAPI11Sample> vDecSample = make_shared<VDecAPI11Sample>();
            vDecSample->INP_DIR = g_inpDir144;
            vDecSample->SF_OUTPUT = false;
            ...
            vDecSample1->INP_DIR = g_inpDir1080;
...
HWTEST_F(HevcSwdecFuncNdkTest, VIDEO_SWDEC_FUNCTION_001, TestSize.Level3)
{
    if (!access("/system/lib64/media/", 0)) {
        shared_ptr<VDecAPI11Sample> vDecSample = make_shared<VDecAPI11Sample>();
        vDecSample->SF_OUTPUT = false;
        vDecSample->INP_DIR = g_inpDir1158;
...
HWTEST_F(HevcSwdecFuncNdkTest, VIDEO_SWDEC_FUNCTION_002, TestSize.Level3)
{
    if (!access("/system/lib64/media/", 0)) {
        shared_ptr<VDecAPI11Sample> vDecSample = make_shared<VDecAPI11Sample>();
        vDecSample->INP_DIR = g_inpDir1440;
        vDecSample->SF_OUTPUT = false;
        vDecSample->DEFAULT_WIDTH = 1920;
...
HWTEST_F(HevcSwdecFuncNdkTest, VIDEO_SWDEC_FUNCTION_003, TestSize.Level3)
{
    if (!access("/system/lib64/media/", 0)) {
        shared_ptr<VDecAPI11Sample> vDecSample = make_shared<VDecAPI11Sample>();
        vDecSample->SF_OUTPUT = false;
        vDecSample->INP_DIR = g_inpDir1022;
...
HWTEST_F(HevcSwdecFuncNdkTest, VIDEO_SWDEC_H265_FLUSH_THREE_0010, TestSize.Level2)
{
    if (cap_hevc != nullptr) {
        auto vDecSample = make_shared<VDecAPI11Sample>();
        vDecSample->INP_DIR = g_inpDirNal1280;
        vDecSample->DEFAULT_WIDTH = 1280;
        vDecSample->DEFAULT_HEIGHT = 720;
        vDecSample->DEFAULT_FRAME_RATE = 30;
        vDecSample->defualtPixelFormat = AV_PIXEL_FORMAT_NV12;
