...
namespace OHOS {
namespace Media {
class HevcSwdecStateNdkTest : public testing::Test {
public:
...
void HevcSwdecStateNdkTest::SetUpTestCase(void) {}

void HevcSwdecStateNdkTest::TearDownTestCase(void) {}
...
void HevcSwdecStateNdkTest::SetUp(void)
{
    if (!access("/system/lib64/media/", 0)) {
        ...
        string hevcCodeName = OH_AVCapability_GetName(cap);
        cout << "hevcCodeName: " << hevcCodeName << endl;
        vDecSample = new VDecNdkSample();
        int32_t ret = vDecSample->CreateVideoDecoder(hevcCodeName);
 ...
 * @tc.desc      : state test
 */
HWTEST_F(HevcSwdecStateNdkTest, VIDEO_SWDEC_STATE_0101, TestSize.Level2)
{
    if (!access("/system/lib64/media/", 0)) {
...
/**
 * @tc.number    : VIDEO_SWDEC_STATE_3500
...
/**
 * @tc.number    : VIDEO_SWDEC_STATE_3600
 * @tc.name      : Flush or stop in buffe decoder callback function
 * @tc.desc      : state test
 */
...
/**
 * @tc.number    : VIDEO_SWDEC_STATE_3700
 * @tc.name      : Flush or stop in buffe decoder callback function
 * @tc.desc      : state test
 */
...
/**
 * @tc.number    : VIDEO_SWDEC_STATE_3800
 * @tc.name      : Flush or stop in buffe decoder callback function
 * @tc.desc      : state test
 */
...
/**
 * @tc.number    : VIDEO_SWDEC_STATE_3900
...
/**
 * @tc.number    : VIDEO_SWDEC_STATE_4000
 * @tc.name      : Flush or stop in buffe decoder callback function
 * @tc.desc      : state test
 */
...
/**
 * @tc.number    : VIDEO_SWDEC_STATE_4100
 * @tc.name      : Flush or stop in buffe decoder callback function
 * @tc.desc      : state test
 */
...
/**
 * @tc.number    : VIDEO_SWDEC_STATE_4200
 * @tc.name      : Flush or stop in buffe decoder callback function
 * @tc.desc      : state test
 */
