...
namespace OHOS {
namespace Media {
class Mpeg2SwdecApiNdkTest : public testing::Test {
public:
...
const string CODEC_NAME = "OH.Media.Codec.Decoder.Video.MPEG2";
VDecSignal *signal_;
...
void Mpeg2SwdecApiNdkTest::SetUpTestCase()
{
...
void Mpeg2SwdecApiNdkTest::TearDownTestCase() {}
void Mpeg2SwdecApiNdkTest::SetUp()
{
    signal_ = new VDecSignal();
}
void Mpeg2SwdecApiNdkTest::TearDown()
{
    if (format != nullptr) {
...
namespace {
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_0100
 * @tc.name      : OH_VideoDecoder_FindDecoder para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_0100, TestSize.Level2)
{
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_0200
 * @tc.name      : OH_VideoDecoder_CreateByName para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_0200, TestSize.Level2)
{
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_0300
 * @tc.name      : OH_VideoDecoder_SetCallback para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_0300, TestSize.Level2)
{
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_0400
 * @tc.name      : OH_VideoDecoder_SetCallback para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_0400, TestSize.Level2)
{
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_0500
 * @tc.name      : OH_VideoDecoder_SetCallback para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_0500, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
        OH_AVCodecAsyncCallback cb_;
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_0600
 * @tc.name      : OH_VideoDecoder_Destroy para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_0600, TestSize.Level2)
{
 ...
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_0700, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
        ASSERT_NE(NULL, vdec_);
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_0800
 * @tc.name      : OH_VideoDecoder_Configure para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_0800, TestSize.Level2)
{
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_0900
 * @tc.name      : OH_VideoDecoder_Configure para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_0900, TestSize.Level2)
{
    OH_AVFormat *format = OH_AVFormat_Create();
    ASSERT_NE(NULL, format);
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_1000
 * @tc.name      : OH_VideoDecoder_Start para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_1000, TestSize.Level2)
{
    ASSERT_EQ(AV_ERR_INVALID_VAL, OH_VideoDecoder_Start(NULL));
}

/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_1100
 * @tc.name      : OH_VideoDecoder_Stop para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_1100, TestSize.Level2)
{
    ASSERT_EQ(AV_ERR_INVALID_VAL, OH_VideoDecoder_Stop(NULL));
}

/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_1200
 * @tc.name      : OH_VideoDecoder_Flush para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_1200, TestSize.Level2)
{
    ASSERT_EQ(AV_ERR_INVALID_VAL, OH_VideoDecoder_Flush(NULL));
}

/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_1300
 * @tc.name      : OH_VideoDecoder_Reset para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_1300, TestSize.Level2)
{
    ASSERT_EQ(AV_ERR_INVALID_VAL, OH_VideoDecoder_Reset(NULL));
}

/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_1400
 * @tc.name      : OH_VideoDecoder_GetOutputDescription para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_1400, TestSize.Level2)
{
    ASSERT_EQ(NULL, OH_VideoDecoder_GetOutputDescription(NULL));
}

/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_1500
 * @tc.name      : OH_VideoDecoder_SetParameter para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_1500, TestSize.Level2)
{
    vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_1600
 * @tc.name      : OH_VideoDecoder_Prepare para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_1600, TestSize.Level2)
{
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_1700
 * @tc.name      : OH_VideoDecoder_SetParameter para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_1700, TestSize.Level2)
{
    OH_AVFormat *format = OH_AVFormat_Create();
    ASSERT_NE(NULL, format);
    (void)OH_AVFormat_SetIntValue(format, OH_MD_KEY_WIDTH, DEFAULT_WIDTH);
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_1800
 * @tc.name      : OH_VideoDecoder_SetSurface para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_1800, TestSize.Level2)
{
    vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_1900
 * @tc.name      : OH_VideoDecoder_CreateByName para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_1900, TestSize.Level2)
{
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_2000
 * @tc.name      : OH_VideoDecoder_CreateByName para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_2000, TestSize.Level2)
{
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_2100
 * @tc.name      : OH_VideoDecoder_RenderOutputData para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_2100, TestSize.Level2)
{
    ASSERT_EQ(AV_ERR_INVALID_VAL, OH_VideoDecoder_RenderOutputData(NULL, 0));
}

/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_2200
 * @tc.name      : OH_VideoDecoder_RenderOutputData para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_2200, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_2300
 * @tc.name      : OH_VideoDecoder_FreeOutputData para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_2300, TestSize.Level2)
{
    ASSERT_EQ(AV_ERR_INVALID_VAL, OH_VideoDecoder_FreeOutputData(NULL, 0));
}

/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_2400
 * @tc.name      : OH_VideoDecoder_FreeOutputData para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_2400, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_2500
 * @tc.name      : OH_VideoDecoder_FreeOutputData para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_2500, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_2600
 * @tc.name      : OH_VideoDecoder_PushInputData para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_2600, TestSize.Level2)
{
    vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_2700
 * @tc.name      : OH_VideoDecoder_PushInputData para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_2700, TestSize.Level2)
{
    OH_AVCodecBufferAttr attr;
    attr.pts = 0;
    attr.size = 0;
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_ILLEGAL_PARA_2800
 * @tc.name      : OH_VideoDecoder_PushInputData para error
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_ILLEGAL_PARA_2800, TestSize.Level2)
{
    OH_AVCodecBufferAttr attr;
    attr.pts = 0;
    attr.size = 0;
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_API_0100
 * @tc.name      : repeat create OH_VideoDecoder_CreateByName
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_API_0100, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_API_0200
 * @tc.name      : repeat create OH_VideoDecoder_CreateByMime
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_API_0200, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        vdec_ = OH_VideoDecoder_CreateByMime(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2);
        ASSERT_NE(vdec_, NULL);
        OH_AVCodec *vdec_2 = OH_VideoDecoder_CreateByMime(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2);
        ASSERT_NE(vdec_2, NULL);
        OH_VideoDecoder_Destroy(vdec_2);
        vdec_2 = nullptr;
    }
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_API_0300
 * @tc.name      : create configure configure
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_API_0300, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
        ASSERT_NE(NULL, vdec_);
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_API_0400
 * @tc.name      : create configure start start
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_API_0400, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
        ASSERT_NE(NULL, vdec_);
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_API_0500
 * @tc.name      : create configure start stop stop
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_API_0500, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
        ASSERT_NE(NULL, vdec_);
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_API_0600
 * @tc.name      : create configure start stop reset reset
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_API_0600, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
        ASSERT_NE(NULL, vdec_);
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_API_0700
 * @tc.name      : create configure start EOS EOS
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_API_0700, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
        ASSERT_NE(NULL, vdec_);
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_API_0800
 * @tc.name      : create configure start flush flush
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_API_0800, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
        ASSERT_NE(NULL, vdec_);
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_API_0900
 * @tc.name      : create configure start stop release release
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_API_0900, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
        ASSERT_NE(NULL, vdec_);
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_API_1000
 * @tc.name      : create create
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_API_1000, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        vdec_ = OH_VideoDecoder_CreateByMime(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2);
        ASSERT_NE(vdec_, NULL);
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_API_1100
 * @tc.name      : repeat OH_VideoDecoder_SetCallback
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_API_1100, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
        OH_AVCodecAsyncCallback cb_;
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_API_1200
 * @tc.name      : repeat OH_VideoDecoder_GetOutputDescription
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_API_1200, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_API_1300
 * @tc.name      : repeat OH_VideoDecoder_SetParameter
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_API_1300, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        vdec_ = OH_VideoDecoder_CreateByName(CODEC_NAME.c_str());
        ASSERT_NE(NULL, vdec_);
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_0100
 * @tc.name      : OH_AVCodec_GetCapability
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_0100, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        cap = OH_AVCodec_GetCapability(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2, false);
        ASSERT_NE(cap, nullptr);
    }
}

/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_0200
 * @tc.name      : OH_AVCodec_GetCapabilityByCategory
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_0200, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_0300
 * @tc.name      : OH_AVCodec_GetCapabilityByCategory
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_0300, TestSize.Level2)
{
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_0400
 * @tc.name      : OH_AVCodec_GetCapability
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_0400, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        cap = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2, false, SOFTWARE);
        ASSERT_NE(cap, nullptr);
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_0500
 * @tc.name      : OH_AVCapability_IsHardware
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_0500, TestSize.Level2)
{
    ASSERT_FALSE(OH_AVCapability_IsHardware(nullptr));
}

/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_0600
 * @tc.name      : OH_AVCodec_GetCapability
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_SWDEC_CAP_API_0600, TestSize.Level2)
{
    ASSERT_EQ(0, OH_AVCapability_GetMaxSupportedInstances(nullptr));
}

/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_0700
 * @tc.name      : OH_AVCodec_GetCapability
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_0700, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        cap = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2, false, SOFTWARE);
        ASSERT_NE(cap, nullptr);
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_0800
 * @tc.name      : OH_AVCodec_GetCapability
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_0800, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        cap = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2, false, SOFTWARE);
        ASSERT_NE(cap, nullptr);
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_0900
 * @tc.name      : OH_AVCodec_GetCapability
 * @tc.desc      : function test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_0900, TestSize.Level2)
{
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_1000
 * @tc.name      : OH_AVCapability_GetVideoWidthAlignment param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_1000, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVErrCode ret = AV_ERR_OK;
        OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2,
        false, SOFTWARE);
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_1100
 * @tc.name      : OH_AVCapability_GetVideoWidthAlignment param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_1100, TestSize.Level2)
{
    OH_AVErrCode ret = AV_ERR_OK;
    int32_t alignment = 0;
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_1200
 * @tc.name      : OH_AVCapability_GetVideoWidthAlignment param correct
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_1200, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVErrCode ret = AV_ERR_OK;
        OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2,
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_1300
 * @tc.name      : OH_AVCapability_GetVideoHeightAlignment param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_1300, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVErrCode ret = AV_ERR_OK;
        OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2,
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_1400
 * @tc.name      : OH_AVCapability_GetVideoHeightAlignment param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_1400, TestSize.Level2)
{
    OH_AVErrCode ret = AV_ERR_OK;
    int32_t alignment = 0;
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_1500
 * @tc.name      : OH_AVCapability_GetVideoHeightAlignment param correct
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_1500, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVErrCode ret = AV_ERR_OK;
        OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2,
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_1600
 * @tc.name      : OH_AVCapability_GetVideoWidthRangeForHeight param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_1600, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVErrCode ret = AV_ERR_OK;
        OH_AVRange range;
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_1700
 * @tc.name      : OH_AVCapability_GetVideoWidthRangeForHeight param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_1700, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVErrCode ret = AV_ERR_OK;
        OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2,
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_1800
 * @tc.name      : OH_AVCapability_GetVideoWidthRangeForHeight param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_1800, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVErrCode ret = AV_ERR_OK;
        OH_AVRange range;
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_1900
 * @tc.name      : OH_AVCapability_GetVideoWidthRangeForHeight param correct
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_1900, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVErrCode ret = AV_ERR_OK;
        OH_AVRange range;
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_2000
 * @tc.name      : OH_AVCapability_GetVideoHeightRangeForWidth param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_2000, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVErrCode ret = AV_ERR_OK;
        OH_AVRange range;
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_2100
 * @tc.name      : OH_AVCapability_GetVideoHeightRangeForWidth param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_2100, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVErrCode ret = AV_ERR_OK;
        OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2,
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_2200
 * @tc.name      : OH_AVCapability_GetVideoHeightRangeForWidth param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_2200, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVErrCode ret = AV_ERR_OK;
        OH_AVRange range;
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_2300
 * @tc.name      : OH_AVCapability_GetVideoHeightRangeForWidth param correct
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_2300, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVErrCode ret = AV_ERR_OK;
        OH_AVRange range;
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_2400
 * @tc.name      : OH_AVCapability_GetVideoWidthRange param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_2400, TestSize.Level2)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_2500
 * @tc.name      : OH_AVCapability_GetVideoWidthRange param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_2500, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVErrCode ret = AV_ERR_OK;
        OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2,
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_2600
 * @tc.name      : OH_AVCapability_GetVideoWidthRange param correct
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_2600, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVErrCode ret = AV_ERR_OK;
        OH_AVRange range;
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_2700
 * @tc.name      : OH_AVCapability_GetVideoHeightRange param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_2700, TestSize.Level2)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_2800
 * @tc.name      : OH_AVCapability_GetVideoHeightRange param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_2800, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVErrCode ret = AV_ERR_OK;
        OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2,
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_2900
 * @tc.name      : OH_AVCapability_GetVideoHeightRange param correct
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_2900, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVErrCode ret = AV_ERR_OK;
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_3000
 * @tc.name      : OH_AVCapability_IsVideoSizeSupported param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_3000, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2,
        false, SOFTWARE);
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_3100
 * @tc.name      : OH_AVCapability_IsVideoSizeSupported param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_3100, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2,
        false, SOFTWARE);
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_3200
 * @tc.name      : OH_AVCapability_IsVideoSizeSupported param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_3200, TestSize.Level2)
{
    ASSERT_EQ(false, OH_AVCapability_IsVideoSizeSupported(nullptr, DEFAULT_WIDTH, DEFAULT_HEIGHT));
}
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_3300
 * @tc.name      : OH_AVCapability_IsVideoSizeSupported param correct
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_3300, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2,
        false, SOFTWARE);
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_3400
 * @tc.name      : OH_AVCapability_IsVideoSizeSupported param correct
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_3400, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2,
        false, SOFTWARE);
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_3500
 * @tc.name      : OH_AVCapability_GetVideoFrameRateRange param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_3500, TestSize.Level2)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_3600
 * @tc.name      : OH_AVCapability_GetVideoFrameRateRange param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_3600, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVErrCode ret = AV_ERR_OK;
        OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2,
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_3700
 * @tc.name      : OH_AVCapability_GetVideoFrameRateRange param correct
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_3700, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVErrCode ret = AV_ERR_OK;
        OH_AVRange range;
        ...
        ASSERT_GE(range.minVal, 0);
        ASSERT_GT(range.maxVal, 0);
        std::cout << "minVal: " << range.minVal << std::endl;
        std::cout << "maxVal: " << range.maxVal << std::endl;
    }
}

/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_3800
 * @tc.name      : OH_AVCapability_GetVideoFrameRateRangeForSize param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_3800, TestSize.Level2)
{
    OH_AVErrCode ret = AV_ERR_OK;
    OH_AVRange range;
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_3900
 * @tc.name      : OH_AVCapability_GetVideoFrameRateRangeForSize param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_3900, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVErrCode ret = AV_ERR_OK;
        OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2,
 ...
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_4000, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVErrCode ret = AV_ERR_OK;
        OH_AVRange range;
 ...
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_4100, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVErrCode ret = AV_ERR_OK;
        OH_AVRange range;
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_4200
 * @tc.name      : OH_AVCapability_GetVideoFrameRateRangeForSize param correct
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_4200, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVErrCode ret = AV_ERR_OK;
        OH_AVRange range;
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_4300
 * @tc.name      : OH_AVCapability_AreVideoSizeAndFrameRateSupported param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_4300, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2,
        false, SOFTWARE);
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_4400
 * @tc.name      : OH_AVCapability_AreVideoSizeAndFrameRateSupported param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_4400, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2,
        false, SOFTWARE);
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_4500
 * @tc.name      : OH_AVCapability_AreVideoSizeAndFrameRateSupported param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_4500, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2,
        false, SOFTWARE);
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_4600
 * @tc.name      : OH_AVCapability_AreVideoSizeAndFrameRateSupported param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_4600, TestSize.Level2)
{
    ASSERT_EQ(false, OH_AVCapability_AreVideoSizeAndFrameRateSupported(nullptr, DEFAULT_WIDTH, DEFAULT_HEIGHT, 30));
}

/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_4700
 * @tc.name      : OH_AVCapability_AreVideoSizeAndFrameRateSupported param correct
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_4700, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2,
        false, SOFTWARE);
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_4800
 * @tc.name      : OH_AVCapability_GetVideoSupportedPixelFormats param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_4800, TestSize.Level2)
{
    OH_AVErrCode ret = AV_ERR_OK;
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_4900
 * @tc.name      : OH_AVCapability_GetVideoSupportedPixelFormats param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_4900, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVErrCode ret = AV_ERR_OK;
        uint32_t pixelFormatNum = 0;
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_5000
 * @tc.name      : OH_AVCapability_GetVideoSupportedPixelFormats param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_5000, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVErrCode ret = AV_ERR_OK;
        const int32_t *pixelFormat = nullptr;
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_5100
 * @tc.name      : OH_AVCapability_GetVideoSupportedPixelFormats param correct
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_5100, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVErrCode ret = AV_ERR_OK;
        const int32_t *pixelFormat = nullptr;
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_5200
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_5300
 * @tc.name      : OH_AVCapability_GetSupportedLevelsForProfile param correct
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_5300, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVErrCode ret = AV_ERR_OK;
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_5400
 * @tc.name      : OH_AVCapability_AreProfileAndLevelSupported param correct
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_5400, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2,
        false, SOFTWARE);
        ASSERT_NE(nullptr, capability);
        ASSERT_EQ(true, OH_AVCapability_AreProfileAndLevelSupported(capability, MPEG2_PROFILE_SIMPLE, 1));
    }
}

/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_5500
 * @tc.name      : OH_AVCapability_AreProfileAndLevelSupported param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_5500, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2,
        false, SOFTWARE);
        ASSERT_NE(nullptr, capability);
        ASSERT_EQ(false, OH_AVCapability_AreProfileAndLevelSupported(capability, MPEG2_PROFILE_SIMPLE, 4));
    }
}

/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_5600
 * @tc.name      : OH_AVCapability_IsFeatureSupported param error
 * @tc.desc      : api test
 */

HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_5600, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2,
        false, SOFTWARE);
...
/**
 * @tc.number    : VIDEO_MPEG2SWDEC_CAP_5700
 * @tc.name      : OH_AVCapability_GetFeatureProperties param error
 * @tc.desc      : api test
 */
HWTEST_F(Mpeg2SwdecApiNdkTest, VIDEO_MPEG2SWDEC_CAP_5700, TestSize.Level2)
{
    if (cap_mpeg2 != nullptr) {
        OH_AVCapability *capability = OH_AVCodec_GetCapabilityByCategory(OH_AVCODEC_MIMETYPE_VIDEO_MPEG2,
        false, SOFTWARE);
