...
public:
    ...
    const char *INP_DIR = "";
    const char *OUT_DIR = "/data/test/media/MsVideo1DecTest.yuv";
    const char *OUT_DIR2 = "/data/test/media/MsVideo1DecTest2.yuv";
    ...
    const char *fileSourcesha256_msvideo1[64] = {
        "5a", "5b", "7e", "3f", "6a", "3e", "41", "69", "61", "54", "c2", "10", "fb", "bb", "75", "9f",
        "fb", "b1", "d4", "e0", "b7", "37", "aa", "77", "0d", "04", "b1", "68", "08", "c1", "25", "8b",
        "ce", "aa", "12", "47", "dd", "43", "77", "35", "26", "01", "8c", "02", "14", "77", "95", "3d",
        "fc", "8e", "2e", "7b", "70", "ab", "a3", "48", "aa", "dc", "c2", "08", "0d", "bb", "a2", "a0"
    };
    const char *fileSourcesha256_2[64] = {
        "d1", "31", "3f", "23", "ad", "30", "94", "a0", "73", "71", "bf", "46", "5b", "6b", "69", "bf",
        "22", "ba", "b5", "c2", "81", "a2", "8d", "28", "0e", "4f", "24", "a4", "7d", "2a", "f9", "c5",
        "76", "d7", "fc", "09", "e0", "6d", "31", "52", "1e", "0c", "92", "ef", "0f", "ca", "fe", "e5",
        "3d", "09", "e7", "d2", "30", "e8", "34", "92", "83", "78", "9f", "68", "5b", "b8", "f2", "71"
    };
