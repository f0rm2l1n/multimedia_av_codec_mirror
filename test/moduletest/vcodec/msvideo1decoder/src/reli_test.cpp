...
namespace OHOS {
namespace Media {
class MsVideo1DecReliNdkTest : public testing::Test {
public:
...
protected:
    ...
    const char *inpDir1080Array[16] = {
        "/data/test/media/msvideo1_720x480.avi"};
};
} // namespace Media
} // namespace OHOS
...
const char *FILE_PATH = "/data/test/media/msvideo1_720x480.avi";
void MsVideo1DecReliNdkTest::SetUpTestCase()
{
    OH_AVCapability *cap = OH_AVCodec_GetCapabilityByCategory(
        OH_AVCODEC_MIMETYPE_VIDEO_MSVIDEO1, false, SOFTWARE);
    g_codecNameMsVideo1 = OH_AVCapability_GetName(cap);
    cout << "g_codecNameMsVideo1: " << g_codecNameMsVideo1 << endl;
}

void MsVideo1DecReliNdkTest::TearDownTestCase() {}
void MsVideo1DecReliNdkTest::SetUp() {}
void MsVideo1DecReliNdkTest::TearDown() {}

namespace {
/**
 * @tc.number    : VIDEO_MSVIDEO1DEC_STABILITY_0010
 * @tc.name      : Msvideo1 soft decode successively 16 times
 * @tc.desc      : reli test
 */
HWTEST_F(MsVideo1DecReliNdkTest, VIDEO_MSVIDEO1DEC_STABILITY_0010, TestSize.Level3)
{
...
/**
 * @tc.number    : VIDEO_MSVIDEO1DEC_STABILITY_0030
 * @tc.name      : 16 instances Msvideo1 soft decode with Surface mode
 * @tc.desc      : reli test
 */
HWTEST_F(MsVideo1DecReliNdkTest, VIDEO_MSVIDEO1DEC_STABILITY_0030, TestSize.Level3)
{
...
/**
 * @tc.number    : VIDEO_MSVIDEO1DEC_STABILITY_0040
 * @tc.name      : 16 instances Msvideo1 soft decode with buffer mode
 * @tc.desc      : reli test
 */
HWTEST_F(MsVideo1DecReliNdkTest, VIDEO_MSVIDEO1DEC_STABILITY_0040, TestSize.Level3)
{
    vector<shared_ptr<VDecAPI11Sample>> decVec;
    for (int i = 0; i < g_reliCount; i++)
    {
...
/**
 * @tc.number    : VIDEO_MSVIDEO1DEC_STABILITY_0050
 * @tc.name      : Msvideo1 soft decode 16 times with fast Surface change
 * @tc.desc      : reli test
 */
HWTEST_F(MsVideo1DecReliNdkTest, VIDEO_MSVIDEO1DEC_STABILITY_0050, TestSize.Level3)
{
    for (int i = 0; i < g_reliCount; i++)
    {
        shared_ptr<VDecAPI11Sample> vDecSample = make_shared<VDecAPI11Sample>();
...
/**
 * @tc.number    : VIDEO_MSVIDEO1DEC_STABILITY_0080
 * @tc.name      : 16 instances Msvideo1 soft decode with buffer mode × 5 loops
 * @tc.desc      : reli test
 */
HWTEST_F(MsVideo1DecReliNdkTest, VIDEO_MSVIDEO1DEC_STABILITY_0080, TestSize.Level3)
{
    for (int j = 0; j < 5; j++)
    {
        vector<shared_ptr<VDecAPI11Sample>> decVec;
...
HWTEST_F(MsVideo1DecReliNdkTest, VIDEO_MSVIDEO1DEC_STABILITY_0090, TestSize.Level3)
{
    for (int i = 0; i < g_reliCount; i++)
    {
        ...
        vDecSample->sleepOnFPS = true;
        vDecSample->NocaleHash = true;
        ASSERT_EQ(AV_ERR_OK, vDecSample->RunVideoDec(g_codecNameMsVideo1));
        vDecSample->WaitForEOS();
        ASSERT_EQ(AV_ERR_OK, vDecSample->errCount);
        ...
        ASSERT_EQ(AV_ERR_OK, vDecSample1->RunVideoDec(g_codecNameMsVideo1));
...
/**
 * @tc.number    : VIDEO_MSVIDEO1DEC_STABILITY_0100
 * @tc.name      : Decode 10-bit and 8-bit Msvideo1 streams simultaneously
 * @tc.desc      : reli test
 */
HWTEST_F(MsVideo1DecReliNdkTest, VIDEO_MSVIDEO1DEC_STABILITY_0100, TestSize.Level3)
{
    for (int i = 0; i < g_reliCount; i++)
    {
        shared_ptr<VDecAPI11Sample> vDecSample = make_shared<VDecAPI11Sample>();
        ...
        ASSERT_EQ(AV_ERR_OK, vDecSample1->RunVideoDec_Surface(g_codecNameMsVideo1));
        vDecSample1->WaitForEOS();
        vDecSample1->ReleaseInFile();
    }
}
/**
 * @tc.number    : VIDEO_MSVIDEO1DEC_STABILITY_0110
 * @tc.name      : Random width and height Msvideo1 decode (1920x1080)
 * @tc.desc      : reli test
 */
HWTEST_F(MsVideo1DecReliNdkTest, VIDEO_MSVIDEO1DEC_STABILITY_0110, TestSize.Level3)
{
    for (int i = 0; i < g_reliCount; i++)
    {
        shared_ptr<VDecAPI11Sample> vDecSample = make_shared<VDecAPI11Sample>();
...
HWTEST_F(MsVideo1DecReliNdkTest, VIDEO_MSVIDEO1DEC_STABILITY_0120, TestSize.Level3)
{
    for (int i = 0; i < g_reliCount; i++)
    {
        ...
        ASSERT_EQ(AV_ERR_OK, vDecSample2->RunVideoDec_Surface(g_codecNameMsVideo1));
        vDecSample2->WaitForEOS();
        vDecSample2->ReleaseInFile();
    }
}
/**
 * @tc.number    : VIDEO_MSVIDEO1DEC_STABILITY_0130
 * @tc.name      : Create and destroy Msvideo1 decoder repeatedly
 * @tc.desc      : reliable test
 */
HWTEST_F(MsVideo1DecReliNdkTest, VIDEO_MSVIDEO1DEC_STABILITY_0130, TestSize.Level3)
{
    shared_ptr<VDecAPI11Sample> vDecSample = make_shared<VDecAPI11Sample>();
    vDecSample->INP_DIR = FILE_PATH;
    for (int i = 0; i < 1000; i++) {
        OH_AVCodec *vdec_ = OH_VideoDecoder_CreateByName(g_codecNameMsVideo1.c_str());
