...
public:
    ...
    static const std::unordered_set<std::string_view> &GetAudioCodecOuterSupportTable()
    {
        static const std::unordered_set<std::string_view> OUTER_SUPPORT_TABLE = {
            ...
            AUDIO_DECODER_ADPCM_MS_NAME,
            AUDIO_DECODER_ADPCM_IMA_QT_NAME,
            AUDIO_DECODER_ADPCM_IMA_WAV_NAME,
            AUDIO_DECODER_ADPCM_IMA_DK3_NAME,
            AUDIO_DECODER_ADPCM_IMA_DK4_NAME,
            AUDIO_DECODER_ADPCM_IMA_WS_NAME,
            AUDIO_DECODER_ADPCM_IMA_SMJPEG_NAME,
            AUDIO_DECODER_ADPCM_IMA_DAT4_NAME,
            AUDIO_DECODER_ADPCM_MTAF_NAME,
            AUDIO_DECODER_ADPCM_ADX_NAME,
            AUDIO_DECODER_ADPCM_AFC_NAME,
            AUDIO_DECODER_ADPCM_AICA_NAME,
            AUDIO_DECODER_ADPCM_CT_NAME,
            AUDIO_DECODER_ADPCM_DTK_NAME,
            AUDIO_DECODER_ADPCM_G722_NAME,
            AUDIO_DECODER_ADPCM_G726_NAME,
            AUDIO_DECODER_ADPCM_G726LE_NAME,
            AUDIO_DECODER_ADPCM_IMA_AMV_NAME,
            AUDIO_DECODER_ADPCM_IMA_APC_NAME,
            AUDIO_DECODER_ADPCM_IMA_ISS_NAME,
            AUDIO_DECODER_ADPCM_IMA_OKI_NAME,
            AUDIO_DECODER_ADPCM_IMA_RAD_NAME,
            AUDIO_DECODER_ADPCM_PSX_NAME,
            AUDIO_DECODER_ADPCM_SBPRO_2_NAME,
            AUDIO_DECODER_ADPCM_SBPRO_3_NAME,
            AUDIO_DECODER_ADPCM_SBPRO_4_NAME,
            AUDIO_DECODER_ADPCM_THP_NAME,
            AUDIO_DECODER_ADPCM_THP_LE_NAME,
            AUDIO_DECODER_ADPCM_XA_NAME,
            AUDIO_DECODER_ADPCM_YAMAHA_NAME,
