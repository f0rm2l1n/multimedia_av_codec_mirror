...
namespace Media {
namespace Pipeline {
class EncoderFilter : public Filter, public std::enable_shared_from_this<EncoderFilter> {
public:
    explicit EncoderFilter(std::string name, FilterType type);
    ~EncoderFilter() override;
