...
public:
    ...
    public:
        ...
        void OnBufferAvailable() override {
            audioSink_->ProcessOutputBuffer();
        }
    private:
...
private:
    ...
    std::shared_ptr<Plugin::AudioSinkPlugin> CreatePlugin(std::shared_ptr<Meta> meta);
    std::shared_ptr<Plugin::AudioSinkPlugin> plugin_ {};
