 ...
 *
 * It's necessary to use {@link OH_VideoDecoder_GetInputBuffer} to get the buffer handle, and then
 * use {@link OH_VideoDecoder_PushInputBuffer} to pass to the encoder.\n
 ...
 * {@link AV_ERR_VIDEO_STREAM_CHANGED}, the stream is changed, call {@link OH_VideoDecoder_GetOutputDescription} to
 ...
 * @param codec Pointer to an OH_AVCodec instance
 * @param index The index value corresponding to the input buffer,
 * should be given by {@link OH_VideoDecoder_QueryInputBuffer}.
 * @return Returns AV_ERR_OK if the execution is successful,
 * otherwise returns a specific error code, refer to {@link OH_AVErrCode}.
 * {@link AV_ERR_NO_MEMORY}, internal errors in the input decode instance, such as an abnormal NULL.
 * {@link AV_ERR_INVALID_VAL}, the decoder is nullptr or invalid.
 ...
 *
 * It's necessary to use {@link OH_VideoDecoder_GetOutputBuffer} to get the buffer handle, and then
 * use {@link OH_VideoDecoder_FreeOutputBuffer} or {@link OH_VideoDecoder_RenderOutputBuffer}
 * or {@link OH_VideoDecoder_RenderOutputBufferAtTime} to return the buffer to the decoder.\n
 * It's only used in synchronous mode.\n
 *
 * @syscap SystemCapability.Multimedia.Media.VideoDecoder
 * @param codec Pointer to an OH_AVCodec instance
 ...
 * @param codec Pointer to an OH_AVCodec instance
 * @param index The index value corresponding to the input buffer,
 * should be given by {@link OH_VideoDecoder_QueryOutputBuffer}.
 * @return Returns AV_ERR_OK if the execution is successful,
 * otherwise returns a specific error code, refer to {@link OH_AVErrCode}.
 * {@link AV_ERR_NO_MEMORY}, internal errors in the input decode instance, such as an abnormal NULL.
 * {@link AV_ERR_INVALID_VAL}, the decoder is nullptr or invalid.
